...
`;
    ...
    out += generateBoxModelExpander('margin', ['margin-top', 'margin-right', 'margin-bottom', 'margin-left'], true, 4, true);
    out += generateBoxModelExpander('padding', ['padding-top', 'padding-right', 'padding-bottom', 'padding-left'], false);
    out += generateBoxModelExpander('inset', ['top', 'right', 'bottom', 'left'], true, 4, true);
    out += generateBoxModelExpander('scroll-margin', ['scroll-margin-top', 'scroll-margin-right', 'scroll-margin-bottom', 'scroll-margin-left'], true);
    out += generateBoxModelExpander('scroll-padding', ['scroll-padding-top', 'scroll-padding-right', 'scroll-padding-bottom', 'scroll-padding-left'], false);
    out += generateBoxModelExpander('margin-block', ['margin-block-start', 'margin-block-end'], true, 2, true);
    out += generateBoxModelExpander('margin-inline', ['margin-inline-start', 'margin-inline-end'], true, 2, true);
    out += generateBoxModelExpander('padding-block', ['padding-block-start', 'padding-block-end'], false, 2);
    out += generateBoxModelExpander('padding-inline', ['padding-inline-start', 'padding-inline-end'], false, 2);
    out += generateBoxModelExpander('inset-block', ['inset-block-start', 'inset-block-end'], true, 2, true);
    out += generateBoxModelExpander('inset-inline', ['inset-inline-start', 'inset-inline-end'], true, 2, true);
    out += generateBoxModelExpander('scroll-margin-block', ['scroll-margin-block-start', 'scroll-margin-block-end'], true, 2);
    out += generateBoxModelExpander('scroll-margin-inline', ['scroll-margin-inline-start', 'scroll-margin-inline-end'], true, 2);
    out += generateBoxModelExpander('scroll-padding-block', ['scroll-padding-block-start', 'scroll-padding-block-end'], false, 2);
    out += generateBoxModelExpander('scroll-padding-inline', ['scroll-padding-inline-start', 'scroll-padding-inline-end'], false, 2);
    out += generateBorderRadiusExpander();
    out += generateBorderExpander();
    out += generateBorderSideExpander('border-top', 'border-top-width', 'border-top-style', 'border-top-color');
    out += generateBorderSideExpander('border-right', 'border-right-width', 'border-right-style', 'border-right-color');
    out += generateBorderSideExpander('border-bottom', 'border-bottom-width', 'border-bottom-style', 'border-bottom-color');
    out += generateBorderSideExpander('border-left', 'border-left-width', 'border-left-style', 'border-left-color');
    out += generateBorderSideExpander('border-block-start', 'border-block-start-width', 'border-block-start-style', 'border-block-start-color');
    out += generateBorderSideExpander('border-block-end', 'border-block-end-width', 'border-block-end-style', 'border-block-end-color');
    out += generateBorderSideExpander('border-inline-start', 'border-inline-start-width', 'border-inline-start-style', 'border-inline-start-color');
    out += generateBorderSideExpander('border-inline-end', 'border-inline-end-width', 'border-inline-end-style', 'border-inline-end-color');
    out += generateBorderWidthStyleColorExpander('border-width', ['border-top-width', 'border-right-width', 'border-bottom-width', 'border-left-width'], 'width');
    out += generateBorderWidthStyleColorExpander('border-style', ['border-top-style', 'border-right-style', 'border-bottom-style', 'border-left-style'], 'style');
    out += generateBorderWidthStyleColorExpander('border-color', ['border-top-color', 'border-right-color', 'border-bottom-color', 'border-left-color'], 'color');
...
function generateBoxModelExpander(shorthand, longhands, acceptNegative, maxValues = 4, acceptAuto = false) {
...
function generateIsGradientToken() {
    return `
\t/**
...
function generateBorderImageExpander() {
    return `
\t/**
