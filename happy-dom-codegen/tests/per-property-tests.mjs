...
// --- animation-composition ---
{
	...
	assertEq(
		...
		'replace',
		'animation-composition: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('animation-composition'),
		'replace',
		'animation-composition: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('animation-composition'),
		'inherit',
		'animation-composition: accepts inherit'
	);
	s.animationComposition = '';
...
// --- animation-delay ---
{
	...
	assertEq(
		s.getPropertyValue('animation-delay'),
		'1s',
		'animation-delay: getPropertyValue matches accessor'
	);
...
// --- animation-direction ---
{
	...
	assertEq(
		s.getPropertyValue('animation-direction'),
		'normal',
		'animation-direction: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('animation-direction'),
		'inherit',
		'animation-direction: accepts inherit'
	);
...
// --- animation-duration ---
{
	...
	assertEq(
		s.getPropertyValue('animation-duration'),
		'1s',
		'animation-duration: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('animation-duration'),
		'inherit',
		'animation-duration: accepts inherit'
	);
	s.animationDuration = '';
...
// --- animation-fill-mode ---
{
	...
	assertEq(
		s.getPropertyValue('animation-fill-mode'),
		'none',
		'animation-fill-mode: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('animation-fill-mode'),
		'inherit',
		'animation-fill-mode: accepts inherit'
	);
	s.animationFillMode = '';
...
// --- animation-iteration-count ---
{
	...
	assertEq(
		...
		'infinite',
		'animation-iteration-count: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('animation-iteration-count'),
		'infinite',
		'animation-iteration-count: getPropertyValue matches accessor'
	);
	s.animationIterationCount = 'inherit';
	assertEq(
		s.animationIterationCount,
		'inherit',
		'animation-iteration-count: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('animation-iteration-count'),
		'inherit',
		'animation-iteration-count: accepts inherit'
	);
	s.animationIterationCount = '';
...
// --- animation-name ---
{
	...
	assertEq(
		s.getPropertyValue('animation-name'),
		'none',
		'animation-name: getPropertyValue matches accessor'
	);
...
// --- animation-play-state ---
{
	...
	assertEq(
		...
		'running',
		'animation-play-state: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('animation-play-state'),
		'running',
		'animation-play-state: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('animation-play-state'),
		'inherit',
		'animation-play-state: accepts inherit'
	);
	s.animationPlayState = '';
...
// --- animation-range-start ---
{
	...
	assertEq(
		...
		'initial',
		'animation-range-start: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('animation-range-start'),
		'initial',
		'animation-range-start: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('animation-range-start'),
		'inherit',
		'animation-range-start: accepts inherit'
	);
	s.animationRangeStart = '';
...
// --- animation-range-end ---
{
	...
	assertEq(
		s.getPropertyValue('animation-range-end'),
		'initial',
		'animation-range-end: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('animation-range-end'),
		'inherit',
		'animation-range-end: accepts inherit'
	);
	s.animationRangeEnd = '';
...
// --- animation-timeline ---
{
	...
	assertEq(
		s.getPropertyValue('animation-timeline'),
		'none',
		'animation-timeline: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('animation-timeline'),
		'inherit',
		'animation-timeline: accepts inherit'
	);
	s.animationTimeline = '';
...
// --- animation-timing-function ---
{
	...
	assertEq(
		...
		'linear',
		'animation-timing-function: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('animation-timing-function'),
		'linear',
		'animation-timing-function: getPropertyValue matches accessor'
	);
	s.animationTimingFunction = 'ease';
	assertEq(
		s.animationTimingFunction,
		'ease',
		'animation-timing-function: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('animation-timing-function'),
		'inherit',
		'animation-timing-function: accepts inherit'
	);
	s.animationTimingFunction = '';
	...
	assertEq(
		s.animationTimingFunction,
		'linear',
		'animation-timing-function: rejects invalid keyword'
	);
}
...
// --- animation-trigger ---
{
	...
	assertEq(
		s.getPropertyValue('animation-trigger'),
		'none',
		'animation-trigger: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('animation-trigger'),
		'inherit',
		'animation-trigger: accepts inherit'
	);
	s.animationTrigger = '';
...
// --- timeline-trigger-name ---
{
	...
	assertEq(
		...
		'initial',
		'timeline-trigger-name: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-name'),
		'initial',
		'timeline-trigger-name: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('timeline-trigger-name'),
		'inherit',
		'timeline-trigger-name: accepts inherit'
	);
	s.timelineTriggerName = '';
...
// --- timeline-trigger-activation-range-start ---
{
	...
	assertEq(
		...
		'initial',
		'timeline-trigger-activation-range-start: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-activation-range-start'),
		'initial',
		'timeline-trigger-activation-range-start: getPropertyValue matches accessor'
	);
	s.timelineTriggerActivationRangeStart = 'inherit';
	assertEq(
		s.timelineTriggerActivationRangeStart,
		'inherit',
		'timeline-trigger-activation-range-start: overwrite with second value'
	);
	s.removeProperty('timeline-trigger-activation-range-start');
	assertEq(
		s.timelineTriggerActivationRangeStart,
		'',
		'timeline-trigger-activation-range-start: removeProperty clears value'
	);
	s.setProperty('timeline-trigger-activation-range-start', 'inherit');
	assertEq(
		s.getPropertyValue('timeline-trigger-activation-range-start'),
		'inherit',
		'timeline-trigger-activation-range-start: accepts inherit'
	);
	s.timelineTriggerActivationRangeStart = '';
	assertEq(
		s.timelineTriggerActivationRangeStart,
		'',
		'timeline-trigger-activation-range-start: empty string removes'
	);
}
...
// --- timeline-trigger-activation-range-end ---
{
	...
	assertEq(
		...
		'initial',
		'timeline-trigger-activation-range-end: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-activation-range-end'),
		'initial',
		'timeline-trigger-activation-range-end: getPropertyValue matches accessor'
	);
	s.timelineTriggerActivationRangeEnd = 'inherit';
	assertEq(
		s.timelineTriggerActivationRangeEnd,
		'inherit',
		'timeline-trigger-activation-range-end: overwrite with second value'
	);
	s.removeProperty('timeline-trigger-activation-range-end');
	assertEq(
		s.timelineTriggerActivationRangeEnd,
		'',
		'timeline-trigger-activation-range-end: removeProperty clears value'
	);
	s.setProperty('timeline-trigger-activation-range-end', 'inherit');
	assertEq(
		s.getPropertyValue('timeline-trigger-activation-range-end'),
		'inherit',
		'timeline-trigger-activation-range-end: accepts inherit'
	);
	s.timelineTriggerActivationRangeEnd = '';
	assertEq(
		s.timelineTriggerActivationRangeEnd,
		'',
		'timeline-trigger-activation-range-end: empty string removes'
	);
}
...
// --- timeline-trigger-active-range-start ---
{
	...
	assertEq(
		...
		'initial',
		'timeline-trigger-active-range-start: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-active-range-start'),
		'initial',
		'timeline-trigger-active-range-start: getPropertyValue matches accessor'
	);
	s.timelineTriggerActiveRangeStart = 'inherit';
	assertEq(
		s.timelineTriggerActiveRangeStart,
		'inherit',
		'timeline-trigger-active-range-start: overwrite with second value'
	);
	s.removeProperty('timeline-trigger-active-range-start');
	assertEq(
		s.timelineTriggerActiveRangeStart,
		'',
		'timeline-trigger-active-range-start: removeProperty clears value'
	);
	s.setProperty('timeline-trigger-active-range-start', 'inherit');
	assertEq(
		s.getPropertyValue('timeline-trigger-active-range-start'),
		'inherit',
		'timeline-trigger-active-range-start: accepts inherit'
	);
	s.timelineTriggerActiveRangeStart = '';
	assertEq(
		s.timelineTriggerActiveRangeStart,
		'',
		'timeline-trigger-active-range-start: empty string removes'
	);
}
...
// --- timeline-trigger-active-range-end ---
{
	...
	assertEq(
		...
		'initial',
		'timeline-trigger-active-range-end: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-active-range-end'),
		'initial',
		'timeline-trigger-active-range-end: getPropertyValue matches accessor'
	);
	s.timelineTriggerActiveRangeEnd = 'inherit';
	assertEq(
		s.timelineTriggerActiveRangeEnd,
		'inherit',
		'timeline-trigger-active-range-end: overwrite with second value'
	);
	s.removeProperty('timeline-trigger-active-range-end');
	assertEq(
		s.timelineTriggerActiveRangeEnd,
		'',
		'timeline-trigger-active-range-end: removeProperty clears value'
	);
	s.setProperty('timeline-trigger-active-range-end', 'inherit');
	assertEq(
		s.getPropertyValue('timeline-trigger-active-range-end'),
		'inherit',
		'timeline-trigger-active-range-end: accepts inherit'
	);
	s.timelineTriggerActiveRangeEnd = '';
	assertEq(
		s.timelineTriggerActiveRangeEnd,
		'',
		'timeline-trigger-active-range-end: empty string removes'
	);
}
...
// --- timeline-trigger-source ---
{
	...
	assertEq(
		...
		'none',
		'timeline-trigger-source: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-source'),
		'none',
		'timeline-trigger-source: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('timeline-trigger-source'),
		'inherit',
		'timeline-trigger-source: accepts inherit'
	);
	s.timelineTriggerSource = '';
...
// --- transition-delay ---
{
	...
	assertEq(
		s.getPropertyValue('transition-delay'),
		'1s',
		'transition-delay: getPropertyValue matches accessor'
	);
...
// --- transition-duration ---
{
	...
	assertEq(
		s.getPropertyValue('transition-duration'),
		'1s',
		'transition-duration: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('transition-duration'),
		'inherit',
		'transition-duration: accepts inherit'
	);
...
// --- transition-property ---
{
	...
	assertEq(
		s.getPropertyValue('transition-property'),
		'none',
		'transition-property: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('transition-property'),
		'inherit',
		'transition-property: accepts inherit'
	);
...
// --- transition-behavior ---
{
	...
	assertEq(
		s.getPropertyValue('transition-behavior'),
		'normal',
		'transition-behavior: getPropertyValue matches accessor'
	);
	s.transitionBehavior = 'allow-discrete';
	assertEq(
		s.transitionBehavior,
		'allow-discrete',
		'transition-behavior: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('transition-behavior'),
		'inherit',
		'transition-behavior: accepts inherit'
	);
	s.transitionBehavior = '';
...
// --- transition-timing-function ---
{
	...
	assertEq(
		...
		'linear',
		'transition-timing-function: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('transition-timing-function'),
		'linear',
		'transition-timing-function: getPropertyValue matches accessor'
	);
	s.transitionTimingFunction = 'ease';
	assertEq(
		s.transitionTimingFunction,
		'ease',
		'transition-timing-function: overwrite with second value'
	);
	s.removeProperty('transition-timing-function');
	assertEq(
		s.transitionTimingFunction,
		'',
		'transition-timing-function: removeProperty clears value'
	);
	s.setProperty('transition-timing-function', 'inherit');
	assertEq(
		s.getPropertyValue('transition-timing-function'),
		'inherit',
		'transition-timing-function: accepts inherit'
	);
	s.transitionTimingFunction = '';
	...
	assertEq(
		s.transitionTimingFunction,
		'linear',
		'transition-timing-function: rejects invalid keyword'
	);
}
...
// --- trigger-scope ---
{
	...
	assertEq(
		s.getPropertyValue('trigger-scope'),
		'none',
		'trigger-scope: getPropertyValue matches accessor'
	);
	s.triggerScope = 'all';
...
// --- font-family ---
{
	...
	assertEq(
		...
		'Arial',
		'font-family: getPropertyValue matches accessor'
	);
...
// --- font-kerning ---
{
	...
	assertEq(
		s.getPropertyValue('font-kerning'),
		'auto',
		'font-kerning: getPropertyValue matches accessor'
	);
...
// --- font-optical-sizing ---
{
	...
	assertEq(
		s.getPropertyValue('font-optical-sizing'),
		'auto',
		'font-optical-sizing: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('font-optical-sizing'),
		'inherit',
		'font-optical-sizing: accepts inherit'
	);
	s.fontOpticalSizing = '';
...
// --- font-palette ---
{
	...
	assertEq(
		s.getPropertyValue('font-palette'),
		'normal',
		'font-palette: getPropertyValue matches accessor'
	);
	s.fontPalette = 'light';
...
// --- font-size-adjust ---
{
	...
	assertEq(
		s.getPropertyValue('font-size-adjust'),
		'1',
		'font-size-adjust: getPropertyValue matches accessor'
	);
	s.fontSizeAdjust = '2';
...
// --- font-stretch ---
{
	...
	assertEq(
		...
		'normal',
		'font-stretch: getPropertyValue matches accessor'
	);
...
// --- font-style ---
{
	...
	assertEq(
		...
		'normal',
		'font-style: getPropertyValue matches accessor'
	);
	s.fontStyle = 'italic';
...
// --- font-variant-ligatures ---
{
	...
	assertEq(
		...
		'normal',
		'font-variant-ligatures: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('font-variant-ligatures'),
		'normal',
		'font-variant-ligatures: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('font-variant-ligatures'),
		'inherit',
		'font-variant-ligatures: accepts inherit'
	);
	s.fontVariantLigatures = '';
...
// --- font-variant-caps ---
{
	...
	assertEq(
		s.getPropertyValue('font-variant-caps'),
		'normal',
		'font-variant-caps: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('font-variant-caps'),
		'inherit',
		'font-variant-caps: accepts inherit'
	);
	s.fontVariantCaps = '';
...
// --- font-variant-east-asian ---
{
	...
	assertEq(
		...
		'normal',
		'font-variant-east-asian: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('font-variant-east-asian'),
		'normal',
		'font-variant-east-asian: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('font-variant-east-asian'),
		'inherit',
		'font-variant-east-asian: accepts inherit'
	);
	s.fontVariantEastAsian = '';
...
// --- font-variant-numeric ---
{
	...
	assertEq(
		s.getPropertyValue('font-variant-numeric'),
		'normal',
		'font-variant-numeric: getPropertyValue matches accessor'
	);
	s.fontVariantNumeric = 'lining-nums';
	assertEq(
		s.fontVariantNumeric,
		'lining-nums',
		'font-variant-numeric: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('font-variant-numeric'),
		'inherit',
		'font-variant-numeric: accepts inherit'
	);
	s.fontVariantNumeric = '';
...
// --- font-variant-alternates ---
{
	...
	assertEq(
		...
		'normal',
		'font-variant-alternates: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('font-variant-alternates'),
		'normal',
		'font-variant-alternates: getPropertyValue matches accessor'
	);
	s.fontVariantAlternates = 'inherit';
	assertEq(
		s.fontVariantAlternates,
		'inherit',
		'font-variant-alternates: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('font-variant-alternates'),
		'inherit',
		'font-variant-alternates: accepts inherit'
	);
	s.fontVariantAlternates = '';
...
// --- font-weight ---
{
	...
	assertEq(
		...
		'1',
		'font-weight: getPropertyValue matches accessor'
	);
	s.fontWeight = '2';
...
// --- font-synthesis-weight ---
{
	...
	assertEq(
		s.getPropertyValue('font-synthesis-weight'),
		'auto',
		'font-synthesis-weight: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('font-synthesis-weight'),
		'inherit',
		'font-synthesis-weight: accepts inherit'
	);
...
// --- font-synthesis-style ---
{
	...
	assertEq(
		s.getPropertyValue('font-synthesis-style'),
		'auto',
		'font-synthesis-style: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('font-synthesis-style'),
		'inherit',
		'font-synthesis-style: accepts inherit'
	);
...
// --- font-synthesis-small-caps ---
{
	...
	assertEq(
		...
		'auto',
		'font-synthesis-small-caps: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('font-synthesis-small-caps'),
		'auto',
		'font-synthesis-small-caps: getPropertyValue matches accessor'
	);
	s.fontSynthesisSmallCaps = 'none';
	assertEq(
		s.fontSynthesisSmallCaps,
		'none',
		'font-synthesis-small-caps: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('font-synthesis-small-caps'),
		'inherit',
		'font-synthesis-small-caps: accepts inherit'
	);
	s.fontSynthesisSmallCaps = '';
...
// --- font-feature-settings ---
{
	...
	assertEq(
		...
		'normal',
		'font-feature-settings: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('font-feature-settings'),
		'normal',
		'font-feature-settings: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('font-feature-settings'),
		'inherit',
		'font-feature-settings: accepts inherit'
	);
	s.fontFeatureSettings = '';
...
// --- font-variation-settings ---
{
	...
	assertEq(
		...
		'normal',
		'font-variation-settings: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('font-variation-settings'),
		'normal',
		'font-variation-settings: getPropertyValue matches accessor'
	);
	s.fontVariationSettings = 'inherit';
	assertEq(
		s.fontVariationSettings,
		'inherit',
		'font-variation-settings: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('font-variation-settings'),
		'inherit',
		'font-variation-settings: accepts inherit'
	);
	s.fontVariationSettings = '';
...
// --- font-language-override ---
{
	...
	assertEq(
		...
		'normal',
		'font-language-override: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('font-language-override'),
		'normal',
		'font-language-override: getPropertyValue matches accessor'
	);
	s.fontLanguageOverride = 'inherit';
	assertEq(
		s.fontLanguageOverride,
		'inherit',
		'font-language-override: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('font-language-override'),
		'inherit',
		'font-language-override: accepts inherit'
	);
	s.fontLanguageOverride = '';
...
// --- font-variant-emoji ---
{
	...
	assertEq(
		s.getPropertyValue('font-variant-emoji'),
		'normal',
		'font-variant-emoji: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('font-variant-emoji'),
		'inherit',
		'font-variant-emoji: accepts inherit'
	);
	s.fontVariantEmoji = '';
...
// --- font-variant-position ---
{
	...
	assertEq(
		...
		'normal',
		'font-variant-position: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('font-variant-position'),
		'normal',
		'font-variant-position: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('font-variant-position'),
		'inherit',
		'font-variant-position: accepts inherit'
	);
	s.fontVariantPosition = '';
...
// --- -webkit-font-smoothing ---
{
	...
	assertEq(
		...
		'initial',
		'-webkit-font-smoothing: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-font-smoothing'),
		'initial',
		'-webkit-font-smoothing: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-font-smoothing'),
		'inherit',
		'-webkit-font-smoothing: accepts inherit'
	);
	s.webkitFontSmoothing = '';
...
// --- forced-color-adjust ---
{
	...
	assertEq(
		s.getPropertyValue('forced-color-adjust'),
		'auto',
		'forced-color-adjust: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('forced-color-adjust'),
		'inherit',
		'forced-color-adjust: accepts inherit'
	);
	s.forcedColorAdjust = '';
...
// --- field-sizing ---
{
	...
	assertEq(
		s.getPropertyValue('field-sizing'),
		'fixed',
		'field-sizing: getPropertyValue matches accessor'
	);
...
// --- -webkit-locale ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-locale'),
		'initial',
		'-webkit-locale: getPropertyValue matches accessor'
	);
...
// --- math-depth ---
{
	...
	assertEq(
		s.getPropertyValue('math-depth'),
		'initial',
		'math-depth: getPropertyValue matches accessor'
	);
	s.mathDepth = 'inherit';
...
// --- text-orientation ---
{
	...
	assertEq(
		s.getPropertyValue('text-orientation'),
		'sideways',
		'text-orientation: getPropertyValue matches accessor'
	);
...
// --- -webkit-text-orientation ---
{
	...
	assertEq(
		...
		'initial',
		'-webkit-text-orientation: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-text-orientation'),
		'initial',
		'-webkit-text-orientation: getPropertyValue matches accessor'
	);
	s.webkitTextOrientation = 'inherit';
	assertEq(
		s.webkitTextOrientation,
		'inherit',
		'-webkit-text-orientation: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-text-orientation'),
		'inherit',
		'-webkit-text-orientation: accepts inherit'
	);
	s.webkitTextOrientation = '';
...
// --- writing-mode ---
{
	...
	assertEq(
		s.getPropertyValue('writing-mode'),
		'horizontal-tb',
		'writing-mode: getPropertyValue matches accessor'
	);
...
// --- -webkit-writing-mode ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-writing-mode'),
		'initial',
		'-webkit-writing-mode: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-writing-mode'),
		'inherit',
		'-webkit-writing-mode: accepts inherit'
	);
	s.webkitWritingMode = '';
...
// --- text-rendering ---
{
	...
	assertEq(
		s.getPropertyValue('text-rendering'),
		'auto',
		'text-rendering: getPropertyValue matches accessor'
	);
...
// --- accent-color ---
{
	...
	assertEq(
		...
		'red',
		'accent-color: getPropertyValue matches accessor'
	);
	s.accentColor = 'blue';
...
// --- align-content ---
{
	...
	assertEq(
		s.getPropertyValue('align-content'),
		'initial',
		'align-content: getPropertyValue matches accessor'
	);
...
// --- align-items ---
{
	...
	assertEq(
		s.getPropertyValue('align-items'),
		'initial',
		'align-items: getPropertyValue matches accessor'
	);
...
// --- alignment-baseline ---
{
	...
	assertEq(
		s.getPropertyValue('alignment-baseline'),
		'auto',
		'alignment-baseline: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('alignment-baseline'),
		'inherit',
		'alignment-baseline: accepts inherit'
	);
	s.alignmentBaseline = '';
...
// --- align-self ---
{
	...
	assertEq(
		s.getPropertyValue('align-self'),
		'initial',
		'align-self: getPropertyValue matches accessor'
	);
	s.alignSelf = 'inherit';
...
// --- anchor-name ---
{
	...
	assertEq(
		s.getPropertyValue('anchor-name'),
		'none',
		'anchor-name: getPropertyValue matches accessor'
	);
...
// --- anchor-scope ---
{
	...
	assertEq(
		s.getPropertyValue('anchor-scope'),
		'none',
		'anchor-scope: getPropertyValue matches accessor'
	);
	s.anchorScope = 'all';
...
// --- aspect-ratio ---
{
	...
	assertEq(
		s.getPropertyValue('aspect-ratio'),
		'auto',
		'aspect-ratio: getPropertyValue matches accessor'
	);
...
// --- backdrop-filter ---
{
	...
	assertEq(
		...
		'none',
		'backdrop-filter: getPropertyValue matches accessor'
	);
...
// --- backface-visibility ---
{
	...
	assertEq(
		s.getPropertyValue('backface-visibility'),
		'visible',
		'backface-visibility: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('backface-visibility'),
		'inherit',
		'backface-visibility: accepts inherit'
	);
...
// --- background-attachment ---
{
	...
	assertEq(
		...
		'scroll',
		'background-attachment: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('background-attachment'),
		'scroll',
		'background-attachment: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('background-attachment'),
		'inherit',
		'background-attachment: accepts inherit'
	);
	s.backgroundAttachment = '';
...
// --- background-blend-mode ---
{
	...
	assertEq(
		...
		'normal',
		'background-blend-mode: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('background-blend-mode'),
		'normal',
		'background-blend-mode: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('background-blend-mode'),
		'inherit',
		'background-blend-mode: accepts inherit'
	);
	s.backgroundBlendMode = '';
...
// --- background-clip ---
{
	...
	assertEq(
		...
		'border-box',
		'background-clip: getPropertyValue matches accessor'
	);
...
// --- background-color ---
{
	...
	assertEq(
		...
		'red',
		'background-color: getPropertyValue matches accessor'
	);
...
// --- background-image ---
{
	...
	assertEq(
		s.getPropertyValue('background-image'),
		'auto',
		'background-image: getPropertyValue matches accessor'
	);
...
// --- background-origin ---
{
	...
	assertEq(
		s.getPropertyValue('background-origin'),
		'border-box',
		'background-origin: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('background-origin'),
		'inherit',
		'background-origin: accepts inherit'
	);
	s.backgroundOrigin = '';
...
// --- background-position-x ---
{
	...
	assertEq(
		...
		'initial',
		'background-position-x: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('background-position-x'),
		'initial',
		'background-position-x: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('background-position-x'),
		'inherit',
		'background-position-x: accepts inherit'
	);
	s.backgroundPositionX = '';
...
// --- background-position-y ---
{
	...
	assertEq(
		...
		'initial',
		'background-position-y: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('background-position-y'),
		'initial',
		'background-position-y: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('background-position-y'),
		'inherit',
		'background-position-y: accepts inherit'
	);
	s.backgroundPositionY = '';
...
// --- background-repeat ---
{
	...
	assertEq(
		s.getPropertyValue('background-repeat'),
		'initial',
		'background-repeat: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('background-repeat'),
		'inherit',
		'background-repeat: accepts inherit'
	);
	s.backgroundRepeat = '';
...
// --- background-size ---
{
	...
	assertEq(
		s.getPropertyValue('background-size'),
		'auto',
		'background-size: getPropertyValue matches accessor'
	);
...
// --- baseline-shift ---
{
	...
	assertEq(
		s.getPropertyValue('baseline-shift'),
		'baseline',
		'baseline-shift: getPropertyValue matches accessor'
	);
	s.baselineShift = 'sub';
...
// --- baseline-source ---
{
	...
	assertEq(
		s.getPropertyValue('baseline-source'),
		'auto',
		'baseline-source: getPropertyValue matches accessor'
	);
...
// --- border-bottom-color ---
{
	...
	assertEq(
		s.getPropertyValue('border-bottom-color'),
		'red',
		'border-bottom-color: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-bottom-color'),
		'inherit',
		'border-bottom-color: accepts inherit'
	);
	s.borderBottomColor = '';
...
// --- border-bottom-left-radius ---
{
	...
	assertEq(
		...
		'10px',
		'border-bottom-left-radius: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('border-bottom-left-radius'),
		'10px',
		'border-bottom-left-radius: getPropertyValue matches accessor'
	);
	s.borderBottomLeftRadius = '20px';
	assertEq(
		s.borderBottomLeftRadius,
		'20px',
		'border-bottom-left-radius: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('border-bottom-left-radius'),
		'inherit',
		'border-bottom-left-radius: accepts inherit'
	);
	s.borderBottomLeftRadius = '';
...
// --- border-bottom-right-radius ---
{
	...
	assertEq(
		...
		'10px',
		'border-bottom-right-radius: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('border-bottom-right-radius'),
		'10px',
		'border-bottom-right-radius: getPropertyValue matches accessor'
	);
	s.borderBottomRightRadius = '20px';
	assertEq(
		s.borderBottomRightRadius,
		'20px',
		'border-bottom-right-radius: overwrite with second value'
	);
	s.removeProperty('border-bottom-right-radius');
	assertEq(
		s.borderBottomRightRadius,
		'',
		'border-bottom-right-radius: removeProperty clears value'
	);
	s.setProperty('border-bottom-right-radius', 'inherit');
	assertEq(
		s.getPropertyValue('border-bottom-right-radius'),
		'inherit',
		'border-bottom-right-radius: accepts inherit'
	);
	s.borderBottomRightRadius = '';
...
// --- border-bottom-style ---
{
	...
	assertEq(
		s.getPropertyValue('border-bottom-style'),
		'none',
		'border-bottom-style: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-bottom-style'),
		'inherit',
		'border-bottom-style: accepts inherit'
	);
	s.borderBottomStyle = '';
...
// --- border-bottom-width ---
{
	...
	assertEq(
		s.getPropertyValue('border-bottom-width'),
		'10px',
		'border-bottom-width: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-bottom-width'),
		'inherit',
		'border-bottom-width: accepts inherit'
	);
	s.borderBottomWidth = '';
...
// --- border-collapse ---
{
	...
	assertEq(
		s.getPropertyValue('border-collapse'),
		'separate',
		'border-collapse: getPropertyValue matches accessor'
	);
...
// --- border-image-outset ---
{
	...
	assertEq(
		s.getPropertyValue('border-image-outset'),
		'none',
		'border-image-outset: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-image-outset'),
		'inherit',
		'border-image-outset: accepts inherit'
	);
	s.borderImageOutset = '';
...
// --- border-image-repeat ---
{
	...
	assertEq(
		s.getPropertyValue('border-image-repeat'),
		'stretch',
		'border-image-repeat: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-image-repeat'),
		'inherit',
		'border-image-repeat: accepts inherit'
	);
	s.borderImageRepeat = '';
...
// --- border-image-slice ---
{
	...
	assertEq(
		s.getPropertyValue('border-image-slice'),
		'none',
		'border-image-slice: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-image-slice'),
		'inherit',
		'border-image-slice: accepts inherit'
	);
	s.borderImageSlice = '';
...
// --- border-image-source ---
{
	...
	assertEq(
		s.getPropertyValue('border-image-source'),
		'none',
		'border-image-source: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-image-source'),
		'inherit',
		'border-image-source: accepts inherit'
	);
	s.borderImageSource = '';
...
// --- border-image-width ---
{
	...
	assertEq(
		s.getPropertyValue('border-image-width'),
		'auto',
		'border-image-width: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-image-width'),
		'inherit',
		'border-image-width: accepts inherit'
	);
	s.borderImageWidth = '';
...
// --- border-left-color ---
{
	...
	assertEq(
		s.getPropertyValue('border-left-color'),
		'red',
		'border-left-color: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-left-color'),
		'inherit',
		'border-left-color: accepts inherit'
	);
	s.borderLeftColor = '';
...
// --- border-left-style ---
{
	...
	assertEq(
		s.getPropertyValue('border-left-style'),
		'none',
		'border-left-style: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-left-style'),
		'inherit',
		'border-left-style: accepts inherit'
	);
	s.borderLeftStyle = '';
...
// --- border-left-width ---
{
	...
	assertEq(
		...
		'10px',
		'border-left-width: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-left-width'),
		'inherit',
		'border-left-width: accepts inherit'
	);
	s.borderLeftWidth = '';
...
// --- border-right-color ---
{
	...
	assertEq(
		s.getPropertyValue('border-right-color'),
		'red',
		'border-right-color: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-right-color'),
		'inherit',
		'border-right-color: accepts inherit'
	);
	s.borderRightColor = '';
...
// --- border-right-style ---
{
	...
	assertEq(
		s.getPropertyValue('border-right-style'),
		'none',
		'border-right-style: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-right-style'),
		'inherit',
		'border-right-style: accepts inherit'
	);
	s.borderRightStyle = '';
...
// --- border-right-width ---
{
	...
	assertEq(
		s.getPropertyValue('border-right-width'),
		'10px',
		'border-right-width: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-right-width'),
		'inherit',
		'border-right-width: accepts inherit'
	);
	s.borderRightWidth = '';
...
// --- border-top-color ---
{
	...
	assertEq(
		s.getPropertyValue('border-top-color'),
		'red',
		'border-top-color: getPropertyValue matches accessor'
	);
...
// --- border-top-left-radius ---
{
	...
	assertEq(
		...
		'10px',
		'border-top-left-radius: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('border-top-left-radius'),
		'10px',
		'border-top-left-radius: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-top-left-radius'),
		'inherit',
		'border-top-left-radius: accepts inherit'
	);
	s.borderTopLeftRadius = '';
...
// --- border-top-right-radius ---
{
	...
	assertEq(
		...
		'10px',
		'border-top-right-radius: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('border-top-right-radius'),
		'10px',
		'border-top-right-radius: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-top-right-radius'),
		'inherit',
		'border-top-right-radius: accepts inherit'
	);
	s.borderTopRightRadius = '';
...
// --- border-top-style ---
{
	...
	assertEq(
		s.getPropertyValue('border-top-style'),
		'none',
		'border-top-style: getPropertyValue matches accessor'
	);
...
// --- border-top-width ---
{
	...
	assertEq(
		...
		'10px',
		'border-top-width: getPropertyValue matches accessor'
	);
...
// --- border-shape ---
{
	...
	assertEq(
		s.getPropertyValue('border-shape'),
		'none',
		'border-shape: getPropertyValue matches accessor'
	);
...
// --- box-decoration-break ---
{
	...
	assertEq(
		...
		'slice',
		'box-decoration-break: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('box-decoration-break'),
		'inherit',
		'box-decoration-break: accepts inherit'
	);
...
// --- box-shadow ---
{
	...
	assertEq(
		...
		'none',
		'box-shadow: getPropertyValue matches accessor'
	);
	s.boxShadow = 'inherit';
...
// --- box-sizing ---
{
	...
	assertEq(
		...
		'content-box',
		'box-sizing: getPropertyValue matches accessor'
	);
...
// --- break-after ---
{
	...
	assertEq(
		s.getPropertyValue('break-after'),
		'auto',
		'break-after: getPropertyValue matches accessor'
	);
	s.breakAfter = 'avoid';
...
// --- break-before ---
{
	...
	assertEq(
		s.getPropertyValue('break-before'),
		'auto',
		'break-before: getPropertyValue matches accessor'
	);
	s.breakBefore = 'avoid';
...
// --- break-inside ---
{
	...
	assertEq(
		s.getPropertyValue('break-inside'),
		'auto',
		'break-inside: getPropertyValue matches accessor'
	);
	s.breakInside = 'avoid';
...
// --- buffered-rendering ---
{
	...
	assertEq(
		s.getPropertyValue('buffered-rendering'),
		'auto',
		'buffered-rendering: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('buffered-rendering'),
		'inherit',
		'buffered-rendering: accepts inherit'
	);
	s.bufferedRendering = '';
...
// --- caption-side ---
{
	...
	assertEq(
		s.getPropertyValue('caption-side'),
		'top',
		'caption-side: getPropertyValue matches accessor'
	);
...
// --- caret-animation ---
{
	...
	assertEq(
		s.getPropertyValue('caret-animation'),
		'auto',
		'caret-animation: getPropertyValue matches accessor'
	);
...
// --- caret-color ---
{
	...
	assertEq(
		s.getPropertyValue('caret-color'),
		'red',
		'caret-color: getPropertyValue matches accessor'
	);
	s.caretColor = 'blue';
...
// --- caret-shape ---
{
	...
	assertEq(
		s.getPropertyValue('caret-shape'),
		'auto',
		'caret-shape: getPropertyValue matches accessor'
	);
	s.caretShape = 'bar';
...
// --- clip-path ---
{
	...
	assertEq(
		s.getPropertyValue('clip-path'),
		'border-box',
		'clip-path: getPropertyValue matches accessor'
	);
...
// --- clip-rule ---
{
	...
	assertEq(
		s.getPropertyValue('clip-rule'),
		'nonzero',
		'clip-rule: getPropertyValue matches accessor'
	);
	s.clipRule = 'evenodd';
...
// --- color-interpolation ---
{
	...
	assertEq(
		s.getPropertyValue('color-interpolation'),
		'auto',
		'color-interpolation: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('color-interpolation'),
		'inherit',
		'color-interpolation: accepts inherit'
	);
...
// --- color-interpolation-filters ---
{
	...
	assertEq(
		...
		'auto',
		'color-interpolation-filters: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('color-interpolation-filters'),
		'auto',
		'color-interpolation-filters: getPropertyValue matches accessor'
	);
	s.colorInterpolationFilters = 'srgb';
	assertEq(
		s.colorInterpolationFilters,
		'srgb',
		'color-interpolation-filters: overwrite with second value'
	);
	s.removeProperty('color-interpolation-filters');
	assertEq(
		s.colorInterpolationFilters,
		'',
		'color-interpolation-filters: removeProperty clears value'
	);
	s.setProperty('color-interpolation-filters', 'inherit');
	assertEq(
		s.getPropertyValue('color-interpolation-filters'),
		'inherit',
		'color-interpolation-filters: accepts inherit'
	);
	s.colorInterpolationFilters = '';
	...
	assertEq(
		s.colorInterpolationFilters,
		'auto',
		'color-interpolation-filters: rejects invalid keyword'
	);
}
...
// --- color-rendering ---
{
	...
	assertEq(
		s.getPropertyValue('color-rendering'),
		'auto',
		'color-rendering: getPropertyValue matches accessor'
	);
...
// --- color-scheme ---
{
	...
	assertEq(
		s.getPropertyValue('color-scheme'),
		'blue',
		'color-scheme: getPropertyValue matches accessor'
	);
...
// --- column-fill ---
{
	...
	assertEq(
		s.getPropertyValue('column-fill'),
		'balance',
		'column-fill: getPropertyValue matches accessor'
	);
	s.columnFill = 'auto';
...
// --- contain-intrinsic-width ---
{
	...
	assertEq(
		...
		'none',
		'contain-intrinsic-width: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('contain-intrinsic-width'),
		'none',
		'contain-intrinsic-width: getPropertyValue matches accessor'
	);
	s.containIntrinsicWidth = 'inherit';
	assertEq(
		s.containIntrinsicWidth,
		'inherit',
		'contain-intrinsic-width: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('contain-intrinsic-width'),
		'inherit',
		'contain-intrinsic-width: accepts inherit'
	);
	s.containIntrinsicWidth = '';
...
// --- contain-intrinsic-height ---
{
	...
	assertEq(
		...
		'none',
		'contain-intrinsic-height: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('contain-intrinsic-height'),
		'none',
		'contain-intrinsic-height: getPropertyValue matches accessor'
	);
	s.containIntrinsicHeight = 'inherit';
	assertEq(
		s.containIntrinsicHeight,
		'inherit',
		'contain-intrinsic-height: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('contain-intrinsic-height'),
		'inherit',
		'contain-intrinsic-height: accepts inherit'
	);
	s.containIntrinsicHeight = '';
...
// --- container-name ---
{
	...
	assertEq(
		s.getPropertyValue('container-name'),
		'none',
		'container-name: getPropertyValue matches accessor'
	);
...
// --- container-type ---
{
	...
	assertEq(
		s.getPropertyValue('container-type'),
		'normal',
		'container-type: getPropertyValue matches accessor'
	);
...
// --- corner-bottom-left-shape ---
{
	...
	assertEq(
		...
		'notch',
		'corner-bottom-left-shape: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-left-shape'),
		'notch',
		'corner-bottom-left-shape: getPropertyValue matches accessor'
	);
	s.cornerBottomLeftShape = 'scoop';
	assertEq(
		s.cornerBottomLeftShape,
		'scoop',
		'corner-bottom-left-shape: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('corner-bottom-left-shape'),
		'inherit',
		'corner-bottom-left-shape: accepts inherit'
	);
	s.cornerBottomLeftShape = '';
...
// --- corner-bottom-right-shape ---
{
	...
	assertEq(
		...
		'notch',
		'corner-bottom-right-shape: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-right-shape'),
		'notch',
		'corner-bottom-right-shape: getPropertyValue matches accessor'
	);
	s.cornerBottomRightShape = 'scoop';
	assertEq(
		s.cornerBottomRightShape,
		'scoop',
		'corner-bottom-right-shape: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('corner-bottom-right-shape'),
		'inherit',
		'corner-bottom-right-shape: accepts inherit'
	);
	s.cornerBottomRightShape = '';
...
// --- corner-top-left-shape ---
{
	...
	assertEq(
		s.getPropertyValue('corner-top-left-shape'),
		'notch',
		'corner-top-left-shape: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('corner-top-left-shape'),
		'inherit',
		'corner-top-left-shape: accepts inherit'
	);
...
// --- corner-top-right-shape ---
{
	...
	assertEq(
		...
		'notch',
		'corner-top-right-shape: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('corner-top-right-shape'),
		'notch',
		'corner-top-right-shape: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('corner-top-right-shape'),
		'inherit',
		'corner-top-right-shape: accepts inherit'
	);
	s.cornerTopRightShape = '';
...
// --- counter-increment ---
{
	...
	assertEq(
		s.getPropertyValue('counter-increment'),
		'none',
		'counter-increment: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('counter-increment'),
		'inherit',
		'counter-increment: accepts inherit'
	);
	s.counterIncrement = '';
...
// --- counter-reset ---
{
	...
	assertEq(
		s.getPropertyValue('counter-reset'),
		'none',
		'counter-reset: getPropertyValue matches accessor'
	);
...
// --- counter-set ---
{
	...
	assertEq(
		s.getPropertyValue('counter-set'),
		'none',
		'counter-set: getPropertyValue matches accessor'
	);
...
// --- dominant-baseline ---
{
	...
	assertEq(
		s.getPropertyValue('dominant-baseline'),
		'auto',
		'dominant-baseline: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('dominant-baseline'),
		'inherit',
		'dominant-baseline: accepts inherit'
	);
	s.dominantBaseline = '';
...
// --- empty-cells ---
{
	...
	assertEq(
		s.getPropertyValue('empty-cells'),
		'show',
		'empty-cells: getPropertyValue matches accessor'
	);
	s.emptyCells = 'hide';
...
// --- fill-opacity ---
{
	...
	assertEq(
		s.getPropertyValue('fill-opacity'),
		'1',
		'fill-opacity: getPropertyValue matches accessor'
	);
	s.fillOpacity = '2';
...
// --- fill-rule ---
{
	...
	assertEq(
		s.getPropertyValue('fill-rule'),
		'nonzero',
		'fill-rule: getPropertyValue matches accessor'
	);
	s.fillRule = 'evenodd';
...
// --- flex-basis ---
{
	...
	assertEq(
		s.getPropertyValue('flex-basis'),
		'10px',
		'flex-basis: getPropertyValue matches accessor'
	);
	s.flexBasis = '20px';
...
// --- flex-direction ---
{
	...
	assertEq(
		s.getPropertyValue('flex-direction'),
		'row',
		'flex-direction: getPropertyValue matches accessor'
	);
...
// --- flex-shrink ---
{
	...
	assertEq(
		s.getPropertyValue('flex-shrink'),
		'1',
		'flex-shrink: getPropertyValue matches accessor'
	);
	s.flexShrink = '2';
...
// --- flex-wrap ---
{
	...
	assertEq(
		s.getPropertyValue('flex-wrap'),
		'nowrap',
		'flex-wrap: getPropertyValue matches accessor'
	);
	s.flexWrap = 'wrap';
...
// --- flood-color ---
{
	...
	assertEq(
		s.getPropertyValue('flood-color'),
		'red',
		'flood-color: getPropertyValue matches accessor'
	);
	s.floodColor = 'blue';
...
// --- flood-opacity ---
{
	...
	assertEq(
		s.getPropertyValue('flood-opacity'),
		'1',
		'flood-opacity: getPropertyValue matches accessor'
	);
	s.floodOpacity = '2';
...
// --- flow-tolerance ---
{
	...
	assertEq(
		s.getPropertyValue('flow-tolerance'),
		'normal',
		'flow-tolerance: getPropertyValue matches accessor'
	);
...
// --- frame-sizing ---
{
	...
	assertEq(
		s.getPropertyValue('frame-sizing'),
		'auto',
		'frame-sizing: getPropertyValue matches accessor'
	);
...
// --- grid-auto-columns ---
{
	...
	assertEq(
		s.getPropertyValue('grid-auto-columns'),
		'auto',
		'grid-auto-columns: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('grid-auto-columns'),
		'inherit',
		'grid-auto-columns: accepts inherit'
	);
	s.gridAutoColumns = '';
...
// --- grid-auto-flow ---
{
	...
	assertEq(
		s.getPropertyValue('grid-auto-flow'),
		'row',
		'grid-auto-flow: getPropertyValue matches accessor'
	);
...
// --- grid-auto-rows ---
{
	...
	assertEq(
		s.getPropertyValue('grid-auto-rows'),
		'auto',
		'grid-auto-rows: getPropertyValue matches accessor'
	);
...
// --- grid-column-end ---
{
	...
	assertEq(
		s.getPropertyValue('grid-column-end'),
		'auto',
		'grid-column-end: getPropertyValue matches accessor'
	);
...
// --- grid-column-start ---
{
	...
	assertEq(
		s.getPropertyValue('grid-column-start'),
		'auto',
		'grid-column-start: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('grid-column-start'),
		'inherit',
		'grid-column-start: accepts inherit'
	);
	s.gridColumnStart = '';
...
// --- grid-lanes-direction ---
{
	...
	assertEq(
		s.getPropertyValue('grid-lanes-direction'),
		'normal',
		'grid-lanes-direction: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('grid-lanes-direction'),
		'inherit',
		'grid-lanes-direction: accepts inherit'
	);
...
// --- grid-lanes-pack ---
{
	...
	assertEq(
		s.getPropertyValue('grid-lanes-pack'),
		'normal',
		'grid-lanes-pack: getPropertyValue matches accessor'
	);
...
// --- grid-row-end ---
{
	...
	assertEq(
		s.getPropertyValue('grid-row-end'),
		'auto',
		'grid-row-end: getPropertyValue matches accessor'
	);
...
// --- grid-row-start ---
{
	...
	assertEq(
		s.getPropertyValue('grid-row-start'),
		'auto',
		'grid-row-start: getPropertyValue matches accessor'
	);
...
// --- grid-template-areas ---
{
	...
	assertEq(
		s.getPropertyValue('grid-template-areas'),
		'none',
		'grid-template-areas: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('grid-template-areas'),
		'inherit',
		'grid-template-areas: accepts inherit'
	);
	s.gridTemplateAreas = '';
...
// --- grid-template-columns ---
{
	...
	assertEq(
		s.getPropertyValue('grid-template-columns'),
		'none',
		'grid-template-columns: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('grid-template-columns'),
		'inherit',
		'grid-template-columns: accepts inherit'
	);
...
// --- grid-template-rows ---
{
	...
	assertEq(
		s.getPropertyValue('grid-template-rows'),
		'none',
		'grid-template-rows: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('grid-template-rows'),
		'inherit',
		'grid-template-rows: accepts inherit'
	);
	s.gridTemplateRows = '';
...
// --- hyphenate-limit-chars ---
{
	...
	assertEq(
		s.getPropertyValue('hyphenate-limit-chars'),
		'auto',
		'hyphenate-limit-chars: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('hyphenate-limit-chars'),
		'inherit',
		'hyphenate-limit-chars: accepts inherit'
	);
...
// --- interest-delay-start ---
{
	...
	assertEq(
		s.getPropertyValue('interest-delay-start'),
		'1s',
		'interest-delay-start: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('interest-delay-start'),
		'inherit',
		'interest-delay-start: accepts inherit'
	);
...
// --- interest-delay-end ---
{
	...
	assertEq(
		s.getPropertyValue('interest-delay-end'),
		'1s',
		'interest-delay-end: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('interest-delay-end'),
		'inherit',
		'interest-delay-end: accepts inherit'
	);
	s.interestDelayEnd = '';
...
// --- image-animation ---
{
	...
	assertEq(
		s.getPropertyValue('image-animation'),
		'normal',
		'image-animation: getPropertyValue matches accessor'
	);
...
// --- image-rendering ---
{
	...
	assertEq(
		s.getPropertyValue('image-rendering'),
		'auto',
		'image-rendering: getPropertyValue matches accessor'
	);
...
// --- image-orientation ---
{
	...
	assertEq(
		s.getPropertyValue('image-orientation'),
		'none',
		'image-orientation: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('image-orientation'),
		'inherit',
		'image-orientation: accepts inherit'
	);
	s.imageOrientation = '';
...
// --- dynamic-range-limit ---
{
	...
	assertEq(
		s.getPropertyValue('dynamic-range-limit'),
		'standard',
		'dynamic-range-limit: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('dynamic-range-limit'),
		'inherit',
		'dynamic-range-limit: accepts inherit'
	);
	s.dynamicRangeLimit = '';
...
// --- initial-letter ---
{
	...
	assertEq(
		s.getPropertyValue('initial-letter'),
		'drop',
		'initial-letter: getPropertyValue matches accessor'
	);
...
// --- interactivity ---
{
	...
	assertEq(
		s.getPropertyValue('interactivity'),
		'auto',
		'interactivity: getPropertyValue matches accessor'
	);
...
// --- interpolate-size ---
{
	...
	assertEq(
		s.getPropertyValue('interpolate-size'),
		'numeric-only',
		'interpolate-size: getPropertyValue matches accessor'
	);
...
// --- justify-content ---
{
	...
	assertEq(
		s.getPropertyValue('justify-content'),
		'initial',
		'justify-content: getPropertyValue matches accessor'
	);
...
// --- justify-items ---
{
	...
	assertEq(
		s.getPropertyValue('justify-items'),
		'initial',
		'justify-items: getPropertyValue matches accessor'
	);
...
// --- justify-self ---
{
	...
	assertEq(
		s.getPropertyValue('justify-self'),
		'initial',
		'justify-self: getPropertyValue matches accessor'
	);
...
// --- letter-spacing ---
{
	...
	assertEq(
		s.getPropertyValue('letter-spacing'),
		'10px',
		'letter-spacing: getPropertyValue matches accessor'
	);
...
// --- lighting-color ---
{
	...
	assertEq(
		s.getPropertyValue('lighting-color'),
		'red',
		'lighting-color: getPropertyValue matches accessor'
	);
...
// --- line-height ---
{
	...
	assertEq(
		...
		'10px',
		'line-height: getPropertyValue matches accessor'
	);
	s.lineHeight = '20px';
...
// --- list-style-image ---
{
	...
	assertEq(
		s.getPropertyValue('list-style-image'),
		'none',
		'list-style-image: getPropertyValue matches accessor'
	);
...
// --- list-style-position ---
{
	...
	assertEq(
		s.getPropertyValue('list-style-position'),
		'outside',
		'list-style-position: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('list-style-position'),
		'inherit',
		'list-style-position: accepts inherit'
	);
	s.listStylePosition = '';
...
// --- list-style-type ---
{
	...
	assertEq(
		s.getPropertyValue('list-style-type'),
		'disc',
		'list-style-type: getPropertyValue matches accessor'
	);
...
// --- margin-bottom ---
{
	...
	assertEq(
		s.getPropertyValue('margin-bottom'),
		'10px',
		'margin-bottom: getPropertyValue matches accessor'
	);
	s.marginBottom = '20px';
...
// --- margin-left ---
{
	...
	assertEq(
		...
		'10px',
		'margin-left: getPropertyValue matches accessor'
	);
	s.marginLeft = '20px';
...
// --- margin-right ---
{
	...
	assertEq(
		s.getPropertyValue('margin-right'),
		'10px',
		'margin-right: getPropertyValue matches accessor'
	);
	s.marginRight = '20px';
...
// --- margin-top ---
{
	...
	assertEq(
		...
		'10px',
		'margin-top: getPropertyValue matches accessor'
	);
	s.marginTop = '20px';
...
// --- margin-trim ---
{
	...
	assertEq(
		s.getPropertyValue('margin-trim'),
		'initial',
		'margin-trim: getPropertyValue matches accessor'
	);
...
// --- marker-end ---
{
	...
	assertEq(
		s.getPropertyValue('marker-end'),
		'none',
		'marker-end: getPropertyValue matches accessor'
	);
	s.markerEnd = 'inherit';
...
// --- marker-mid ---
{
	...
	assertEq(
		s.getPropertyValue('marker-mid'),
		'none',
		'marker-mid: getPropertyValue matches accessor'
	);
	s.markerMid = 'inherit';
...
// --- marker-start ---
{
	...
	assertEq(
		s.getPropertyValue('marker-start'),
		'none',
		'marker-start: getPropertyValue matches accessor'
	);
...
// --- mask-type ---
{
	...
	assertEq(
		s.getPropertyValue('mask-type'),
		'luminance',
		'mask-type: getPropertyValue matches accessor'
	);
	s.maskType = 'alpha';
...
// --- math-shift ---
{
	...
	assertEq(
		s.getPropertyValue('math-shift'),
		'normal',
		'math-shift: getPropertyValue matches accessor'
	);
	s.mathShift = 'compact';
...
// --- math-style ---
{
	...
	assertEq(
		s.getPropertyValue('math-style'),
		'normal',
		'math-style: getPropertyValue matches accessor'
	);
	s.mathStyle = 'compact';
...
// --- max-height ---
{
	...
	assertEq(
		s.getPropertyValue('max-height'),
		'10px',
		'max-height: getPropertyValue matches accessor'
	);
	s.maxHeight = '20px';
...
// --- min-height ---
{
	...
	assertEq(
		s.getPropertyValue('min-height'),
		'10px',
		'min-height: getPropertyValue matches accessor'
	);
	s.minHeight = '20px';
...
// --- mix-blend-mode ---
{
	...
	assertEq(
		s.getPropertyValue('mix-blend-mode'),
		'normal',
		'mix-blend-mode: getPropertyValue matches accessor'
	);
...
// --- object-fit ---
{
	...
	assertEq(
		s.getPropertyValue('object-fit'),
		'fill',
		'object-fit: getPropertyValue matches accessor'
	);
	s.objectFit = 'contain';
...
// --- object-position ---
{
	...
	assertEq(
		s.getPropertyValue('object-position'),
		'initial',
		'object-position: getPropertyValue matches accessor'
	);
...
// --- object-view-box ---
{
	...
	assertEq(
		s.getPropertyValue('object-view-box'),
		'none',
		'object-view-box: getPropertyValue matches accessor'
	);
...
// --- offset-anchor ---
{
	...
	assertEq(
		s.getPropertyValue('offset-anchor'),
		'auto',
		'offset-anchor: getPropertyValue matches accessor'
	);
...
// --- offset-distance ---
{
	...
	assertEq(
		s.getPropertyValue('offset-distance'),
		'10px',
		'offset-distance: getPropertyValue matches accessor'
	);
...
// --- offset-path ---
{
	...
	assertEq(
		s.getPropertyValue('offset-path'),
		'none',
		'offset-path: getPropertyValue matches accessor'
	);
...
// --- offset-position ---
{
	...
	assertEq(
		s.getPropertyValue('offset-position'),
		'auto',
		'offset-position: getPropertyValue matches accessor'
	);
...
// --- offset-rotate ---
{
	...
	assertEq(
		s.getPropertyValue('offset-rotate'),
		'auto',
		'offset-rotate: getPropertyValue matches accessor'
	);
...
// --- origin-trial-test-property ---
{
	...
	assertEq(
		...
		'normal',
		'origin-trial-test-property: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('origin-trial-test-property'),
		'normal',
		'origin-trial-test-property: getPropertyValue matches accessor'
	);
	s.originTrialTestProperty = 'none';
	assertEq(
		s.originTrialTestProperty,
		'none',
		'origin-trial-test-property: overwrite with second value'
	);
	s.removeProperty('origin-trial-test-property');
	assertEq(
		s.originTrialTestProperty,
		'',
		'origin-trial-test-property: removeProperty clears value'
	);
	s.setProperty('origin-trial-test-property', 'inherit');
	assertEq(
		s.getPropertyValue('origin-trial-test-property'),
		'inherit',
		'origin-trial-test-property: accepts inherit'
	);
	s.originTrialTestProperty = '';
	...
	assertEq(
		s.originTrialTestProperty,
		'normal',
		'origin-trial-test-property: rejects invalid keyword'
	);
}
...
// --- outline-color ---
{
	...
	assertEq(
		s.getPropertyValue('outline-color'),
		'red',
		'outline-color: getPropertyValue matches accessor'
	);
	s.outlineColor = 'blue';
...
// --- outline-offset ---
{
	...
	assertEq(
		s.getPropertyValue('outline-offset'),
		'10px',
		'outline-offset: getPropertyValue matches accessor'
	);
...
// --- outline-style ---
{
	...
	assertEq(
		s.getPropertyValue('outline-style'),
		'none',
		'outline-style: getPropertyValue matches accessor'
	);
...
// --- outline-width ---
{
	...
	assertEq(
		s.getPropertyValue('outline-width'),
		'10px',
		'outline-width: getPropertyValue matches accessor'
	);
	s.outlineWidth = '20px';
...
// --- overflow-anchor ---
{
	...
	assertEq(
		s.getPropertyValue('overflow-anchor'),
		'visible',
		'overflow-anchor: getPropertyValue matches accessor'
	);
...
// --- overflow-wrap ---
{
	...
	assertEq(
		s.getPropertyValue('overflow-wrap'),
		'normal',
		'overflow-wrap: getPropertyValue matches accessor'
	);
...
// --- overflow-inline ---
{
	...
	assertEq(
		s.getPropertyValue('overflow-inline'),
		'initial',
		'overflow-inline: getPropertyValue matches accessor'
	);
...
// --- overflow-block ---
{
	...
	assertEq(
		s.getPropertyValue('overflow-block'),
		'initial',
		'overflow-block: getPropertyValue matches accessor'
	);
...
// --- overflow-clip-margin ---
{
	...
	assertEq(
		...
		'border-box',
		'overflow-clip-margin: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('overflow-clip-margin'),
		'border-box',
		'overflow-clip-margin: getPropertyValue matches accessor'
	);
	s.overflowClipMargin = 'content-box';
	assertEq(
		s.overflowClipMargin,
		'content-box',
		'overflow-clip-margin: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('overflow-clip-margin'),
		'inherit',
		'overflow-clip-margin: accepts inherit'
	);
	s.overflowClipMargin = '';
...
// --- overflow-x ---
{
	...
	assertEq(
		...
		'visible',
		'overflow-x: getPropertyValue matches accessor'
	);
	s.overflowX = 'hidden';
...
// --- overflow-y ---
{
	...
	assertEq(
		...
		'visible',
		'overflow-y: getPropertyValue matches accessor'
	);
	s.overflowY = 'hidden';
...
// --- overscroll-behavior-inline ---
{
	...
	assertEq(
		...
		'initial',
		'overscroll-behavior-inline: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('overscroll-behavior-inline'),
		'initial',
		'overscroll-behavior-inline: getPropertyValue matches accessor'
	);
	s.overscrollBehaviorInline = 'inherit';
	assertEq(
		s.overscrollBehaviorInline,
		'inherit',
		'overscroll-behavior-inline: overwrite with second value'
	);
	s.removeProperty('overscroll-behavior-inline');
	assertEq(
		s.overscrollBehaviorInline,
		'',
		'overscroll-behavior-inline: removeProperty clears value'
	);
	s.setProperty('overscroll-behavior-inline', 'inherit');
	assertEq(
		s.getPropertyValue('overscroll-behavior-inline'),
		'inherit',
		'overscroll-behavior-inline: accepts inherit'
	);
	s.overscrollBehaviorInline = '';
...
// --- overscroll-behavior-block ---
{
	...
	assertEq(
		...
		'initial',
		'overscroll-behavior-block: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('overscroll-behavior-block'),
		'initial',
		'overscroll-behavior-block: getPropertyValue matches accessor'
	);
	s.overscrollBehaviorBlock = 'inherit';
	assertEq(
		s.overscrollBehaviorBlock,
		'inherit',
		'overscroll-behavior-block: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('overscroll-behavior-block'),
		'inherit',
		'overscroll-behavior-block: accepts inherit'
	);
	s.overscrollBehaviorBlock = '';
...
// --- overscroll-behavior-x ---
{
	...
	assertEq(
		s.getPropertyValue('overscroll-behavior-x'),
		'auto',
		'overscroll-behavior-x: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('overscroll-behavior-x'),
		'inherit',
		'overscroll-behavior-x: accepts inherit'
	);
...
// --- overscroll-behavior-y ---
{
	...
	assertEq(
		s.getPropertyValue('overscroll-behavior-y'),
		'auto',
		'overscroll-behavior-y: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('overscroll-behavior-y'),
		'inherit',
		'overscroll-behavior-y: accepts inherit'
	);
...
// --- padding-bottom ---
{
	...
	assertEq(
		...
		'10px',
		'padding-bottom: getPropertyValue matches accessor'
	);
...
// --- padding-left ---
{
	...
	assertEq(
		s.getPropertyValue('padding-left'),
		'10px',
		'padding-left: getPropertyValue matches accessor'
	);
	s.paddingLeft = '20px';
...
// --- padding-right ---
{
	...
	assertEq(
		s.getPropertyValue('padding-right'),
		'10px',
		'padding-right: getPropertyValue matches accessor'
	);
	s.paddingRight = '20px';
...
// --- padding-top ---
{
	...
	assertEq(
		s.getPropertyValue('padding-top'),
		'10px',
		'padding-top: getPropertyValue matches accessor'
	);
	s.paddingTop = '20px';
...
// --- page-margin-safety ---
{
	...
	assertEq(
		s.getPropertyValue('page-margin-safety'),
		'none',
		'page-margin-safety: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('page-margin-safety'),
		'inherit',
		'page-margin-safety: accepts inherit'
	);
	s.pageMarginSafety = '';
...
// --- page-orientation ---
{
	...
	assertEq(
		s.getPropertyValue('page-orientation'),
		'initial',
		'page-orientation: getPropertyValue matches accessor'
	);
...
// --- paint-order ---
{
	...
	assertEq(
		s.getPropertyValue('paint-order'),
		'normal',
		'paint-order: getPropertyValue matches accessor'
	);
	s.paintOrder = 'fill';
...
// --- path-length ---
{
	...
	assertEq(
		s.getPropertyValue('path-length'),
		'none',
		'path-length: getPropertyValue matches accessor'
	);
...
// --- perspective ---
{
	...
	assertEq(
		s.getPropertyValue('perspective'),
		'none',
		'perspective: getPropertyValue matches accessor'
	);
...
// --- perspective-origin ---
{
	...
	assertEq(
		s.getPropertyValue('perspective-origin'),
		'initial',
		'perspective-origin: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('perspective-origin'),
		'inherit',
		'perspective-origin: accepts inherit'
	);
	s.perspectiveOrigin = '';
...
// --- pointer-events ---
{
	...
	assertEq(
		s.getPropertyValue('pointer-events'),
		'none',
		'pointer-events: getPropertyValue matches accessor'
	);
...
// --- position-anchor ---
{
	...
	assertEq(
		s.getPropertyValue('position-anchor'),
		'auto',
		'position-anchor: getPropertyValue matches accessor'
	);
...
// --- position-try-fallbacks ---
{
	...
	assertEq(
		...
		'none',
		'position-try-fallbacks: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('position-try-fallbacks'),
		'none',
		'position-try-fallbacks: getPropertyValue matches accessor'
	);
	s.positionTryFallbacks = 'flip-block';
	assertEq(
		s.positionTryFallbacks,
		'flip-block',
		'position-try-fallbacks: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('position-try-fallbacks'),
		'inherit',
		'position-try-fallbacks: accepts inherit'
	);
	s.positionTryFallbacks = '';
...
// --- position-try-order ---
{
	...
	assertEq(
		s.getPropertyValue('position-try-order'),
		'normal',
		'position-try-order: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('position-try-order'),
		'inherit',
		'position-try-order: accepts inherit'
	);
	s.positionTryOrder = '';
...
// --- position-visibility ---
{
	...
	assertEq(
		s.getPropertyValue('position-visibility'),
		'always',
		'position-visibility: getPropertyValue matches accessor'
	);
	s.positionVisibility = 'anchors-visible';
	assertEq(
		s.positionVisibility,
		'anchors-visible',
		'position-visibility: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('position-visibility'),
		'inherit',
		'position-visibility: accepts inherit'
	);
	s.positionVisibility = '';
...
// --- print-color-adjust ---
{
	...
	assertEq(
		...
		'economy',
		'print-color-adjust: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('print-color-adjust'),
		'inherit',
		'print-color-adjust: accepts inherit'
	);
	s.printColorAdjust = '';
...
// --- content-visibility ---
{
	...
	assertEq(
		s.getPropertyValue('content-visibility'),
		'visible',
		'content-visibility: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('content-visibility'),
		'inherit',
		'content-visibility: accepts inherit'
	);
	s.contentVisibility = '';
...
// --- reading-flow ---
{
	...
	assertEq(
		s.getPropertyValue('reading-flow'),
		'normal',
		'reading-flow: getPropertyValue matches accessor'
	);
...
// --- reading-order ---
{
	...
	assertEq(
		s.getPropertyValue('reading-order'),
		'initial',
		'reading-order: getPropertyValue matches accessor'
	);
...
// --- scroll-target-group ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-target-group'),
		'none',
		'scroll-target-group: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-target-group'),
		'inherit',
		'scroll-target-group: accepts inherit'
	);
	s.scrollTargetGroup = '';
...
// --- scroll-marker-group ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-marker-group'),
		'initial',
		'scroll-marker-group: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-marker-group'),
		'inherit',
		'scroll-marker-group: accepts inherit'
	);
	s.scrollMarkerGroup = '';
...
// --- scrollbar-color ---
{
	...
	assertEq(
		s.getPropertyValue('scrollbar-color'),
		'red',
		'scrollbar-color: getPropertyValue matches accessor'
	);
...
// --- scrollbar-gutter ---
{
	...
	assertEq(
		s.getPropertyValue('scrollbar-gutter'),
		'auto',
		'scrollbar-gutter: getPropertyValue matches accessor'
	);
...
// --- scrollbar-width ---
{
	...
	assertEq(
		s.getPropertyValue('scrollbar-width'),
		'auto',
		'scrollbar-width: getPropertyValue matches accessor'
	);
...
// --- scroll-behavior ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-behavior'),
		'auto',
		'scroll-behavior: getPropertyValue matches accessor'
	);
...
// --- scroll-initial-target ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-initial-target'),
		'none',
		'scroll-initial-target: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-initial-target'),
		'inherit',
		'scroll-initial-target: accepts inherit'
	);
...
// --- scroll-margin-block-end ---
{
	...
	assertEq(
		...
		'initial',
		'scroll-margin-block-end: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-block-end'),
		'initial',
		'scroll-margin-block-end: getPropertyValue matches accessor'
	);
	s.scrollMarginBlockEnd = 'inherit';
	assertEq(
		s.scrollMarginBlockEnd,
		'inherit',
		'scroll-margin-block-end: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-margin-block-end'),
		'inherit',
		'scroll-margin-block-end: accepts inherit'
	);
	s.scrollMarginBlockEnd = '';
...
// --- scroll-margin-block-start ---
{
	...
	assertEq(
		...
		'initial',
		'scroll-margin-block-start: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-block-start'),
		'initial',
		'scroll-margin-block-start: getPropertyValue matches accessor'
	);
	s.scrollMarginBlockStart = 'inherit';
	assertEq(
		s.scrollMarginBlockStart,
		'inherit',
		'scroll-margin-block-start: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-margin-block-start'),
		'inherit',
		'scroll-margin-block-start: accepts inherit'
	);
	s.scrollMarginBlockStart = '';
...
// --- scroll-margin-bottom ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-margin-bottom'),
		'10px',
		'scroll-margin-bottom: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-margin-bottom'),
		'inherit',
		'scroll-margin-bottom: accepts inherit'
	);
...
// --- scroll-margin-inline-end ---
{
	...
	assertEq(
		...
		'initial',
		'scroll-margin-inline-end: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-inline-end'),
		'initial',
		'scroll-margin-inline-end: getPropertyValue matches accessor'
	);
	s.scrollMarginInlineEnd = 'inherit';
	assertEq(
		s.scrollMarginInlineEnd,
		'inherit',
		'scroll-margin-inline-end: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-margin-inline-end'),
		'inherit',
		'scroll-margin-inline-end: accepts inherit'
	);
	s.scrollMarginInlineEnd = '';
...
// --- scroll-margin-inline-start ---
{
	...
	assertEq(
		...
		'initial',
		'scroll-margin-inline-start: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-inline-start'),
		'initial',
		'scroll-margin-inline-start: getPropertyValue matches accessor'
	);
	s.scrollMarginInlineStart = 'inherit';
	assertEq(
		s.scrollMarginInlineStart,
		'inherit',
		'scroll-margin-inline-start: overwrite with second value'
	);
	s.removeProperty('scroll-margin-inline-start');
	assertEq(
		s.scrollMarginInlineStart,
		'',
		'scroll-margin-inline-start: removeProperty clears value'
	);
	s.setProperty('scroll-margin-inline-start', 'inherit');
	assertEq(
		s.getPropertyValue('scroll-margin-inline-start'),
		'inherit',
		'scroll-margin-inline-start: accepts inherit'
	);
	s.scrollMarginInlineStart = '';
...
// --- scroll-margin-left ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-margin-left'),
		'10px',
		'scroll-margin-left: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-margin-left'),
		'inherit',
		'scroll-margin-left: accepts inherit'
	);
	s.scrollMarginLeft = '';
...
// --- scroll-margin-right ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-margin-right'),
		'10px',
		'scroll-margin-right: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-margin-right'),
		'inherit',
		'scroll-margin-right: accepts inherit'
	);
	s.scrollMarginRight = '';
...
// --- scroll-margin-top ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-margin-top'),
		'10px',
		'scroll-margin-top: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-margin-top'),
		'inherit',
		'scroll-margin-top: accepts inherit'
	);
	s.scrollMarginTop = '';
...
// --- scroll-padding-block-end ---
{
	...
	assertEq(
		...
		'auto',
		'scroll-padding-block-end: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-block-end'),
		'auto',
		'scroll-padding-block-end: getPropertyValue matches accessor'
	);
	s.scrollPaddingBlockEnd = 'inherit';
	assertEq(
		s.scrollPaddingBlockEnd,
		'inherit',
		'scroll-padding-block-end: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-padding-block-end'),
		'inherit',
		'scroll-padding-block-end: accepts inherit'
	);
	s.scrollPaddingBlockEnd = '';
...
// --- scroll-padding-block-start ---
{
	...
	assertEq(
		...
		'auto',
		'scroll-padding-block-start: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-block-start'),
		'auto',
		'scroll-padding-block-start: getPropertyValue matches accessor'
	);
	s.scrollPaddingBlockStart = 'inherit';
	assertEq(
		s.scrollPaddingBlockStart,
		'inherit',
		'scroll-padding-block-start: overwrite with second value'
	);
	s.removeProperty('scroll-padding-block-start');
	assertEq(
		s.scrollPaddingBlockStart,
		'',
		'scroll-padding-block-start: removeProperty clears value'
	);
	s.setProperty('scroll-padding-block-start', 'inherit');
	assertEq(
		s.getPropertyValue('scroll-padding-block-start'),
		'inherit',
		'scroll-padding-block-start: accepts inherit'
	);
	s.scrollPaddingBlockStart = '';
...
// --- scroll-padding-bottom ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-padding-bottom'),
		'10px',
		'scroll-padding-bottom: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-padding-bottom'),
		'inherit',
		'scroll-padding-bottom: accepts inherit'
	);
...
// --- scroll-padding-inline-end ---
{
	...
	assertEq(
		...
		'auto',
		'scroll-padding-inline-end: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-inline-end'),
		'auto',
		'scroll-padding-inline-end: getPropertyValue matches accessor'
	);
	s.scrollPaddingInlineEnd = 'inherit';
	assertEq(
		s.scrollPaddingInlineEnd,
		'inherit',
		'scroll-padding-inline-end: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-padding-inline-end'),
		'inherit',
		'scroll-padding-inline-end: accepts inherit'
	);
	s.scrollPaddingInlineEnd = '';
...
// --- scroll-padding-inline-start ---
{
	...
	assertEq(
		...
		'auto',
		'scroll-padding-inline-start: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-inline-start'),
		'auto',
		'scroll-padding-inline-start: getPropertyValue matches accessor'
	);
	s.scrollPaddingInlineStart = 'inherit';
	assertEq(
		s.scrollPaddingInlineStart,
		'inherit',
		'scroll-padding-inline-start: overwrite with second value'
	);
	s.removeProperty('scroll-padding-inline-start');
	assertEq(
		s.scrollPaddingInlineStart,
		'',
		'scroll-padding-inline-start: removeProperty clears value'
	);
	s.setProperty('scroll-padding-inline-start', 'inherit');
	assertEq(
		s.getPropertyValue('scroll-padding-inline-start'),
		'inherit',
		'scroll-padding-inline-start: accepts inherit'
	);
	s.scrollPaddingInlineStart = '';
...
// --- scroll-padding-left ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-padding-left'),
		'10px',
		'scroll-padding-left: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-padding-left'),
		'inherit',
		'scroll-padding-left: accepts inherit'
	);
	s.scrollPaddingLeft = '';
...
// --- scroll-padding-right ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-padding-right'),
		'10px',
		'scroll-padding-right: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-padding-right'),
		'inherit',
		'scroll-padding-right: accepts inherit'
	);
...
// --- scroll-padding-top ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-padding-top'),
		'10px',
		'scroll-padding-top: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-padding-top'),
		'inherit',
		'scroll-padding-top: accepts inherit'
	);
	s.scrollPaddingTop = '';
...
// --- scroll-snap-align ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-snap-align'),
		'none',
		'scroll-snap-align: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-snap-align'),
		'inherit',
		'scroll-snap-align: accepts inherit'
	);
	s.scrollSnapAlign = '';
...
// --- scroll-snap-stop ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-snap-stop'),
		'normal',
		'scroll-snap-stop: getPropertyValue matches accessor'
	);
...
// --- scroll-snap-type ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-snap-type'),
		'none',
		'scroll-snap-type: getPropertyValue matches accessor'
	);
	s.scrollSnapType = 'x';
...
// --- scroll-timeline-axis ---
{
	...
	assertEq(
		...
		'initial',
		'scroll-timeline-axis: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('scroll-timeline-axis'),
		'initial',
		'scroll-timeline-axis: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-timeline-axis'),
		'inherit',
		'scroll-timeline-axis: accepts inherit'
	);
	s.scrollTimelineAxis = '';
...
// --- scroll-timeline-name ---
{
	...
	assertEq(
		...
		'initial',
		'scroll-timeline-name: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('scroll-timeline-name'),
		'initial',
		'scroll-timeline-name: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('scroll-timeline-name'),
		'inherit',
		'scroll-timeline-name: accepts inherit'
	);
	s.scrollTimelineName = '';
...
// --- shape-image-threshold ---
{
	...
	assertEq(
		s.getPropertyValue('shape-image-threshold'),
		'1',
		'shape-image-threshold: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('shape-image-threshold'),
		'inherit',
		'shape-image-threshold: accepts inherit'
	);
...
// --- shape-margin ---
{
	...
	assertEq(
		s.getPropertyValue('shape-margin'),
		'none',
		'shape-margin: getPropertyValue matches accessor'
	);
...
// --- shape-outside ---
{
	...
	assertEq(
		s.getPropertyValue('shape-outside'),
		'none',
		'shape-outside: getPropertyValue matches accessor'
	);
...
// --- shape-rendering ---
{
	...
	assertEq(
		s.getPropertyValue('shape-rendering'),
		'auto',
		'shape-rendering: getPropertyValue matches accessor'
	);
...
// --- stop-color ---
{
	...
	assertEq(
		s.getPropertyValue('stop-color'),
		'red',
		'stop-color: getPropertyValue matches accessor'
	);
	s.stopColor = 'blue';
...
// --- stop-opacity ---
{
	...
	assertEq(
		s.getPropertyValue('stop-opacity'),
		'1',
		'stop-opacity: getPropertyValue matches accessor'
	);
	s.stopOpacity = '2';
...
// --- stroke-dasharray ---
{
	...
	assertEq(
		s.getPropertyValue('stroke-dasharray'),
		'none',
		'stroke-dasharray: getPropertyValue matches accessor'
	);
...
// --- stroke-dashoffset ---
{
	...
	assertEq(
		s.getPropertyValue('stroke-dashoffset'),
		'10px',
		'stroke-dashoffset: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('stroke-dashoffset'),
		'inherit',
		'stroke-dashoffset: accepts inherit'
	);
	s.strokeDashoffset = '';
...
// --- stroke-linecap ---
{
	...
	assertEq(
		s.getPropertyValue('stroke-linecap'),
		'butt',
		'stroke-linecap: getPropertyValue matches accessor'
	);
...
// --- stroke-linejoin ---
{
	...
	assertEq(
		s.getPropertyValue('stroke-linejoin'),
		'miter',
		'stroke-linejoin: getPropertyValue matches accessor'
	);
...
// --- stroke-miterlimit ---
{
	...
	assertEq(
		s.getPropertyValue('stroke-miterlimit'),
		'initial',
		'stroke-miterlimit: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('stroke-miterlimit'),
		'inherit',
		'stroke-miterlimit: accepts inherit'
	);
	s.strokeMiterlimit = '';
...
// --- stroke-opacity ---
{
	...
	assertEq(
		s.getPropertyValue('stroke-opacity'),
		'1',
		'stroke-opacity: getPropertyValue matches accessor'
	);
	s.strokeOpacity = '2';
...
// --- stroke-width ---
{
	...
	assertEq(
		s.getPropertyValue('stroke-width'),
		'10px',
		'stroke-width: getPropertyValue matches accessor'
	);
	s.strokeWidth = '20px';
...
// --- table-layout ---
{
	...
	assertEq(
		s.getPropertyValue('table-layout'),
		'auto',
		'table-layout: getPropertyValue matches accessor'
	);
	s.tableLayout = 'fixed';
...
// --- text-align ---
{
	...
	assertEq(
		s.getPropertyValue('text-align'),
		'left',
		'text-align: getPropertyValue matches accessor'
	);
	s.textAlign = 'right';
...
// --- text-align-last ---
{
	...
	assertEq(
		s.getPropertyValue('text-align-last'),
		'auto',
		'text-align-last: getPropertyValue matches accessor'
	);
...
// --- text-anchor ---
{
	...
	assertEq(
		s.getPropertyValue('text-anchor'),
		'start',
		'text-anchor: getPropertyValue matches accessor'
	);
	s.textAnchor = 'middle';
...
// --- text-autospace ---
{
	...
	assertEq(
		s.getPropertyValue('text-autospace'),
		'no-autospace',
		'text-autospace: getPropertyValue matches accessor'
	);
...
// --- text-box-edge ---
{
	...
	assertEq(
		s.getPropertyValue('text-box-edge'),
		'initial',
		'text-box-edge: getPropertyValue matches accessor'
	);
...
// --- text-box-trim ---
{
	...
	assertEq(
		s.getPropertyValue('text-box-trim'),
		'none',
		'text-box-trim: getPropertyValue matches accessor'
	);
...
// --- text-combine-upright ---
{
	...
	assertEq(
		s.getPropertyValue('text-combine-upright'),
		'none',
		'text-combine-upright: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('text-combine-upright'),
		'inherit',
		'text-combine-upright: accepts inherit'
	);
...
// --- text-decoration-color ---
{
	...
	assertEq(
		s.getPropertyValue('text-decoration-color'),
		'red',
		'text-decoration-color: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('text-decoration-color'),
		'inherit',
		'text-decoration-color: accepts inherit'
	);
...
// --- text-decoration-line ---
{
	...
	assertEq(
		s.getPropertyValue('text-decoration-line'),
		'none',
		'text-decoration-line: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('text-decoration-line'),
		'inherit',
		'text-decoration-line: accepts inherit'
	);
...
// --- text-decoration-skip-ink ---
{
	...
	assertEq(
		...
		'none',
		'text-decoration-skip-ink: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('text-decoration-skip-ink'),
		'none',
		'text-decoration-skip-ink: getPropertyValue matches accessor'
	);
	s.textDecorationSkipInk = 'auto';
	assertEq(
		s.textDecorationSkipInk,
		'auto',
		'text-decoration-skip-ink: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('text-decoration-skip-ink'),
		'inherit',
		'text-decoration-skip-ink: accepts inherit'
	);
	s.textDecorationSkipInk = '';
...
// --- text-decoration-style ---
{
	...
	assertEq(
		...
		'solid',
		'text-decoration-style: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('text-decoration-style'),
		'solid',
		'text-decoration-style: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('text-decoration-style'),
		'inherit',
		'text-decoration-style: accepts inherit'
	);
	s.textDecorationStyle = '';
...
// --- text-decoration-thickness ---
{
	...
	assertEq(
		...
		'auto',
		'text-decoration-thickness: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('text-decoration-thickness'),
		'auto',
		'text-decoration-thickness: getPropertyValue matches accessor'
	);
	s.textDecorationThickness = 'from-font';
	assertEq(
		s.textDecorationThickness,
		'from-font',
		'text-decoration-thickness: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('text-decoration-thickness'),
		'inherit',
		'text-decoration-thickness: accepts inherit'
	);
	s.textDecorationThickness = '';
...
// --- text-indent ---
{
	...
	assertEq(
		s.getPropertyValue('text-indent'),
		'10px',
		'text-indent: getPropertyValue matches accessor'
	);
	s.textIndent = '20px';
...
// --- text-justify ---
{
	...
	assertEq(
		s.getPropertyValue('text-justify'),
		'auto',
		'text-justify: getPropertyValue matches accessor'
	);
	s.textJustify = 'none';
...
// --- text-overflow ---
{
	...
	assertEq(
		s.getPropertyValue('text-overflow'),
		'clip',
		'text-overflow: getPropertyValue matches accessor'
	);
...
// --- text-shadow ---
{
	...
	assertEq(
		s.getPropertyValue('text-shadow'),
		'none',
		'text-shadow: getPropertyValue matches accessor'
	);
...
// --- text-size-adjust ---
{
	...
	assertEq(
		...
		'none',
		'text-size-adjust: getPropertyValue matches accessor'
	);
...
// --- text-spacing-trim ---
{
	...
	assertEq(
		s.getPropertyValue('text-spacing-trim'),
		'normal',
		'text-spacing-trim: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('text-spacing-trim'),
		'inherit',
		'text-spacing-trim: accepts inherit'
	);
	s.textSpacingTrim = '';
...
// --- text-transform ---
{
	...
	assertEq(
		s.getPropertyValue('text-transform'),
		'none',
		'text-transform: getPropertyValue matches accessor'
	);
...
// --- text-underline-offset ---
{
	...
	assertEq(
		s.getPropertyValue('text-underline-offset'),
		'auto',
		'text-underline-offset: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('text-underline-offset'),
		'inherit',
		'text-underline-offset: accepts inherit'
	);
...
// --- text-underline-position ---
{
	...
	assertEq(
		...
		'auto',
		'text-underline-position: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('text-underline-position'),
		'auto',
		'text-underline-position: getPropertyValue matches accessor'
	);
	s.textUnderlinePosition = 'from-font';
	assertEq(
		s.textUnderlinePosition,
		'from-font',
		'text-underline-position: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('text-underline-position'),
		'inherit',
		'text-underline-position: accepts inherit'
	);
	s.textUnderlinePosition = '';
...
// --- timeline-scope ---
{
	...
	assertEq(
		s.getPropertyValue('timeline-scope'),
		'initial',
		'timeline-scope: getPropertyValue matches accessor'
	);
...
// --- touch-action ---
{
	...
	assertEq(
		s.getPropertyValue('touch-action'),
		'auto',
		'touch-action: getPropertyValue matches accessor'
	);
	s.touchAction = 'none';
...
// --- transform-box ---
{
	...
	assertEq(
		s.getPropertyValue('transform-box'),
		'content-box',
		'transform-box: getPropertyValue matches accessor'
	);
...
// --- transform-origin ---
{
	...
	assertEq(
		s.getPropertyValue('transform-origin'),
		'initial',
		'transform-origin: getPropertyValue matches accessor'
	);
...
// --- transform-style ---
{
	...
	assertEq(
		s.getPropertyValue('transform-style'),
		'flat',
		'transform-style: getPropertyValue matches accessor'
	);
...
// --- translate ---
{
	...
	assertEq(
		s.getPropertyValue('translate'),
		'initial',
		'translate: getPropertyValue matches accessor'
	);
	s.translate = 'inherit';
...
// --- unicode-bidi ---
{
	...
	assertEq(
		s.getPropertyValue('unicode-bidi'),
		'normal',
		'unicode-bidi: getPropertyValue matches accessor'
	);
	s.unicodeBidi = 'embed';
...
// --- vector-effect ---
{
	...
	assertEq(
		s.getPropertyValue('vector-effect'),
		'none',
		'vector-effect: getPropertyValue matches accessor'
	);
...
// --- vertical-align ---
{
	...
	assertEq(
		s.getPropertyValue('vertical-align'),
		'baseline',
		'vertical-align: getPropertyValue matches accessor'
	);
	s.verticalAlign = 'sub';
...
// --- view-timeline-axis ---
{
	...
	assertEq(
		s.getPropertyValue('view-timeline-axis'),
		'initial',
		'view-timeline-axis: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('view-timeline-axis'),
		'inherit',
		'view-timeline-axis: accepts inherit'
	);
	s.viewTimelineAxis = '';
...
// --- view-timeline-inset ---
{
	...
	assertEq(
		s.getPropertyValue('view-timeline-inset'),
		'initial',
		'view-timeline-inset: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('view-timeline-inset'),
		'inherit',
		'view-timeline-inset: accepts inherit'
	);
	s.viewTimelineInset = '';
...
// --- view-timeline-name ---
{
	...
	assertEq(
		s.getPropertyValue('view-timeline-name'),
		'initial',
		'view-timeline-name: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('view-timeline-name'),
		'inherit',
		'view-timeline-name: accepts inherit'
	);
	s.viewTimelineName = '';
...
// --- view-transition-class ---
{
	...
	assertEq(
		s.getPropertyValue('view-transition-class'),
		'none',
		'view-transition-class: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('view-transition-class'),
		'inherit',
		'view-transition-class: accepts inherit'
	);
...
// --- view-transition-group ---
{
	...
	assertEq(
		...
		'normal',
		'view-transition-group: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('view-transition-group'),
		'normal',
		'view-transition-group: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('view-transition-group'),
		'inherit',
		'view-transition-group: accepts inherit'
	);
	s.viewTransitionGroup = '';
...
// --- view-transition-name ---
{
	...
	assertEq(
		s.getPropertyValue('view-transition-name'),
		'none',
		'view-transition-name: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('view-transition-name'),
		'inherit',
		'view-transition-name: accepts inherit'
	);
...
// --- view-transition-scope ---
{
	...
	assertEq(
		s.getPropertyValue('view-transition-scope'),
		'none',
		'view-transition-scope: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('view-transition-scope'),
		'inherit',
		'view-transition-scope: accepts inherit'
	);
...
// --- visibility ---
{
	...
	assertEq(
		s.getPropertyValue('visibility'),
		'visible',
		'visibility: getPropertyValue matches accessor'
	);
	s.visibility = 'hidden';
...
// --- appearance ---
{
	...
	assertEq(
		...
		'initial',
		'appearance: getPropertyValue matches accessor'
	);
...
// --- app-region ---
{
	...
	assertEq(
		s.getPropertyValue('app-region'),
		'none',
		'app-region: getPropertyValue matches accessor'
	);
	s.appRegion = 'drag';
...
// --- -webkit-border-horizontal-spacing ---
{
	...
	assertEq(
		...
		'initial',
		'-webkit-border-horizontal-spacing: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-border-horizontal-spacing'),
		'initial',
		'-webkit-border-horizontal-spacing: getPropertyValue matches accessor'
	);
	s.webkitBorderHorizontalSpacing = 'inherit';
	assertEq(
		s.webkitBorderHorizontalSpacing,
		'inherit',
		'-webkit-border-horizontal-spacing: overwrite with second value'
	);
	s.removeProperty('-webkit-border-horizontal-spacing');
	assertEq(
		s.webkitBorderHorizontalSpacing,
		'',
		'-webkit-border-horizontal-spacing: removeProperty clears value'
	);
	s.setProperty('-webkit-border-horizontal-spacing', 'inherit');
	assertEq(
		s.getPropertyValue('-webkit-border-horizontal-spacing'),
		'inherit',
		'-webkit-border-horizontal-spacing: accepts inherit'
	);
	s.webkitBorderHorizontalSpacing = '';
	assertEq(
		s.webkitBorderHorizontalSpacing,
		'',
		'-webkit-border-horizontal-spacing: empty string removes'
	);
}
...
// --- -webkit-border-image ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-border-image'),
		'none',
		'-webkit-border-image: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-border-image'),
		'inherit',
		'-webkit-border-image: accepts inherit'
	);
	s.webkitBorderImage = '';
...
// --- -webkit-border-vertical-spacing ---
{
	...
	assertEq(
		...
		'initial',
		'-webkit-border-vertical-spacing: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-border-vertical-spacing'),
		'initial',
		'-webkit-border-vertical-spacing: getPropertyValue matches accessor'
	);
	s.webkitBorderVerticalSpacing = 'inherit';
	assertEq(
		s.webkitBorderVerticalSpacing,
		'inherit',
		'-webkit-border-vertical-spacing: overwrite with second value'
	);
	s.removeProperty('-webkit-border-vertical-spacing');
	assertEq(
		s.webkitBorderVerticalSpacing,
		'',
		'-webkit-border-vertical-spacing: removeProperty clears value'
	);
	s.setProperty('-webkit-border-vertical-spacing', 'inherit');
	assertEq(
		s.getPropertyValue('-webkit-border-vertical-spacing'),
		'inherit',
		'-webkit-border-vertical-spacing: accepts inherit'
	);
	s.webkitBorderVerticalSpacing = '';
	assertEq(
		s.webkitBorderVerticalSpacing,
		'',
		'-webkit-border-vertical-spacing: empty string removes'
	);
}
...
// --- -webkit-box-align ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-box-align'),
		'stretch',
		'-webkit-box-align: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-box-align'),
		'inherit',
		'-webkit-box-align: accepts inherit'
	);
	s.webkitBoxAlign = '';
...
// --- -webkit-box-decoration-break ---
{
	...
	assertEq(
		...
		'slice',
		'-webkit-box-decoration-break: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-box-decoration-break'),
		'slice',
		'-webkit-box-decoration-break: getPropertyValue matches accessor'
	);
	s.webkitBoxDecorationBreak = 'clone';
	assertEq(
		s.webkitBoxDecorationBreak,
		'clone',
		'-webkit-box-decoration-break: overwrite with second value'
	);
	s.removeProperty('-webkit-box-decoration-break');
	assertEq(
		s.webkitBoxDecorationBreak,
		'',
		'-webkit-box-decoration-break: removeProperty clears value'
	);
	s.setProperty('-webkit-box-decoration-break', 'inherit');
	assertEq(
		s.getPropertyValue('-webkit-box-decoration-break'),
		'inherit',
		'-webkit-box-decoration-break: accepts inherit'
	);
	s.webkitBoxDecorationBreak = '';
	...
	assertEq(
		s.webkitBoxDecorationBreak,
		'slice',
		'-webkit-box-decoration-break: rejects invalid keyword'
	);
}
...
// --- -webkit-box-direction ---
{
	...
	assertEq(
		...
		'normal',
		'-webkit-box-direction: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-box-direction'),
		'normal',
		'-webkit-box-direction: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-box-direction'),
		'inherit',
		'-webkit-box-direction: accepts inherit'
	);
	s.webkitBoxDirection = '';
...
// --- -webkit-box-flex ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-box-flex'),
		'initial',
		'-webkit-box-flex: getPropertyValue matches accessor'
	);
...
// --- -webkit-box-ordinal-group ---
{
	...
	assertEq(
		...
		'initial',
		'-webkit-box-ordinal-group: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-box-ordinal-group'),
		'initial',
		'-webkit-box-ordinal-group: getPropertyValue matches accessor'
	);
	s.webkitBoxOrdinalGroup = 'inherit';
	assertEq(
		s.webkitBoxOrdinalGroup,
		'inherit',
		'-webkit-box-ordinal-group: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-box-ordinal-group'),
		'inherit',
		'-webkit-box-ordinal-group: accepts inherit'
	);
	s.webkitBoxOrdinalGroup = '';
...
// --- -webkit-box-orient ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-box-orient'),
		'horizontal',
		'-webkit-box-orient: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-box-orient'),
		'inherit',
		'-webkit-box-orient: accepts inherit'
	);
	s.webkitBoxOrient = '';
...
// --- -webkit-box-pack ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-box-pack'),
		'start',
		'-webkit-box-pack: getPropertyValue matches accessor'
	);
...
// --- -webkit-box-reflect ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-box-reflect'),
		'initial',
		'-webkit-box-reflect: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-box-reflect'),
		'inherit',
		'-webkit-box-reflect: accepts inherit'
	);
	s.webkitBoxReflect = '';
...
// --- column-count ---
{
	...
	assertEq(
		s.getPropertyValue('column-count'),
		'auto',
		'column-count: getPropertyValue matches accessor'
	);
...
// --- column-gap ---
{
	...
	assertEq(
		s.getPropertyValue('column-gap'),
		'10px',
		'column-gap: getPropertyValue matches accessor'
	);
	s.columnGap = '20px';
...
// --- rule-overlap ---
{
	...
	assertEq(
		s.getPropertyValue('rule-overlap'),
		'row-over-column',
		'rule-overlap: getPropertyValue matches accessor'
	);
...
// --- column-rule-break ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-break'),
		'none',
		'column-rule-break: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('column-rule-break'),
		'inherit',
		'column-rule-break: accepts inherit'
	);
	s.columnRuleBreak = '';
...
// --- row-rule-break ---
{
	...
	assertEq(
		s.getPropertyValue('row-rule-break'),
		'none',
		'row-rule-break: getPropertyValue matches accessor'
	);
...
// --- column-rule-edge-inset-end ---
{
	...
	assertEq(
		...
		'overlap-join',
		'column-rule-edge-inset-end: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'overlap-join',
		'column-rule-edge-inset-end: getPropertyValue matches accessor'
	);
	s.columnRuleEdgeInsetEnd = 'inherit';
	assertEq(
		s.columnRuleEdgeInsetEnd,
		'inherit',
		'column-rule-edge-inset-end: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'inherit',
		'column-rule-edge-inset-end: accepts inherit'
	);
	s.columnRuleEdgeInsetEnd = '';
...
// --- row-rule-edge-inset-end ---
{
	...
	assertEq(
		...
		'overlap-join',
		'row-rule-edge-inset-end: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'overlap-join',
		'row-rule-edge-inset-end: getPropertyValue matches accessor'
	);
	s.rowRuleEdgeInsetEnd = 'inherit';
	assertEq(
		s.rowRuleEdgeInsetEnd,
		'inherit',
		'row-rule-edge-inset-end: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'inherit',
		'row-rule-edge-inset-end: accepts inherit'
	);
	s.rowRuleEdgeInsetEnd = '';
...
// --- column-rule-edge-inset-start ---
{
	...
	assertEq(
		...
		'overlap-join',
		'column-rule-edge-inset-start: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'overlap-join',
		'column-rule-edge-inset-start: getPropertyValue matches accessor'
	);
	s.columnRuleEdgeInsetStart = 'inherit';
	assertEq(
		s.columnRuleEdgeInsetStart,
		'inherit',
		'column-rule-edge-inset-start: overwrite with second value'
	);
	s.removeProperty('column-rule-edge-inset-start');
	assertEq(
		s.columnRuleEdgeInsetStart,
		'',
		'column-rule-edge-inset-start: removeProperty clears value'
	);
	s.setProperty('column-rule-edge-inset-start', 'inherit');
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'inherit',
		'column-rule-edge-inset-start: accepts inherit'
	);
	s.columnRuleEdgeInsetStart = '';
...
// --- row-rule-edge-inset-start ---
{
	...
	assertEq(
		...
		'overlap-join',
		'row-rule-edge-inset-start: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'overlap-join',
		'row-rule-edge-inset-start: getPropertyValue matches accessor'
	);
	s.rowRuleEdgeInsetStart = 'inherit';
	assertEq(
		s.rowRuleEdgeInsetStart,
		'inherit',
		'row-rule-edge-inset-start: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'inherit',
		'row-rule-edge-inset-start: accepts inherit'
	);
	s.rowRuleEdgeInsetStart = '';
...
// --- column-rule-interior-inset-end ---
{
	...
	assertEq(
		...
		'overlap-join',
		'column-rule-interior-inset-end: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'overlap-join',
		'column-rule-interior-inset-end: getPropertyValue matches accessor'
	);
	s.columnRuleInteriorInsetEnd = 'inherit';
	assertEq(
		s.columnRuleInteriorInsetEnd,
		'inherit',
		'column-rule-interior-inset-end: overwrite with second value'
	);
	s.removeProperty('column-rule-interior-inset-end');
	assertEq(
		s.columnRuleInteriorInsetEnd,
		'',
		'column-rule-interior-inset-end: removeProperty clears value'
	);
	s.setProperty('column-rule-interior-inset-end', 'inherit');
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'inherit',
		'column-rule-interior-inset-end: accepts inherit'
	);
	s.columnRuleInteriorInsetEnd = '';
	assertEq(
		s.columnRuleInteriorInsetEnd,
		'',
		'column-rule-interior-inset-end: empty string removes'
	);
}
...
// --- row-rule-interior-inset-end ---
{
	...
	assertEq(
		...
		'overlap-join',
		'row-rule-interior-inset-end: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'overlap-join',
		'row-rule-interior-inset-end: getPropertyValue matches accessor'
	);
	s.rowRuleInteriorInsetEnd = 'inherit';
	assertEq(
		s.rowRuleInteriorInsetEnd,
		'inherit',
		'row-rule-interior-inset-end: overwrite with second value'
	);
	s.removeProperty('row-rule-interior-inset-end');
	assertEq(
		s.rowRuleInteriorInsetEnd,
		'',
		'row-rule-interior-inset-end: removeProperty clears value'
	);
	s.setProperty('row-rule-interior-inset-end', 'inherit');
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'inherit',
		'row-rule-interior-inset-end: accepts inherit'
	);
	s.rowRuleInteriorInsetEnd = '';
...
// --- column-rule-interior-inset-start ---
{
	...
	assertEq(
		...
		'overlap-join',
		'column-rule-interior-inset-start: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'overlap-join',
		'column-rule-interior-inset-start: getPropertyValue matches accessor'
	);
	s.columnRuleInteriorInsetStart = 'inherit';
	assertEq(
		s.columnRuleInteriorInsetStart,
		'inherit',
		'column-rule-interior-inset-start: overwrite with second value'
	);
	s.removeProperty('column-rule-interior-inset-start');
	assertEq(
		s.columnRuleInteriorInsetStart,
		'',
		'column-rule-interior-inset-start: removeProperty clears value'
	);
	s.setProperty('column-rule-interior-inset-start', 'inherit');
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'inherit',
		'column-rule-interior-inset-start: accepts inherit'
	);
	s.columnRuleInteriorInsetStart = '';
	assertEq(
		s.columnRuleInteriorInsetStart,
		'',
		'column-rule-interior-inset-start: empty string removes'
	);
}
...
// --- row-rule-interior-inset-start ---
{
	...
	assertEq(
		...
		'overlap-join',
		'row-rule-interior-inset-start: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'overlap-join',
		'row-rule-interior-inset-start: getPropertyValue matches accessor'
	);
	s.rowRuleInteriorInsetStart = 'inherit';
	assertEq(
		s.rowRuleInteriorInsetStart,
		'inherit',
		'row-rule-interior-inset-start: overwrite with second value'
	);
	s.removeProperty('row-rule-interior-inset-start');
	assertEq(
		s.rowRuleInteriorInsetStart,
		'',
		'row-rule-interior-inset-start: removeProperty clears value'
	);
	s.setProperty('row-rule-interior-inset-start', 'inherit');
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'inherit',
		'row-rule-interior-inset-start: accepts inherit'
	);
	s.rowRuleInteriorInsetStart = '';
...
// --- column-rule-color ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-color'),
		'red',
		'column-rule-color: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('column-rule-color'),
		'inherit',
		'column-rule-color: accepts inherit'
	);
	s.columnRuleColor = '';
...
// --- row-rule-color ---
{
	...
	assertEq(
		s.getPropertyValue('row-rule-color'),
		'currentcolor',
		'row-rule-color: getPropertyValue matches accessor'
	);
...
// --- column-rule-style ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-style'),
		'none',
		'column-rule-style: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('column-rule-style'),
		'inherit',
		'column-rule-style: accepts inherit'
	);
	s.columnRuleStyle = '';
...
// --- row-rule-style ---
{
	...
	assertEq(
		s.getPropertyValue('row-rule-style'),
		'none',
		'row-rule-style: getPropertyValue matches accessor'
	);
...
// --- column-rule-visibility-items ---
{
	...
	assertEq(
		...
		'all',
		'column-rule-visibility-items: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('column-rule-visibility-items'),
		'all',
		'column-rule-visibility-items: getPropertyValue matches accessor'
	);
	s.columnRuleVisibilityItems = 'auto';
	assertEq(
		s.columnRuleVisibilityItems,
		'auto',
		'column-rule-visibility-items: overwrite with second value'
	);
	s.removeProperty('column-rule-visibility-items');
	assertEq(
		s.columnRuleVisibilityItems,
		'',
		'column-rule-visibility-items: removeProperty clears value'
	);
	s.setProperty('column-rule-visibility-items', 'inherit');
	assertEq(
		s.getPropertyValue('column-rule-visibility-items'),
		'inherit',
		'column-rule-visibility-items: accepts inherit'
	);
	s.columnRuleVisibilityItems = '';
	...
	assertEq(
		s.columnRuleVisibilityItems,
		'all',
		'column-rule-visibility-items: rejects invalid keyword'
	);
}
...
// --- row-rule-visibility-items ---
{
	...
	assertEq(
		...
		'all',
		'row-rule-visibility-items: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('row-rule-visibility-items'),
		'all',
		'row-rule-visibility-items: getPropertyValue matches accessor'
	);
	s.rowRuleVisibilityItems = 'auto';
	assertEq(
		s.rowRuleVisibilityItems,
		'auto',
		'row-rule-visibility-items: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('row-rule-visibility-items'),
		'inherit',
		'row-rule-visibility-items: accepts inherit'
	);
	s.rowRuleVisibilityItems = '';
...
// --- column-rule-width ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-width'),
		'thin',
		'column-rule-width: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('column-rule-width'),
		'inherit',
		'column-rule-width: accepts inherit'
	);
	s.columnRuleWidth = '';
...
// --- row-rule-width ---
{
	...
	assertEq(
		s.getPropertyValue('row-rule-width'),
		'thin',
		'row-rule-width: getPropertyValue matches accessor'
	);
...
// --- column-span ---
{
	...
	assertEq(
		s.getPropertyValue('column-span'),
		'none',
		'column-span: getPropertyValue matches accessor'
	);
	s.columnSpan = 'all';
...
// --- column-width ---
{
	...
	assertEq(
		s.getPropertyValue('column-width'),
		'10px',
		'column-width: getPropertyValue matches accessor'
	);
	s.columnWidth = '20px';
...
// --- column-height ---
{
	...
	assertEq(
		s.getPropertyValue('column-height'),
		'auto',
		'column-height: getPropertyValue matches accessor'
	);
...
// --- column-wrap ---
{
	...
	assertEq(
		s.getPropertyValue('column-wrap'),
		'auto',
		'column-wrap: getPropertyValue matches accessor'
	);
	s.columnWrap = 'nowrap';
...
// --- hyphenate-character ---
{
	...
	assertEq(
		s.getPropertyValue('hyphenate-character'),
		'initial',
		'hyphenate-character: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('hyphenate-character'),
		'inherit',
		'hyphenate-character: accepts inherit'
	);
...
// --- -webkit-line-break ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-line-break'),
		'auto',
		'-webkit-line-break: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-line-break'),
		'inherit',
		'-webkit-line-break: accepts inherit'
	);
	s.webkitLineBreak = '';
...
// --- line-break ---
{
	...
	assertEq(
		s.getPropertyValue('line-break'),
		'auto',
		'line-break: getPropertyValue matches accessor'
	);
	s.lineBreak = 'loose';
...
// --- block-ellipsis ---
{
	...
	assertEq(
		s.getPropertyValue('block-ellipsis'),
		'auto',
		'block-ellipsis: getPropertyValue matches accessor'
	);
...
// --- -webkit-line-clamp ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-line-clamp'),
		'none',
		'-webkit-line-clamp: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-line-clamp'),
		'inherit',
		'-webkit-line-clamp: accepts inherit'
	);
	s.webkitLineClamp = '';
...
// --- -webkit-mask-box-image-outset ---
{
	...
	assertEq(
		...
		'none',
		'-webkit-mask-box-image-outset: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-outset'),
		'none',
		'-webkit-mask-box-image-outset: getPropertyValue matches accessor'
	);
	s.webkitMaskBoxImageOutset = 'inherit';
	assertEq(
		s.webkitMaskBoxImageOutset,
		'inherit',
		'-webkit-mask-box-image-outset: overwrite with second value'
	);
	s.removeProperty('-webkit-mask-box-image-outset');
	assertEq(
		s.webkitMaskBoxImageOutset,
		'',
		'-webkit-mask-box-image-outset: removeProperty clears value'
	);
	s.setProperty('-webkit-mask-box-image-outset', 'inherit');
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-outset'),
		'inherit',
		'-webkit-mask-box-image-outset: accepts inherit'
	);
	s.webkitMaskBoxImageOutset = '';
...
// --- -webkit-mask-box-image-repeat ---
{
	...
	assertEq(
		...
		'none',
		'-webkit-mask-box-image-repeat: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-repeat'),
		'none',
		'-webkit-mask-box-image-repeat: getPropertyValue matches accessor'
	);
	s.webkitMaskBoxImageRepeat = 'inherit';
	assertEq(
		s.webkitMaskBoxImageRepeat,
		'inherit',
		'-webkit-mask-box-image-repeat: overwrite with second value'
	);
	s.removeProperty('-webkit-mask-box-image-repeat');
	assertEq(
		s.webkitMaskBoxImageRepeat,
		'',
		'-webkit-mask-box-image-repeat: removeProperty clears value'
	);
	s.setProperty('-webkit-mask-box-image-repeat', 'inherit');
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-repeat'),
		'inherit',
		'-webkit-mask-box-image-repeat: accepts inherit'
	);
	s.webkitMaskBoxImageRepeat = '';
...
// --- -webkit-mask-box-image-slice ---
{
	...
	assertEq(
		...
		'none',
		'-webkit-mask-box-image-slice: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-slice'),
		'none',
		'-webkit-mask-box-image-slice: getPropertyValue matches accessor'
	);
	s.webkitMaskBoxImageSlice = 'inherit';
	assertEq(
		s.webkitMaskBoxImageSlice,
		'inherit',
		'-webkit-mask-box-image-slice: overwrite with second value'
	);
	s.removeProperty('-webkit-mask-box-image-slice');
	assertEq(
		s.webkitMaskBoxImageSlice,
		'',
		'-webkit-mask-box-image-slice: removeProperty clears value'
	);
	s.setProperty('-webkit-mask-box-image-slice', 'inherit');
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-slice'),
		'inherit',
		'-webkit-mask-box-image-slice: accepts inherit'
	);
	s.webkitMaskBoxImageSlice = '';
...
// --- -webkit-mask-box-image-source ---
{
	...
	assertEq(
		...
		'none',
		'-webkit-mask-box-image-source: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-source'),
		'none',
		'-webkit-mask-box-image-source: getPropertyValue matches accessor'
	);
	s.webkitMaskBoxImageSource = 'inherit';
	assertEq(
		s.webkitMaskBoxImageSource,
		'inherit',
		'-webkit-mask-box-image-source: overwrite with second value'
	);
	s.removeProperty('-webkit-mask-box-image-source');
	assertEq(
		s.webkitMaskBoxImageSource,
		'',
		'-webkit-mask-box-image-source: removeProperty clears value'
	);
	s.setProperty('-webkit-mask-box-image-source', 'inherit');
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-source'),
		'inherit',
		'-webkit-mask-box-image-source: accepts inherit'
	);
	s.webkitMaskBoxImageSource = '';
...
// --- -webkit-mask-box-image-width ---
{
	...
	assertEq(
		...
		'10px',
		'-webkit-mask-box-image-width: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-width'),
		'10px',
		'-webkit-mask-box-image-width: getPropertyValue matches accessor'
	);
	s.webkitMaskBoxImageWidth = 'inherit';
	assertEq(
		s.webkitMaskBoxImageWidth,
		'inherit',
		'-webkit-mask-box-image-width: overwrite with second value'
	);
	s.removeProperty('-webkit-mask-box-image-width');
	assertEq(
		s.webkitMaskBoxImageWidth,
		'',
		'-webkit-mask-box-image-width: removeProperty clears value'
	);
	s.setProperty('-webkit-mask-box-image-width', 'inherit');
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-width'),
		'inherit',
		'-webkit-mask-box-image-width: accepts inherit'
	);
	s.webkitMaskBoxImageWidth = '';
...
// --- mask-mode ---
{
	...
	assertEq(
		s.getPropertyValue('mask-mode'),
		'alpha',
		'mask-mode: getPropertyValue matches accessor'
	);
...
// --- mask-clip ---
{
	...
	assertEq(
		s.getPropertyValue('mask-clip'),
		'initial',
		'mask-clip: getPropertyValue matches accessor'
	);
	s.maskClip = 'inherit';
...
// --- mask-composite ---
{
	...
	assertEq(
		s.getPropertyValue('mask-composite'),
		'add',
		'mask-composite: getPropertyValue matches accessor'
	);
...
// --- mask-image ---
{
	...
	assertEq(
		...
		'none',
		'mask-image: getPropertyValue matches accessor'
	);
	s.maskImage = 'inherit';
...
// --- mask-origin ---
{
	...
	assertEq(
		s.getPropertyValue('mask-origin'),
		'initial',
		'mask-origin: getPropertyValue matches accessor'
	);
...
// --- -webkit-mask-position-x ---
{
	...
	assertEq(
		...
		'initial',
		'-webkit-mask-position-x: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-position-x'),
		'initial',
		'-webkit-mask-position-x: getPropertyValue matches accessor'
	);
	s.webkitMaskPositionX = 'inherit';
	assertEq(
		s.webkitMaskPositionX,
		'inherit',
		'-webkit-mask-position-x: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-mask-position-x'),
		'inherit',
		'-webkit-mask-position-x: accepts inherit'
	);
	s.webkitMaskPositionX = '';
...
// --- -webkit-mask-position-y ---
{
	...
	assertEq(
		...
		'initial',
		'-webkit-mask-position-y: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-position-y'),
		'initial',
		'-webkit-mask-position-y: getPropertyValue matches accessor'
	);
	s.webkitMaskPositionY = 'inherit';
	assertEq(
		s.webkitMaskPositionY,
		'inherit',
		'-webkit-mask-position-y: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-mask-position-y'),
		'inherit',
		'-webkit-mask-position-y: accepts inherit'
	);
	s.webkitMaskPositionY = '';
...
// --- mask-repeat ---
{
	...
	assertEq(
		s.getPropertyValue('mask-repeat'),
		'initial',
		'mask-repeat: getPropertyValue matches accessor'
	);
...
// --- -webkit-perspective-origin-x ---
{
	...
	assertEq(
		...
		'initial',
		'-webkit-perspective-origin-x: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-perspective-origin-x'),
		'initial',
		'-webkit-perspective-origin-x: getPropertyValue matches accessor'
	);
	s.webkitPerspectiveOriginX = 'inherit';
	assertEq(
		s.webkitPerspectiveOriginX,
		'inherit',
		'-webkit-perspective-origin-x: overwrite with second value'
	);
	s.removeProperty('-webkit-perspective-origin-x');
	assertEq(
		s.webkitPerspectiveOriginX,
		'',
		'-webkit-perspective-origin-x: removeProperty clears value'
	);
	s.setProperty('-webkit-perspective-origin-x', 'inherit');
	assertEq(
		s.getPropertyValue('-webkit-perspective-origin-x'),
		'inherit',
		'-webkit-perspective-origin-x: accepts inherit'
	);
	s.webkitPerspectiveOriginX = '';
...
// --- -webkit-perspective-origin-y ---
{
	...
	assertEq(
		...
		'initial',
		'-webkit-perspective-origin-y: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-perspective-origin-y'),
		'initial',
		'-webkit-perspective-origin-y: getPropertyValue matches accessor'
	);
	s.webkitPerspectiveOriginY = 'inherit';
	assertEq(
		s.webkitPerspectiveOriginY,
		'inherit',
		'-webkit-perspective-origin-y: overwrite with second value'
	);
	s.removeProperty('-webkit-perspective-origin-y');
	assertEq(
		s.webkitPerspectiveOriginY,
		'',
		'-webkit-perspective-origin-y: removeProperty clears value'
	);
	s.setProperty('-webkit-perspective-origin-y', 'inherit');
	assertEq(
		s.getPropertyValue('-webkit-perspective-origin-y'),
		'inherit',
		'-webkit-perspective-origin-y: accepts inherit'
	);
	s.webkitPerspectiveOriginY = '';
...
// --- -webkit-rtl-ordering ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-rtl-ordering'),
		'logical',
		'-webkit-rtl-ordering: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-rtl-ordering'),
		'inherit',
		'-webkit-rtl-ordering: accepts inherit'
	);
	s.webkitRtlOrdering = '';
...
// --- ruby-align ---
{
	...
	assertEq(
		s.getPropertyValue('ruby-align'),
		'space-around',
		'ruby-align: getPropertyValue matches accessor'
	);
	s.rubyAlign = 'start';
...
// --- ruby-overhang ---
{
	...
	assertEq(
		s.getPropertyValue('ruby-overhang'),
		'auto',
		'ruby-overhang: getPropertyValue matches accessor'
	);
	s.rubyOverhang = 'none';
...
// --- -webkit-ruby-position ---
{
	...
	assertEq(
		...
		'initial',
		'-webkit-ruby-position: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-ruby-position'),
		'initial',
		'-webkit-ruby-position: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-ruby-position'),
		'inherit',
		'-webkit-ruby-position: accepts inherit'
	);
	s.webkitRubyPosition = '';
...
// --- ruby-position ---
{
	...
	assertEq(
		s.getPropertyValue('ruby-position'),
		'over',
		'ruby-position: getPropertyValue matches accessor'
	);
...
// --- -webkit-tap-highlight-color ---
{
	...
	assertEq(
		...
		'blue',
		'-webkit-tap-highlight-color: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-tap-highlight-color'),
		'blue',
		'-webkit-tap-highlight-color: getPropertyValue matches accessor'
	);
	s.webkitTapHighlightColor = 'inherit';
	assertEq(
		s.webkitTapHighlightColor,
		'inherit',
		'-webkit-tap-highlight-color: overwrite with second value'
	);
	s.removeProperty('-webkit-tap-highlight-color');
	assertEq(
		s.webkitTapHighlightColor,
		'',
		'-webkit-tap-highlight-color: removeProperty clears value'
	);
	s.setProperty('-webkit-tap-highlight-color', 'inherit');
	assertEq(
		s.getPropertyValue('-webkit-tap-highlight-color'),
		'inherit',
		'-webkit-tap-highlight-color: accepts inherit'
	);
	s.webkitTapHighlightColor = '';
...
// --- -webkit-text-combine ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-text-combine'),
		'initial',
		'-webkit-text-combine: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-text-combine'),
		'inherit',
		'-webkit-text-combine: accepts inherit'
	);
	s.webkitTextCombine = '';
...
// --- text-emphasis-color ---
{
	...
	assertEq(
		s.getPropertyValue('text-emphasis-color'),
		'red',
		'text-emphasis-color: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('text-emphasis-color'),
		'inherit',
		'text-emphasis-color: accepts inherit'
	);
	s.textEmphasisColor = '';
...
// --- text-emphasis-position ---
{
	...
	assertEq(
		...
		'initial',
		'text-emphasis-position: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('text-emphasis-position'),
		'initial',
		'text-emphasis-position: getPropertyValue matches accessor'
	);
	s.textEmphasisPosition = 'inherit';
	assertEq(
		s.textEmphasisPosition,
		'inherit',
		'text-emphasis-position: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('text-emphasis-position'),
		'inherit',
		'text-emphasis-position: accepts inherit'
	);
	s.textEmphasisPosition = '';
...
// --- text-emphasis-style ---
{
	...
	assertEq(
		s.getPropertyValue('text-emphasis-style'),
		'initial',
		'text-emphasis-style: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('text-emphasis-style'),
		'inherit',
		'text-emphasis-style: accepts inherit'
	);
	s.textEmphasisStyle = '';
...
// --- -webkit-text-fill-color ---
{
	...
	assertEq(
		...
		'red',
		'-webkit-text-fill-color: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-text-fill-color'),
		'red',
		'-webkit-text-fill-color: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-text-fill-color'),
		'inherit',
		'-webkit-text-fill-color: accepts inherit'
	);
	s.webkitTextFillColor = '';
...
// --- text-fit ---
{
	...
	assertEq(
		s.getPropertyValue('text-fit'),
		'initial',
		'text-fit: getPropertyValue matches accessor'
	);
	s.textFit = 'inherit';
...
// --- -webkit-text-security ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-text-security'),
		'none',
		'-webkit-text-security: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-text-security'),
		'inherit',
		'-webkit-text-security: accepts inherit'
	);
...
// --- -webkit-text-stroke-color ---
{
	...
	assertEq(
		...
		'red',
		'-webkit-text-stroke-color: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-text-stroke-color'),
		'red',
		'-webkit-text-stroke-color: getPropertyValue matches accessor'
	);
	s.webkitTextStrokeColor = 'blue';
	assertEq(
		s.webkitTextStrokeColor,
		'blue',
		'-webkit-text-stroke-color: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-text-stroke-color'),
		'inherit',
		'-webkit-text-stroke-color: accepts inherit'
	);
	s.webkitTextStrokeColor = '';
...
// --- -webkit-text-stroke-width ---
{
	...
	assertEq(
		...
		'10px',
		'-webkit-text-stroke-width: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-text-stroke-width'),
		'10px',
		'-webkit-text-stroke-width: getPropertyValue matches accessor'
	);
	s.webkitTextStrokeWidth = 'inherit';
	assertEq(
		s.webkitTextStrokeWidth,
		'inherit',
		'-webkit-text-stroke-width: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-text-stroke-width'),
		'inherit',
		'-webkit-text-stroke-width: accepts inherit'
	);
	s.webkitTextStrokeWidth = '';
...
// --- -webkit-transform-origin-x ---
{
	...
	assertEq(
		...
		'initial',
		'-webkit-transform-origin-x: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-transform-origin-x'),
		'initial',
		'-webkit-transform-origin-x: getPropertyValue matches accessor'
	);
	s.webkitTransformOriginX = 'inherit';
	assertEq(
		s.webkitTransformOriginX,
		'inherit',
		'-webkit-transform-origin-x: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-transform-origin-x'),
		'inherit',
		'-webkit-transform-origin-x: accepts inherit'
	);
	s.webkitTransformOriginX = '';
...
// --- -webkit-transform-origin-y ---
{
	...
	assertEq(
		...
		'initial',
		'-webkit-transform-origin-y: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-transform-origin-y'),
		'initial',
		'-webkit-transform-origin-y: getPropertyValue matches accessor'
	);
	s.webkitTransformOriginY = 'inherit';
	assertEq(
		s.webkitTransformOriginY,
		'inherit',
		'-webkit-transform-origin-y: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-transform-origin-y'),
		'inherit',
		'-webkit-transform-origin-y: accepts inherit'
	);
	s.webkitTransformOriginY = '';
...
// --- -webkit-transform-origin-z ---
{
	...
	assertEq(
		...
		'initial',
		'-webkit-transform-origin-z: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-transform-origin-z'),
		'initial',
		'-webkit-transform-origin-z: getPropertyValue matches accessor'
	);
	s.webkitTransformOriginZ = 'inherit';
	assertEq(
		s.webkitTransformOriginZ,
		'inherit',
		'-webkit-transform-origin-z: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-transform-origin-z'),
		'inherit',
		'-webkit-transform-origin-z: accepts inherit'
	);
	s.webkitTransformOriginZ = '';
...
// --- -webkit-user-drag ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-user-drag'),
		'auto',
		'-webkit-user-drag: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-user-drag'),
		'inherit',
		'-webkit-user-drag: accepts inherit'
	);
	s.webkitUserDrag = '';
...
// --- -webkit-user-modify ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-user-modify'),
		'read-only',
		'-webkit-user-modify: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-user-modify'),
		'inherit',
		'-webkit-user-modify: accepts inherit'
	);
	s.webkitUserModify = '';
...
// --- user-select ---
{
	...
	assertEq(
		...
		'auto',
		'user-select: getPropertyValue matches accessor'
	);
	s.userSelect = 'none';
...
// --- white-space-collapse ---
{
	...
	assertEq(
		...
		'collapse',
		'white-space-collapse: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('white-space-collapse'),
		'collapse',
		'white-space-collapse: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('white-space-collapse'),
		'inherit',
		'white-space-collapse: accepts inherit'
	);
	s.whiteSpaceCollapse = '';
...
// --- text-wrap-mode ---
{
	...
	assertEq(
		s.getPropertyValue('text-wrap-mode'),
		'wrap',
		'text-wrap-mode: getPropertyValue matches accessor'
	);
...
// --- text-wrap-style ---
{
	...
	assertEq(
		s.getPropertyValue('text-wrap-style'),
		'auto',
		'text-wrap-style: getPropertyValue matches accessor'
	);
...
// --- will-change ---
{
	...
	assertEq(
		s.getPropertyValue('will-change'),
		'auto',
		'will-change: getPropertyValue matches accessor'
	);
...
// --- word-break ---
{
	...
	assertEq(
		s.getPropertyValue('word-break'),
		'normal',
		'word-break: getPropertyValue matches accessor'
	);
...
// --- word-spacing ---
{
	...
	assertEq(
		s.getPropertyValue('word-spacing'),
		'10px',
		'word-spacing: getPropertyValue matches accessor'
	);
	s.wordSpacing = '20px';
...
// --- inline-size ---
{
	...
	assertEq(
		s.getPropertyValue('inline-size'),
		'10px',
		'inline-size: getPropertyValue matches accessor'
	);
	s.inlineSize = '20px';
...
// --- block-size ---
{
	...
	assertEq(
		s.getPropertyValue('block-size'),
		'10px',
		'block-size: getPropertyValue matches accessor'
	);
	s.blockSize = '20px';
...
// --- min-inline-size ---
{
	...
	assertEq(
		s.getPropertyValue('min-inline-size'),
		'10px',
		'min-inline-size: getPropertyValue matches accessor'
	);
...
// --- min-block-size ---
{
	...
	assertEq(
		s.getPropertyValue('min-block-size'),
		'10px',
		'min-block-size: getPropertyValue matches accessor'
	);
	s.minBlockSize = '20px';
...
// --- max-inline-size ---
{
	...
	assertEq(
		s.getPropertyValue('max-inline-size'),
		'10px',
		'max-inline-size: getPropertyValue matches accessor'
	);
...
// --- max-block-size ---
{
	...
	assertEq(
		s.getPropertyValue('max-block-size'),
		'10px',
		'max-block-size: getPropertyValue matches accessor'
	);
	s.maxBlockSize = '20px';
...
// --- margin-inline-start ---
{
	...
	assertEq(
		s.getPropertyValue('margin-inline-start'),
		'10px',
		'margin-inline-start: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('margin-inline-start'),
		'inherit',
		'margin-inline-start: accepts inherit'
	);
	s.marginInlineStart = '';
...
// --- margin-inline-end ---
{
	...
	assertEq(
		s.getPropertyValue('margin-inline-end'),
		'10px',
		'margin-inline-end: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('margin-inline-end'),
		'inherit',
		'margin-inline-end: accepts inherit'
	);
	s.marginInlineEnd = '';
...
// --- margin-block-start ---
{
	...
	assertEq(
		s.getPropertyValue('margin-block-start'),
		'10px',
		'margin-block-start: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('margin-block-start'),
		'inherit',
		'margin-block-start: accepts inherit'
	);
	s.marginBlockStart = '';
...
// --- margin-block-end ---
{
	...
	assertEq(
		s.getPropertyValue('margin-block-end'),
		'10px',
		'margin-block-end: getPropertyValue matches accessor'
	);
...
// --- padding-inline-start ---
{
	...
	assertEq(
		s.getPropertyValue('padding-inline-start'),
		'10px',
		'padding-inline-start: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('padding-inline-start'),
		'inherit',
		'padding-inline-start: accepts inherit'
	);
...
// --- padding-inline-end ---
{
	...
	assertEq(
		s.getPropertyValue('padding-inline-end'),
		'10px',
		'padding-inline-end: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('padding-inline-end'),
		'inherit',
		'padding-inline-end: accepts inherit'
	);
	s.paddingInlineEnd = '';
...
// --- padding-block-start ---
{
	...
	assertEq(
		s.getPropertyValue('padding-block-start'),
		'10px',
		'padding-block-start: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('padding-block-start'),
		'inherit',
		'padding-block-start: accepts inherit'
	);
	s.paddingBlockStart = '';
...
// --- padding-block-end ---
{
	...
	assertEq(
		s.getPropertyValue('padding-block-end'),
		'10px',
		'padding-block-end: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('padding-block-end'),
		'inherit',
		'padding-block-end: accepts inherit'
	);
	s.paddingBlockEnd = '';
...
// --- border-inline-start-width ---
{
	...
	assertEq(
		...
		'10px',
		'border-inline-start-width: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('border-inline-start-width'),
		'10px',
		'border-inline-start-width: getPropertyValue matches accessor'
	);
	s.borderInlineStartWidth = '20px';
	assertEq(
		s.borderInlineStartWidth,
		'20px',
		'border-inline-start-width: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('border-inline-start-width'),
		'inherit',
		'border-inline-start-width: accepts inherit'
	);
	s.borderInlineStartWidth = '';
...
// --- border-inline-start-style ---
{
	...
	assertEq(
		...
		'initial',
		'border-inline-start-style: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('border-inline-start-style'),
		'initial',
		'border-inline-start-style: getPropertyValue matches accessor'
	);
	s.borderInlineStartStyle = 'inherit';
	assertEq(
		s.borderInlineStartStyle,
		'inherit',
		'border-inline-start-style: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('border-inline-start-style'),
		'inherit',
		'border-inline-start-style: accepts inherit'
	);
	s.borderInlineStartStyle = '';
...
// --- border-inline-start-color ---
{
	...
	assertEq(
		...
		'red',
		'border-inline-start-color: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('border-inline-start-color'),
		'red',
		'border-inline-start-color: getPropertyValue matches accessor'
	);
	s.borderInlineStartColor = 'blue';
	assertEq(
		s.borderInlineStartColor,
		'blue',
		'border-inline-start-color: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('border-inline-start-color'),
		'inherit',
		'border-inline-start-color: accepts inherit'
	);
	s.borderInlineStartColor = '';
...
// --- border-inline-end-width ---
{
	...
	assertEq(
		...
		'10px',
		'border-inline-end-width: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-width'),
		'10px',
		'border-inline-end-width: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-inline-end-width'),
		'inherit',
		'border-inline-end-width: accepts inherit'
	);
	s.borderInlineEndWidth = '';
...
// --- border-inline-end-style ---
{
	...
	assertEq(
		...
		'initial',
		'border-inline-end-style: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-style'),
		'initial',
		'border-inline-end-style: getPropertyValue matches accessor'
	);
	s.borderInlineEndStyle = 'inherit';
	assertEq(
		s.borderInlineEndStyle,
		'inherit',
		'border-inline-end-style: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('border-inline-end-style'),
		'inherit',
		'border-inline-end-style: accepts inherit'
	);
	s.borderInlineEndStyle = '';
...
// --- border-inline-end-color ---
{
	...
	assertEq(
		...
		'red',
		'border-inline-end-color: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-color'),
		'red',
		'border-inline-end-color: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-inline-end-color'),
		'inherit',
		'border-inline-end-color: accepts inherit'
	);
	s.borderInlineEndColor = '';
...
// --- border-block-start-width ---
{
	...
	assertEq(
		...
		'10px',
		'border-block-start-width: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('border-block-start-width'),
		'10px',
		'border-block-start-width: getPropertyValue matches accessor'
	);
	s.borderBlockStartWidth = '20px';
	assertEq(
		s.borderBlockStartWidth,
		'20px',
		'border-block-start-width: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('border-block-start-width'),
		'inherit',
		'border-block-start-width: accepts inherit'
	);
	s.borderBlockStartWidth = '';
...
// --- border-block-start-style ---
{
	...
	assertEq(
		...
		'initial',
		'border-block-start-style: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('border-block-start-style'),
		'initial',
		'border-block-start-style: getPropertyValue matches accessor'
	);
	s.borderBlockStartStyle = 'inherit';
	assertEq(
		s.borderBlockStartStyle,
		'inherit',
		'border-block-start-style: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('border-block-start-style'),
		'inherit',
		'border-block-start-style: accepts inherit'
	);
	s.borderBlockStartStyle = '';
...
// --- border-block-start-color ---
{
	...
	assertEq(
		...
		'red',
		'border-block-start-color: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('border-block-start-color'),
		'red',
		'border-block-start-color: getPropertyValue matches accessor'
	);
	s.borderBlockStartColor = 'blue';
	assertEq(
		s.borderBlockStartColor,
		'blue',
		'border-block-start-color: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('border-block-start-color'),
		'inherit',
		'border-block-start-color: accepts inherit'
	);
	s.borderBlockStartColor = '';
...
// --- border-block-end-width ---
{
	...
	assertEq(
		...
		'10px',
		'border-block-end-width: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('border-block-end-width'),
		'10px',
		'border-block-end-width: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-block-end-width'),
		'inherit',
		'border-block-end-width: accepts inherit'
	);
	s.borderBlockEndWidth = '';
...
// --- border-block-end-style ---
{
	...
	assertEq(
		...
		'initial',
		'border-block-end-style: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('border-block-end-style'),
		'initial',
		'border-block-end-style: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-block-end-style'),
		'inherit',
		'border-block-end-style: accepts inherit'
	);
	s.borderBlockEndStyle = '';
...
// --- border-block-end-color ---
{
	...
	assertEq(
		s.getPropertyValue('border-block-end-color'),
		'red',
		'border-block-end-color: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-block-end-color'),
		'inherit',
		'border-block-end-color: accepts inherit'
	);
...
// --- inset-inline-start ---
{
	...
	assertEq(
		...
		'10px',
		'inset-inline-start: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('inset-inline-start'),
		'inherit',
		'inset-inline-start: accepts inherit'
	);
	s.insetInlineStart = '';
...
// --- inset-inline-end ---
{
	...
	assertEq(
		...
		'10px',
		'inset-inline-end: getPropertyValue matches accessor'
	);
...
// --- inset-block-start ---
{
	...
	assertEq(
		s.getPropertyValue('inset-block-start'),
		'10px',
		'inset-block-start: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('inset-block-start'),
		'inherit',
		'inset-block-start: accepts inherit'
	);
	s.insetBlockStart = '';
...
// --- inset-block-end ---
{
	...
	assertEq(
		s.getPropertyValue('inset-block-end'),
		'10px',
		'inset-block-end: getPropertyValue matches accessor'
	);
...
// --- border-start-start-radius ---
{
	...
	assertEq(
		...
		'10px',
		'border-start-start-radius: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('border-start-start-radius'),
		'10px',
		'border-start-start-radius: getPropertyValue matches accessor'
	);
	s.borderStartStartRadius = '20px';
	assertEq(
		s.borderStartStartRadius,
		'20px',
		'border-start-start-radius: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('border-start-start-radius'),
		'inherit',
		'border-start-start-radius: accepts inherit'
	);
	s.borderStartStartRadius = '';
...
// --- border-start-end-radius ---
{
	...
	assertEq(
		...
		'10px',
		'border-start-end-radius: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('border-start-end-radius'),
		'10px',
		'border-start-end-radius: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-start-end-radius'),
		'inherit',
		'border-start-end-radius: accepts inherit'
	);
	s.borderStartEndRadius = '';
...
// --- border-end-start-radius ---
{
	...
	assertEq(
		...
		'10px',
		'border-end-start-radius: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('border-end-start-radius'),
		'10px',
		'border-end-start-radius: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-end-start-radius'),
		'inherit',
		'border-end-start-radius: accepts inherit'
	);
	s.borderEndStartRadius = '';
...
// --- border-end-end-radius ---
{
	...
	assertEq(
		s.getPropertyValue('border-end-end-radius'),
		'10px',
		'border-end-end-radius: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('border-end-end-radius'),
		'inherit',
		'border-end-end-radius: accepts inherit'
	);
...
// --- corner-start-start-shape ---
{
	...
	assertEq(
		...
		'initial',
		'corner-start-start-shape: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('corner-start-start-shape'),
		'initial',
		'corner-start-start-shape: getPropertyValue matches accessor'
	);
	s.cornerStartStartShape = 'inherit';
	assertEq(
		s.cornerStartStartShape,
		'inherit',
		'corner-start-start-shape: overwrite with second value'
	);
	...
	assertEq(
		s.getPropertyValue('corner-start-start-shape'),
		'inherit',
		'corner-start-start-shape: accepts inherit'
	);
	s.cornerStartStartShape = '';
...
// --- corner-start-end-shape ---
{
	...
	assertEq(
		...
		'initial',
		'corner-start-end-shape: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('corner-start-end-shape'),
		'initial',
		'corner-start-end-shape: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('corner-start-end-shape'),
		'inherit',
		'corner-start-end-shape: accepts inherit'
	);
	s.cornerStartEndShape = '';
...
// --- corner-end-start-shape ---
{
	...
	assertEq(
		...
		'initial',
		'corner-end-start-shape: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('corner-end-start-shape'),
		'initial',
		'corner-end-start-shape: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('corner-end-start-shape'),
		'inherit',
		'corner-end-start-shape: accepts inherit'
	);
	s.cornerEndStartShape = '';
...
// --- corner-end-end-shape ---
{
	...
	assertEq(
		s.getPropertyValue('corner-end-end-shape'),
		'initial',
		'corner-end-end-shape: getPropertyValue matches accessor'
	);
	...
	assertEq(
		s.getPropertyValue('corner-end-end-shape'),
		'inherit',
		'corner-end-end-shape: accepts inherit'
	);
	s.cornerEndEndShape = '';
...
// --- -webkit-text-decorations-in-effect ---
{
	...
	assertEq(
		...
		'initial',
		'-webkit-text-decorations-in-effect: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('-webkit-text-decorations-in-effect'),
		'initial',
		'-webkit-text-decorations-in-effect: getPropertyValue matches accessor'
	);
	s.webkitTextDecorationsInEffect = 'inherit';
	assertEq(
		s.webkitTextDecorationsInEffect,
		'inherit',
		'-webkit-text-decorations-in-effect: overwrite with second value'
	);
	s.removeProperty('-webkit-text-decorations-in-effect');
	assertEq(
		s.webkitTextDecorationsInEffect,
		'',
		'-webkit-text-decorations-in-effect: removeProperty clears value'
	);
	s.setProperty('-webkit-text-decorations-in-effect', 'inherit');
	assertEq(
		s.getPropertyValue('-webkit-text-decorations-in-effect'),
		'inherit',
		'-webkit-text-decorations-in-effect: accepts inherit'
	);
	s.webkitTextDecorationsInEffect = '';
	assertEq(
		s.webkitTextDecorationsInEffect,
		'',
		'-webkit-text-decorations-in-effect: empty string removes'
	);
}
...
// --- position-area ---
{
	...
	assertEq(
		s.getPropertyValue('position-area'),
		'none',
		'position-area: getPropertyValue matches accessor'
	);
	s.positionArea = 'top';
...
// --- contain-intrinsic-inline-size ---
{
	...
	assertEq(
		...
		'10px',
		'contain-intrinsic-inline-size: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('contain-intrinsic-inline-size'),
		'10px',
		'contain-intrinsic-inline-size: getPropertyValue matches accessor'
	);
	s.containIntrinsicInlineSize = 'inherit';
	assertEq(
		s.containIntrinsicInlineSize,
		'inherit',
		'contain-intrinsic-inline-size: overwrite with second value'
	);
	s.removeProperty('contain-intrinsic-inline-size');
	assertEq(
		s.containIntrinsicInlineSize,
		'',
		'contain-intrinsic-inline-size: removeProperty clears value'
	);
	s.setProperty('contain-intrinsic-inline-size', 'inherit');
	assertEq(
		s.getPropertyValue('contain-intrinsic-inline-size'),
		'inherit',
		'contain-intrinsic-inline-size: accepts inherit'
	);
	s.containIntrinsicInlineSize = '';
...
// --- contain-intrinsic-block-size ---
{
	...
	assertEq(
		...
		'10px',
		'contain-intrinsic-block-size: set/get round-trip via accessor'
	);
	assertEq(
		s.getPropertyValue('contain-intrinsic-block-size'),
		'10px',
		'contain-intrinsic-block-size: getPropertyValue matches accessor'
	);
	s.containIntrinsicBlockSize = 'inherit';
	assertEq(
		s.containIntrinsicBlockSize,
		'inherit',
		'contain-intrinsic-block-size: overwrite with second value'
	);
	s.removeProperty('contain-intrinsic-block-size');
	assertEq(
		s.containIntrinsicBlockSize,
		'',
		'contain-intrinsic-block-size: removeProperty clears value'
	);
	s.setProperty('contain-intrinsic-block-size', 'inherit');
	assertEq(
		s.getPropertyValue('contain-intrinsic-block-size'),
		'inherit',
		'contain-intrinsic-block-size: accepts inherit'
	);
	s.containIntrinsicBlockSize = '';
...
// --- interest-delay (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('interest-delay-start'),
		'inherit',
		'interest-delay: expands to interest-delay-start'
	);
	assertEq(
		s.getPropertyValue('interest-delay-end'),
		'inherit',
		'interest-delay: expands to interest-delay-end'
	);
	s.setProperty('interest-delay', 'inherit');
	assertEq(
		s.getPropertyValue('interest-delay-start'),
		'inherit',
		'interest-delay: inherit expands to interest-delay-start'
	);
	assertEq(
		s.getPropertyValue('interest-delay-end'),
		'inherit',
		'interest-delay: inherit expands to interest-delay-end'
	);
	s.removeProperty('interest-delay');
	assertEq(
		s.getPropertyValue('interest-delay-start'),
		'',
		'interest-delay: removeProperty clears interest-delay-start'
	);
	assertEq(
		s.getPropertyValue('interest-delay-end'),
		'',
		'interest-delay: removeProperty clears interest-delay-end'
	);
}
...
// --- text-box (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('text-box-trim'),
		'inherit',
		'text-box: inherit expands to text-box-trim'
	);
	assertEq(
		s.getPropertyValue('text-box-edge'),
		'inherit',
		'text-box: inherit expands to text-box-edge'
	);
	s.removeProperty('text-box');
	assertEq(
		s.getPropertyValue('text-box-trim'),
		'',
		'text-box: removeProperty clears text-box-trim'
	);
	assertEq(
		s.getPropertyValue('text-box-edge'),
		'',
		'text-box: removeProperty clears text-box-edge'
	);
}
...
// --- text-spacing (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('text-autospace'),
		'inherit',
		'text-spacing: expands to text-autospace'
	);
	assertEq(
		s.getPropertyValue('text-spacing-trim'),
		'inherit',
		'text-spacing: expands to text-spacing-trim'
	);
	s.setProperty('text-spacing', 'inherit');
	assertEq(
		s.getPropertyValue('text-autospace'),
		'inherit',
		'text-spacing: inherit expands to text-autospace'
	);
	assertEq(
		s.getPropertyValue('text-spacing-trim'),
		'inherit',
		'text-spacing: inherit expands to text-spacing-trim'
	);
	s.removeProperty('text-spacing');
	assertEq(
		s.getPropertyValue('text-autospace'),
		'',
		'text-spacing: removeProperty clears text-autospace'
	);
	assertEq(
		s.getPropertyValue('text-spacing-trim'),
		'',
		'text-spacing: removeProperty clears text-spacing-trim'
	);
}
...
// --- line-clamp (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('block-ellipsis'),
		'inherit',
		'line-clamp: expands to block-ellipsis'
	);
	...
	assertEq(
		s.getPropertyValue('block-ellipsis'),
		'inherit',
		'line-clamp: inherit expands to block-ellipsis'
	);
	...
	assertEq(
		s.getPropertyValue('block-ellipsis'),
		'',
		'line-clamp: removeProperty clears block-ellipsis'
	);
...
// --- -alternative-webkit-line-clamp (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('max-lines'),
		'inherit',
		'-alternative-webkit-line-clamp: expands to max-lines'
	);
	assertEq(
		s.getPropertyValue('block-ellipsis'),
		'inherit',
		'-alternative-webkit-line-clamp: expands to block-ellipsis'
	);
	assertEq(
		s.getPropertyValue('continue'),
		'inherit',
		'-alternative-webkit-line-clamp: expands to continue'
	);
	s.setProperty('-alternative-webkit-line-clamp', 'inherit');
	assertEq(
		s.getPropertyValue('max-lines'),
		'inherit',
		'-alternative-webkit-line-clamp: inherit expands to max-lines'
	);
	assertEq(
		s.getPropertyValue('block-ellipsis'),
		'inherit',
		'-alternative-webkit-line-clamp: inherit expands to block-ellipsis'
	);
	assertEq(
		s.getPropertyValue('continue'),
		'inherit',
		'-alternative-webkit-line-clamp: inherit expands to continue'
	);
	s.removeProperty('-alternative-webkit-line-clamp');
	assertEq(
		s.getPropertyValue('max-lines'),
		'',
		'-alternative-webkit-line-clamp: removeProperty clears max-lines'
	);
	assertEq(
		s.getPropertyValue('block-ellipsis'),
		'',
		'-alternative-webkit-line-clamp: removeProperty clears block-ellipsis'
	);
	assertEq(
		s.getPropertyValue('continue'),
		'',
		'-alternative-webkit-line-clamp: removeProperty clears continue'
	);
}
...
// --- white-space (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('white-space-collapse'),
		'inherit',
		'white-space: expands to white-space-collapse'
	);
	assertEq(
		s.getPropertyValue('text-wrap-mode'),
		'inherit',
		'white-space: expands to text-wrap-mode'
	);
	s.setProperty('white-space', 'inherit');
	assertEq(
		s.getPropertyValue('white-space-collapse'),
		'inherit',
		'white-space: inherit expands to white-space-collapse'
	);
	assertEq(
		s.getPropertyValue('text-wrap-mode'),
		'inherit',
		'white-space: inherit expands to text-wrap-mode'
	);
	s.removeProperty('white-space');
	assertEq(
		s.getPropertyValue('white-space-collapse'),
		'',
		'white-space: removeProperty clears white-space-collapse'
	);
	assertEq(
		s.getPropertyValue('text-wrap-mode'),
		'',
		'white-space: removeProperty clears text-wrap-mode'
	);
}
...
// --- text-wrap (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('text-wrap-style'),
		'inherit',
		'text-wrap: expands to text-wrap-style'
	);
	s.setProperty('text-wrap', 'inherit');
	assertEq(
		s.getPropertyValue('text-wrap-mode'),
		'inherit',
		'text-wrap: inherit expands to text-wrap-mode'
	);
	assertEq(
		s.getPropertyValue('text-wrap-style'),
		'inherit',
		'text-wrap: inherit expands to text-wrap-style'
	);
	s.removeProperty('text-wrap');
	assertEq(
		s.getPropertyValue('text-wrap-mode'),
		'',
		'text-wrap: removeProperty clears text-wrap-mode'
	);
	assertEq(
		s.getPropertyValue('text-wrap-style'),
		'',
		'text-wrap: removeProperty clears text-wrap-style'
	);
}
...
// --- animation (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('animation-duration'),
		'inherit',
		'animation: expands to animation-duration'
	);
	assertEq(
		s.getPropertyValue('animation-timing-function'),
		'inherit',
		'animation: expands to animation-timing-function'
	);
	assertEq(
		s.getPropertyValue('animation-delay'),
		'inherit',
		'animation: expands to animation-delay'
	);
	assertEq(
		s.getPropertyValue('animation-iteration-count'),
		'inherit',
		'animation: expands to animation-iteration-count'
	);
	assertEq(
		s.getPropertyValue('animation-direction'),
		'inherit',
		'animation: expands to animation-direction'
	);
	assertEq(
		s.getPropertyValue('animation-fill-mode'),
		'inherit',
		'animation: expands to animation-fill-mode'
	);
	assertEq(
		s.getPropertyValue('animation-play-state'),
		'inherit',
		'animation: expands to animation-play-state'
	);
	assertEq(s.getPropertyValue('animation-name'), 'inherit', 'animation: expands to animation-name');
	assertEq(
		s.getPropertyValue('animation-timeline'),
		'inherit',
		'animation: expands to animation-timeline'
	);
	assertEq(
		s.getPropertyValue('animation-range-start'),
		'inherit',
		'animation: expands to animation-range-start'
	);
	assertEq(
		s.getPropertyValue('animation-range-end'),
		'inherit',
		'animation: expands to animation-range-end'
	);
	s.setProperty('animation', 'inherit');
	assertEq(
		s.getPropertyValue('animation-duration'),
		'inherit',
		'animation: inherit expands to animation-duration'
	);
	assertEq(
		s.getPropertyValue('animation-timing-function'),
		'inherit',
		'animation: inherit expands to animation-timing-function'
	);
	assertEq(
		s.getPropertyValue('animation-delay'),
		'inherit',
		'animation: inherit expands to animation-delay'
	);
	assertEq(
		s.getPropertyValue('animation-iteration-count'),
		'inherit',
		'animation: inherit expands to animation-iteration-count'
	);
	assertEq(
		s.getPropertyValue('animation-direction'),
		'inherit',
		'animation: inherit expands to animation-direction'
	);
	assertEq(
		s.getPropertyValue('animation-fill-mode'),
		'inherit',
		'animation: inherit expands to animation-fill-mode'
	);
	assertEq(
		s.getPropertyValue('animation-play-state'),
		'inherit',
		'animation: inherit expands to animation-play-state'
	);
	assertEq(
		s.getPropertyValue('animation-name'),
		'inherit',
		'animation: inherit expands to animation-name'
	);
	assertEq(
		s.getPropertyValue('animation-timeline'),
		'inherit',
		'animation: inherit expands to animation-timeline'
	);
	assertEq(
		s.getPropertyValue('animation-range-start'),
		'inherit',
		'animation: inherit expands to animation-range-start'
	);
	assertEq(
		s.getPropertyValue('animation-range-end'),
		'inherit',
		'animation: inherit expands to animation-range-end'
	);
	s.removeProperty('animation');
	assertEq(
		s.getPropertyValue('animation-duration'),
		'',
		'animation: removeProperty clears animation-duration'
	);
	assertEq(
		s.getPropertyValue('animation-timing-function'),
		'',
		'animation: removeProperty clears animation-timing-function'
	);
	assertEq(
		s.getPropertyValue('animation-delay'),
		'',
		'animation: removeProperty clears animation-delay'
	);
	assertEq(
		s.getPropertyValue('animation-iteration-count'),
		'',
		'animation: removeProperty clears animation-iteration-count'
	);
	assertEq(
		s.getPropertyValue('animation-direction'),
		'',
		'animation: removeProperty clears animation-direction'
	);
	assertEq(
		s.getPropertyValue('animation-fill-mode'),
		'',
		'animation: removeProperty clears animation-fill-mode'
	);
	assertEq(
		s.getPropertyValue('animation-play-state'),
		'',
		'animation: removeProperty clears animation-play-state'
	);
	assertEq(
		s.getPropertyValue('animation-name'),
		'',
		'animation: removeProperty clears animation-name'
	);
	assertEq(
		s.getPropertyValue('animation-timeline'),
		'',
		'animation: removeProperty clears animation-timeline'
	);
	assertEq(
		s.getPropertyValue('animation-range-start'),
		'',
		'animation: removeProperty clears animation-range-start'
	);
	assertEq(
		s.getPropertyValue('animation-range-end'),
		'',
		'animation: removeProperty clears animation-range-end'
	);
}
...
// --- animation-range (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('animation-range-start'),
		'inherit',
		'animation-range: expands to animation-range-start'
	);
	assertEq(
		s.getPropertyValue('animation-range-end'),
		'inherit',
		'animation-range: expands to animation-range-end'
	);
	s.setProperty('animation-range', 'inherit');
	assertEq(
		s.getPropertyValue('animation-range-start'),
		'inherit',
		'animation-range: inherit expands to animation-range-start'
	);
	assertEq(
		s.getPropertyValue('animation-range-end'),
		'inherit',
		'animation-range: inherit expands to animation-range-end'
	);
	s.removeProperty('animation-range');
	assertEq(
		s.getPropertyValue('animation-range-start'),
		'',
		'animation-range: removeProperty clears animation-range-start'
	);
	assertEq(
		s.getPropertyValue('animation-range-end'),
		'',
		'animation-range: removeProperty clears animation-range-end'
	);
}
...
// --- background (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('background-image'),
		'inherit',
		'background: expands to background-image'
	);
	assertEq(
		s.getPropertyValue('background-position-x'),
		'inherit',
		'background: expands to background-position-x'
	);
	assertEq(
		s.getPropertyValue('background-position-y'),
		'inherit',
		'background: expands to background-position-y'
	);
	assertEq(
		s.getPropertyValue('background-size'),
		'inherit',
		'background: expands to background-size'
	);
	assertEq(
		s.getPropertyValue('background-repeat'),
		'inherit',
		'background: expands to background-repeat'
	);
	assertEq(
		s.getPropertyValue('background-attachment'),
		'inherit',
		'background: expands to background-attachment'
	);
	assertEq(
		s.getPropertyValue('background-origin'),
		'inherit',
		'background: expands to background-origin'
	);
	assertEq(
		s.getPropertyValue('background-clip'),
		'inherit',
		'background: expands to background-clip'
	);
	assertEq(
		s.getPropertyValue('background-color'),
		'inherit',
		'background: expands to background-color'
	);
	s.setProperty('background', 'inherit');
	assertEq(
		s.getPropertyValue('background-image'),
		'inherit',
		'background: inherit expands to background-image'
	);
	assertEq(
		s.getPropertyValue('background-position-x'),
		'inherit',
		'background: inherit expands to background-position-x'
	);
	assertEq(
		s.getPropertyValue('background-position-y'),
		'inherit',
		'background: inherit expands to background-position-y'
	);
	assertEq(
		s.getPropertyValue('background-size'),
		'inherit',
		'background: inherit expands to background-size'
	);
	assertEq(
		s.getPropertyValue('background-repeat'),
		'inherit',
		'background: inherit expands to background-repeat'
	);
	assertEq(
		s.getPropertyValue('background-attachment'),
		'inherit',
		'background: inherit expands to background-attachment'
	);
	assertEq(
		s.getPropertyValue('background-origin'),
		'inherit',
		'background: inherit expands to background-origin'
	);
	assertEq(
		s.getPropertyValue('background-clip'),
		'inherit',
		'background: inherit expands to background-clip'
	);
	assertEq(
		s.getPropertyValue('background-color'),
		'inherit',
		'background: inherit expands to background-color'
	);
	s.removeProperty('background');
	assertEq(
		s.getPropertyValue('background-image'),
		'',
		'background: removeProperty clears background-image'
	);
	assertEq(
		s.getPropertyValue('background-position-x'),
		'',
		'background: removeProperty clears background-position-x'
	);
	assertEq(
		s.getPropertyValue('background-position-y'),
		'',
		'background: removeProperty clears background-position-y'
	);
	assertEq(
		s.getPropertyValue('background-size'),
		'',
		'background: removeProperty clears background-size'
	);
	assertEq(
		s.getPropertyValue('background-repeat'),
		'',
		'background: removeProperty clears background-repeat'
	);
	assertEq(
		s.getPropertyValue('background-attachment'),
		'',
		'background: removeProperty clears background-attachment'
	);
	assertEq(
		s.getPropertyValue('background-origin'),
		'',
		'background: removeProperty clears background-origin'
	);
	assertEq(
		s.getPropertyValue('background-clip'),
		'',
		'background: removeProperty clears background-clip'
	);
	assertEq(
		s.getPropertyValue('background-color'),
		'',
		'background: removeProperty clears background-color'
	);
}
...
// --- background-position (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('background-position-x'),
		'50%',
		'background-position: expands to background-position-x'
	);
	assertEq(
		s.getPropertyValue('background-position-y'),
		'50%',
		'background-position: expands to background-position-y'
	);
	s.setProperty('background-position', 'inherit');
	assertEq(
		s.getPropertyValue('background-position-x'),
		'inherit',
		'background-position: inherit expands to background-position-x'
	);
	assertEq(
		s.getPropertyValue('background-position-y'),
		'inherit',
		'background-position: inherit expands to background-position-y'
	);
	s.removeProperty('background-position');
	assertEq(
		s.getPropertyValue('background-position-x'),
		'',
		'background-position: removeProperty clears background-position-x'
	);
	assertEq(
		s.getPropertyValue('background-position-y'),
		'',
		'background-position: removeProperty clears background-position-y'
	);
}
...
// --- border (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-right-width'),
		'2px',
		'border: expands to border-right-width'
	);
	assertEq(
		s.getPropertyValue('border-bottom-width'),
		'2px',
		'border: expands to border-bottom-width'
	);
	...
	assertEq(
		s.getPropertyValue('border-right-style'),
		'dashed',
		'border: expands to border-right-style'
	);
	assertEq(
		s.getPropertyValue('border-bottom-style'),
		'dashed',
		'border: expands to border-bottom-style'
	);
	assertEq(
		s.getPropertyValue('border-left-style'),
		'dashed',
		'border: expands to border-left-style'
	);
	assertEq(s.getPropertyValue('border-top-color'), 'blue', 'border: expands to border-top-color');
	assertEq(
		s.getPropertyValue('border-right-color'),
		'blue',
		'border: expands to border-right-color'
	);
	assertEq(
		s.getPropertyValue('border-bottom-color'),
		'blue',
		'border: expands to border-bottom-color'
	);
	...
	assertEq(
		s.getPropertyValue('border-top-color'),
		'inherit',
		'border: inherit expands to border-top-color'
	);
	assertEq(
		s.getPropertyValue('border-top-style'),
		'inherit',
		'border: inherit expands to border-top-style'
	);
	assertEq(
		s.getPropertyValue('border-top-width'),
		'inherit',
		'border: inherit expands to border-top-width'
	);
	assertEq(
		s.getPropertyValue('border-right-color'),
		'inherit',
		'border: inherit expands to border-right-color'
	);
	assertEq(
		s.getPropertyValue('border-right-style'),
		'inherit',
		'border: inherit expands to border-right-style'
	);
	assertEq(
		s.getPropertyValue('border-right-width'),
		'inherit',
		'border: inherit expands to border-right-width'
	);
	assertEq(
		s.getPropertyValue('border-bottom-color'),
		'inherit',
		'border: inherit expands to border-bottom-color'
	);
	assertEq(
		s.getPropertyValue('border-bottom-style'),
		'inherit',
		'border: inherit expands to border-bottom-style'
	);
	assertEq(
		s.getPropertyValue('border-bottom-width'),
		'inherit',
		'border: inherit expands to border-bottom-width'
	);
	assertEq(
		s.getPropertyValue('border-left-color'),
		'inherit',
		'border: inherit expands to border-left-color'
	);
	assertEq(
		s.getPropertyValue('border-left-style'),
		'inherit',
		'border: inherit expands to border-left-style'
	);
	assertEq(
		s.getPropertyValue('border-left-width'),
		'inherit',
		'border: inherit expands to border-left-width'
	);
	assertEq(
		s.getPropertyValue('border-image-source'),
		'inherit',
		'border: inherit expands to border-image-source'
	);
	assertEq(
		s.getPropertyValue('border-image-slice'),
		'inherit',
		'border: inherit expands to border-image-slice'
	);
	assertEq(
		s.getPropertyValue('border-image-width'),
		'inherit',
		'border: inherit expands to border-image-width'
	);
	assertEq(
		s.getPropertyValue('border-image-outset'),
		'inherit',
		'border: inherit expands to border-image-outset'
	);
	assertEq(
		s.getPropertyValue('border-image-repeat'),
		'inherit',
		'border: inherit expands to border-image-repeat'
	);
	s.removeProperty('border');
	assertEq(
		s.getPropertyValue('border-top-color'),
		'',
		'border: removeProperty clears border-top-color'
	);
	assertEq(
		s.getPropertyValue('border-top-style'),
		'',
		'border: removeProperty clears border-top-style'
	);
	assertEq(
		s.getPropertyValue('border-top-width'),
		'',
		'border: removeProperty clears border-top-width'
	);
	assertEq(
		s.getPropertyValue('border-right-color'),
		'',
		'border: removeProperty clears border-right-color'
	);
	assertEq(
		s.getPropertyValue('border-right-style'),
		'',
		'border: removeProperty clears border-right-style'
	);
	assertEq(
		s.getPropertyValue('border-right-width'),
		'',
		'border: removeProperty clears border-right-width'
	);
	assertEq(
		s.getPropertyValue('border-bottom-color'),
		'',
		'border: removeProperty clears border-bottom-color'
	);
	assertEq(
		s.getPropertyValue('border-bottom-style'),
		'',
		'border: removeProperty clears border-bottom-style'
	);
	assertEq(
		s.getPropertyValue('border-bottom-width'),
		'',
		'border: removeProperty clears border-bottom-width'
	);
	assertEq(
		s.getPropertyValue('border-left-color'),
		'',
		'border: removeProperty clears border-left-color'
	);
	assertEq(
		s.getPropertyValue('border-left-style'),
		'',
		'border: removeProperty clears border-left-style'
	);
	assertEq(
		s.getPropertyValue('border-left-width'),
		'',
		'border: removeProperty clears border-left-width'
	);
	assertEq(
		s.getPropertyValue('border-image-source'),
		'',
		'border: removeProperty clears border-image-source'
	);
	assertEq(
		s.getPropertyValue('border-image-slice'),
		'',
		'border: removeProperty clears border-image-slice'
	);
	assertEq(
		s.getPropertyValue('border-image-width'),
		'',
		'border: removeProperty clears border-image-width'
	);
	assertEq(
		s.getPropertyValue('border-image-outset'),
		'',
		'border: removeProperty clears border-image-outset'
	);
	assertEq(
		s.getPropertyValue('border-image-repeat'),
		'',
		'border: removeProperty clears border-image-repeat'
	);
}
...
// --- border-block (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-block-start-color'),
		'inherit',
		'border-block: expands to border-block-start-color'
	);
	assertEq(
		s.getPropertyValue('border-block-start-style'),
		'inherit',
		'border-block: expands to border-block-start-style'
	);
	assertEq(
		s.getPropertyValue('border-block-start-width'),
		'inherit',
		'border-block: expands to border-block-start-width'
	);
	assertEq(
		s.getPropertyValue('border-block-end-color'),
		'inherit',
		'border-block: expands to border-block-end-color'
	);
	assertEq(
		s.getPropertyValue('border-block-end-style'),
		'inherit',
		'border-block: expands to border-block-end-style'
	);
	assertEq(
		s.getPropertyValue('border-block-end-width'),
		'inherit',
		'border-block: expands to border-block-end-width'
	);
	s.setProperty('border-block', 'inherit');
	assertEq(
		s.getPropertyValue('border-block-start-color'),
		'inherit',
		'border-block: inherit expands to border-block-start-color'
	);
	assertEq(
		s.getPropertyValue('border-block-start-style'),
		'inherit',
		'border-block: inherit expands to border-block-start-style'
	);
	assertEq(
		s.getPropertyValue('border-block-start-width'),
		'inherit',
		'border-block: inherit expands to border-block-start-width'
	);
	assertEq(
		s.getPropertyValue('border-block-end-color'),
		'inherit',
		'border-block: inherit expands to border-block-end-color'
	);
	assertEq(
		s.getPropertyValue('border-block-end-style'),
		'inherit',
		'border-block: inherit expands to border-block-end-style'
	);
	assertEq(
		s.getPropertyValue('border-block-end-width'),
		'inherit',
		'border-block: inherit expands to border-block-end-width'
	);
	s.removeProperty('border-block');
	assertEq(
		s.getPropertyValue('border-block-start-color'),
		'',
		'border-block: removeProperty clears border-block-start-color'
	);
	assertEq(
		s.getPropertyValue('border-block-start-style'),
		'',
		'border-block: removeProperty clears border-block-start-style'
	);
	assertEq(
		s.getPropertyValue('border-block-start-width'),
		'',
		'border-block: removeProperty clears border-block-start-width'
	);
	assertEq(
		s.getPropertyValue('border-block-end-color'),
		'',
		'border-block: removeProperty clears border-block-end-color'
	);
	assertEq(
		s.getPropertyValue('border-block-end-style'),
		'',
		'border-block: removeProperty clears border-block-end-style'
	);
	assertEq(
		s.getPropertyValue('border-block-end-width'),
		'',
		'border-block: removeProperty clears border-block-end-width'
	);
}
...
// --- border-block-color (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-block-start-color'),
		'inherit',
		'border-block-color: expands to border-block-start-color'
	);
	assertEq(
		s.getPropertyValue('border-block-end-color'),
		'inherit',
		'border-block-color: expands to border-block-end-color'
	);
	s.setProperty('border-block-color', 'inherit');
	assertEq(
		s.getPropertyValue('border-block-start-color'),
		'inherit',
		'border-block-color: inherit expands to border-block-start-color'
	);
	assertEq(
		s.getPropertyValue('border-block-end-color'),
		'inherit',
		'border-block-color: inherit expands to border-block-end-color'
	);
	s.removeProperty('border-block-color');
	assertEq(
		s.getPropertyValue('border-block-start-color'),
		'',
		'border-block-color: removeProperty clears border-block-start-color'
	);
	assertEq(
		s.getPropertyValue('border-block-end-color'),
		'',
		'border-block-color: removeProperty clears border-block-end-color'
	);
}
...
// --- border-block-end (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-block-end-width'),
		'1px',
		'border-block-end: expands to border-block-end-width'
	);
	assertEq(
		s.getPropertyValue('border-block-end-style'),
		'solid',
		'border-block-end: expands to border-block-end-style'
	);
	assertEq(
		s.getPropertyValue('border-block-end-color'),
		'red',
		'border-block-end: expands to border-block-end-color'
	);
	s.setProperty('border-block-end', 'inherit');
	assertEq(
		s.getPropertyValue('border-block-end-width'),
		'inherit',
		'border-block-end: inherit expands to border-block-end-width'
	);
	assertEq(
		s.getPropertyValue('border-block-end-style'),
		'inherit',
		'border-block-end: inherit expands to border-block-end-style'
	);
	assertEq(
		s.getPropertyValue('border-block-end-color'),
		'inherit',
		'border-block-end: inherit expands to border-block-end-color'
	);
	s.removeProperty('border-block-end');
	assertEq(
		s.getPropertyValue('border-block-end-width'),
		'',
		'border-block-end: removeProperty clears border-block-end-width'
	);
	assertEq(
		s.getPropertyValue('border-block-end-style'),
		'',
		'border-block-end: removeProperty clears border-block-end-style'
	);
	assertEq(
		s.getPropertyValue('border-block-end-color'),
		'',
		'border-block-end: removeProperty clears border-block-end-color'
	);
}
...
// --- border-block-start (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-block-start-width'),
		'1px',
		'border-block-start: expands to border-block-start-width'
	);
	assertEq(
		s.getPropertyValue('border-block-start-style'),
		'solid',
		'border-block-start: expands to border-block-start-style'
	);
	assertEq(
		s.getPropertyValue('border-block-start-color'),
		'red',
		'border-block-start: expands to border-block-start-color'
	);
	s.setProperty('border-block-start', 'inherit');
	assertEq(
		s.getPropertyValue('border-block-start-width'),
		'inherit',
		'border-block-start: inherit expands to border-block-start-width'
	);
	assertEq(
		s.getPropertyValue('border-block-start-style'),
		'inherit',
		'border-block-start: inherit expands to border-block-start-style'
	);
	assertEq(
		s.getPropertyValue('border-block-start-color'),
		'inherit',
		'border-block-start: inherit expands to border-block-start-color'
	);
	s.removeProperty('border-block-start');
	assertEq(
		s.getPropertyValue('border-block-start-width'),
		'',
		'border-block-start: removeProperty clears border-block-start-width'
	);
	assertEq(
		s.getPropertyValue('border-block-start-style'),
		'',
		'border-block-start: removeProperty clears border-block-start-style'
	);
	assertEq(
		s.getPropertyValue('border-block-start-color'),
		'',
		'border-block-start: removeProperty clears border-block-start-color'
	);
}
...
// --- border-block-style (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-block-start-style'),
		'inherit',
		'border-block-style: expands to border-block-start-style'
	);
	assertEq(
		s.getPropertyValue('border-block-end-style'),
		'inherit',
		'border-block-style: expands to border-block-end-style'
	);
	s.setProperty('border-block-style', 'inherit');
	assertEq(
		s.getPropertyValue('border-block-start-style'),
		'inherit',
		'border-block-style: inherit expands to border-block-start-style'
	);
	assertEq(
		s.getPropertyValue('border-block-end-style'),
		'inherit',
		'border-block-style: inherit expands to border-block-end-style'
	);
	s.removeProperty('border-block-style');
	assertEq(
		s.getPropertyValue('border-block-start-style'),
		'',
		'border-block-style: removeProperty clears border-block-start-style'
	);
	assertEq(
		s.getPropertyValue('border-block-end-style'),
		'',
		'border-block-style: removeProperty clears border-block-end-style'
	);
}
...
// --- border-block-width (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-block-start-width'),
		'inherit',
		'border-block-width: expands to border-block-start-width'
	);
	assertEq(
		s.getPropertyValue('border-block-end-width'),
		'inherit',
		'border-block-width: expands to border-block-end-width'
	);
	s.setProperty('border-block-width', 'inherit');
	assertEq(
		s.getPropertyValue('border-block-start-width'),
		'inherit',
		'border-block-width: inherit expands to border-block-start-width'
	);
	assertEq(
		s.getPropertyValue('border-block-end-width'),
		'inherit',
		'border-block-width: inherit expands to border-block-end-width'
	);
	s.removeProperty('border-block-width');
	assertEq(
		s.getPropertyValue('border-block-start-width'),
		'',
		'border-block-width: removeProperty clears border-block-start-width'
	);
	assertEq(
		s.getPropertyValue('border-block-end-width'),
		'',
		'border-block-width: removeProperty clears border-block-end-width'
	);
}
...
// --- border-bottom (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-bottom-width'),
		'1px',
		'border-bottom: expands to border-bottom-width'
	);
	assertEq(
		s.getPropertyValue('border-bottom-style'),
		'solid',
		'border-bottom: expands to border-bottom-style'
	);
	assertEq(
		s.getPropertyValue('border-bottom-color'),
		'red',
		'border-bottom: expands to border-bottom-color'
	);
	s.setProperty('border-bottom', 'inherit');
	assertEq(
		s.getPropertyValue('border-bottom-width'),
		'inherit',
		'border-bottom: inherit expands to border-bottom-width'
	);
	assertEq(
		s.getPropertyValue('border-bottom-style'),
		'inherit',
		'border-bottom: inherit expands to border-bottom-style'
	);
	assertEq(
		s.getPropertyValue('border-bottom-color'),
		'inherit',
		'border-bottom: inherit expands to border-bottom-color'
	);
	s.removeProperty('border-bottom');
	assertEq(
		s.getPropertyValue('border-bottom-width'),
		'',
		'border-bottom: removeProperty clears border-bottom-width'
	);
	assertEq(
		s.getPropertyValue('border-bottom-style'),
		'',
		'border-bottom: removeProperty clears border-bottom-style'
	);
	assertEq(
		s.getPropertyValue('border-bottom-color'),
		'',
		'border-bottom: removeProperty clears border-bottom-color'
	);
}
...
// --- border-color (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-top-color'),
		'red',
		'border-color: expands to border-top-color'
	);
	assertEq(
		s.getPropertyValue('border-right-color'),
		'red',
		'border-color: expands to border-right-color'
	);
	assertEq(
		s.getPropertyValue('border-bottom-color'),
		'red',
		'border-color: expands to border-bottom-color'
	);
	assertEq(
		s.getPropertyValue('border-left-color'),
		'red',
		'border-color: expands to border-left-color'
	);
	s.setProperty('border-color', 'inherit');
	assertEq(
		s.getPropertyValue('border-top-color'),
		'inherit',
		'border-color: inherit expands to border-top-color'
	);
	assertEq(
		s.getPropertyValue('border-right-color'),
		'inherit',
		'border-color: inherit expands to border-right-color'
	);
	assertEq(
		s.getPropertyValue('border-bottom-color'),
		'inherit',
		'border-color: inherit expands to border-bottom-color'
	);
	assertEq(
		s.getPropertyValue('border-left-color'),
		'inherit',
		'border-color: inherit expands to border-left-color'
	);
	s.removeProperty('border-color');
	assertEq(
		s.getPropertyValue('border-top-color'),
		'',
		'border-color: removeProperty clears border-top-color'
	);
	assertEq(
		s.getPropertyValue('border-right-color'),
		'',
		'border-color: removeProperty clears border-right-color'
	);
	assertEq(
		s.getPropertyValue('border-bottom-color'),
		'',
		'border-color: removeProperty clears border-bottom-color'
	);
	assertEq(
		s.getPropertyValue('border-left-color'),
		'',
		'border-color: removeProperty clears border-left-color'
	);
}
...
// --- border-image (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-image-source'),
		'inherit',
		'border-image: expands to border-image-source'
	);
	assertEq(
		s.getPropertyValue('border-image-slice'),
		'inherit',
		'border-image: expands to border-image-slice'
	);
	assertEq(
		s.getPropertyValue('border-image-width'),
		'inherit',
		'border-image: expands to border-image-width'
	);
	assertEq(
		s.getPropertyValue('border-image-outset'),
		'inherit',
		'border-image: expands to border-image-outset'
	);
	assertEq(
		s.getPropertyValue('border-image-repeat'),
		'inherit',
		'border-image: expands to border-image-repeat'
	);
	s.setProperty('border-image', 'inherit');
	assertEq(
		s.getPropertyValue('border-image-source'),
		'inherit',
		'border-image: inherit expands to border-image-source'
	);
	assertEq(
		s.getPropertyValue('border-image-slice'),
		'inherit',
		'border-image: inherit expands to border-image-slice'
	);
	assertEq(
		s.getPropertyValue('border-image-width'),
		'inherit',
		'border-image: inherit expands to border-image-width'
	);
	assertEq(
		s.getPropertyValue('border-image-outset'),
		'inherit',
		'border-image: inherit expands to border-image-outset'
	);
	assertEq(
		s.getPropertyValue('border-image-repeat'),
		'inherit',
		'border-image: inherit expands to border-image-repeat'
	);
	s.removeProperty('border-image');
	assertEq(
		s.getPropertyValue('border-image-source'),
		'',
		'border-image: removeProperty clears border-image-source'
	);
	assertEq(
		s.getPropertyValue('border-image-slice'),
		'',
		'border-image: removeProperty clears border-image-slice'
	);
	assertEq(
		s.getPropertyValue('border-image-width'),
		'',
		'border-image: removeProperty clears border-image-width'
	);
	assertEq(
		s.getPropertyValue('border-image-outset'),
		'',
		'border-image: removeProperty clears border-image-outset'
	);
	assertEq(
		s.getPropertyValue('border-image-repeat'),
		'',
		'border-image: removeProperty clears border-image-repeat'
	);
}
...
// --- border-inline (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-inline-start-color'),
		'inherit',
		'border-inline: expands to border-inline-start-color'
	);
	assertEq(
		s.getPropertyValue('border-inline-start-style'),
		'inherit',
		'border-inline: expands to border-inline-start-style'
	);
	assertEq(
		s.getPropertyValue('border-inline-start-width'),
		'inherit',
		'border-inline: expands to border-inline-start-width'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-color'),
		'inherit',
		'border-inline: expands to border-inline-end-color'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-style'),
		'inherit',
		'border-inline: expands to border-inline-end-style'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-width'),
		'inherit',
		'border-inline: expands to border-inline-end-width'
	);
	s.setProperty('border-inline', 'inherit');
	assertEq(
		s.getPropertyValue('border-inline-start-color'),
		'inherit',
		'border-inline: inherit expands to border-inline-start-color'
	);
	assertEq(
		s.getPropertyValue('border-inline-start-style'),
		'inherit',
		'border-inline: inherit expands to border-inline-start-style'
	);
	assertEq(
		s.getPropertyValue('border-inline-start-width'),
		'inherit',
		'border-inline: inherit expands to border-inline-start-width'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-color'),
		'inherit',
		'border-inline: inherit expands to border-inline-end-color'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-style'),
		'inherit',
		'border-inline: inherit expands to border-inline-end-style'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-width'),
		'inherit',
		'border-inline: inherit expands to border-inline-end-width'
	);
	s.removeProperty('border-inline');
	assertEq(
		s.getPropertyValue('border-inline-start-color'),
		'',
		'border-inline: removeProperty clears border-inline-start-color'
	);
	assertEq(
		s.getPropertyValue('border-inline-start-style'),
		'',
		'border-inline: removeProperty clears border-inline-start-style'
	);
	assertEq(
		s.getPropertyValue('border-inline-start-width'),
		'',
		'border-inline: removeProperty clears border-inline-start-width'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-color'),
		'',
		'border-inline: removeProperty clears border-inline-end-color'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-style'),
		'',
		'border-inline: removeProperty clears border-inline-end-style'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-width'),
		'',
		'border-inline: removeProperty clears border-inline-end-width'
	);
}
...
// --- border-inline-color (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-inline-start-color'),
		'inherit',
		'border-inline-color: expands to border-inline-start-color'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-color'),
		'inherit',
		'border-inline-color: expands to border-inline-end-color'
	);
	s.setProperty('border-inline-color', 'inherit');
	assertEq(
		s.getPropertyValue('border-inline-start-color'),
		'inherit',
		'border-inline-color: inherit expands to border-inline-start-color'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-color'),
		'inherit',
		'border-inline-color: inherit expands to border-inline-end-color'
	);
	s.removeProperty('border-inline-color');
	assertEq(
		s.getPropertyValue('border-inline-start-color'),
		'',
		'border-inline-color: removeProperty clears border-inline-start-color'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-color'),
		'',
		'border-inline-color: removeProperty clears border-inline-end-color'
	);
}
...
// --- border-inline-end (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-inline-end-width'),
		'1px',
		'border-inline-end: expands to border-inline-end-width'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-style'),
		'solid',
		'border-inline-end: expands to border-inline-end-style'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-color'),
		'red',
		'border-inline-end: expands to border-inline-end-color'
	);
	s.setProperty('border-inline-end', 'inherit');
	assertEq(
		s.getPropertyValue('border-inline-end-width'),
		'inherit',
		'border-inline-end: inherit expands to border-inline-end-width'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-style'),
		'inherit',
		'border-inline-end: inherit expands to border-inline-end-style'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-color'),
		'inherit',
		'border-inline-end: inherit expands to border-inline-end-color'
	);
	s.removeProperty('border-inline-end');
	assertEq(
		s.getPropertyValue('border-inline-end-width'),
		'',
		'border-inline-end: removeProperty clears border-inline-end-width'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-style'),
		'',
		'border-inline-end: removeProperty clears border-inline-end-style'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-color'),
		'',
		'border-inline-end: removeProperty clears border-inline-end-color'
	);
}
...
// --- border-inline-start (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-inline-start-width'),
		'1px',
		'border-inline-start: expands to border-inline-start-width'
	);
	assertEq(
		s.getPropertyValue('border-inline-start-style'),
		'solid',
		'border-inline-start: expands to border-inline-start-style'
	);
	assertEq(
		s.getPropertyValue('border-inline-start-color'),
		'red',
		'border-inline-start: expands to border-inline-start-color'
	);
	s.setProperty('border-inline-start', 'inherit');
	assertEq(
		s.getPropertyValue('border-inline-start-width'),
		'inherit',
		'border-inline-start: inherit expands to border-inline-start-width'
	);
	assertEq(
		s.getPropertyValue('border-inline-start-style'),
		'inherit',
		'border-inline-start: inherit expands to border-inline-start-style'
	);
	assertEq(
		s.getPropertyValue('border-inline-start-color'),
		'inherit',
		'border-inline-start: inherit expands to border-inline-start-color'
	);
	s.removeProperty('border-inline-start');
	assertEq(
		s.getPropertyValue('border-inline-start-width'),
		'',
		'border-inline-start: removeProperty clears border-inline-start-width'
	);
	assertEq(
		s.getPropertyValue('border-inline-start-style'),
		'',
		'border-inline-start: removeProperty clears border-inline-start-style'
	);
	assertEq(
		s.getPropertyValue('border-inline-start-color'),
		'',
		'border-inline-start: removeProperty clears border-inline-start-color'
	);
}
...
// --- border-inline-style (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-inline-start-style'),
		'inherit',
		'border-inline-style: expands to border-inline-start-style'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-style'),
		'inherit',
		'border-inline-style: expands to border-inline-end-style'
	);
	s.setProperty('border-inline-style', 'inherit');
	assertEq(
		s.getPropertyValue('border-inline-start-style'),
		'inherit',
		'border-inline-style: inherit expands to border-inline-start-style'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-style'),
		'inherit',
		'border-inline-style: inherit expands to border-inline-end-style'
	);
	s.removeProperty('border-inline-style');
	assertEq(
		s.getPropertyValue('border-inline-start-style'),
		'',
		'border-inline-style: removeProperty clears border-inline-start-style'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-style'),
		'',
		'border-inline-style: removeProperty clears border-inline-end-style'
	);
}
...
// --- border-inline-width (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-inline-start-width'),
		'inherit',
		'border-inline-width: expands to border-inline-start-width'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-width'),
		'inherit',
		'border-inline-width: expands to border-inline-end-width'
	);
	s.setProperty('border-inline-width', 'inherit');
	assertEq(
		s.getPropertyValue('border-inline-start-width'),
		'inherit',
		'border-inline-width: inherit expands to border-inline-start-width'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-width'),
		'inherit',
		'border-inline-width: inherit expands to border-inline-end-width'
	);
	s.removeProperty('border-inline-width');
	assertEq(
		s.getPropertyValue('border-inline-start-width'),
		'',
		'border-inline-width: removeProperty clears border-inline-start-width'
	);
	assertEq(
		s.getPropertyValue('border-inline-end-width'),
		'',
		'border-inline-width: removeProperty clears border-inline-end-width'
	);
}
...
// --- border-left (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-left-width'),
		'1px',
		'border-left: expands to border-left-width'
	);
	assertEq(
		s.getPropertyValue('border-left-style'),
		'solid',
		'border-left: expands to border-left-style'
	);
	assertEq(
		s.getPropertyValue('border-left-color'),
		'red',
		'border-left: expands to border-left-color'
	);
	s.setProperty('border-left', 'inherit');
	assertEq(
		s.getPropertyValue('border-left-width'),
		'inherit',
		'border-left: inherit expands to border-left-width'
	);
	assertEq(
		s.getPropertyValue('border-left-style'),
		'inherit',
		'border-left: inherit expands to border-left-style'
	);
	assertEq(
		s.getPropertyValue('border-left-color'),
		'inherit',
		'border-left: inherit expands to border-left-color'
	);
	s.removeProperty('border-left');
	assertEq(
		s.getPropertyValue('border-left-width'),
		'',
		'border-left: removeProperty clears border-left-width'
	);
	assertEq(
		s.getPropertyValue('border-left-style'),
		'',
		'border-left: removeProperty clears border-left-style'
	);
	assertEq(
		s.getPropertyValue('border-left-color'),
		'',
		'border-left: removeProperty clears border-left-color'
	);
}
...
// --- border-radius (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-top-left-radius'),
		'5px',
		'border-radius: expands to border-top-left-radius'
	);
	assertEq(
		s.getPropertyValue('border-top-right-radius'),
		'5px',
		'border-radius: expands to border-top-right-radius'
	);
	assertEq(
		s.getPropertyValue('border-bottom-right-radius'),
		'5px',
		'border-radius: expands to border-bottom-right-radius'
	);
	assertEq(
		s.getPropertyValue('border-bottom-left-radius'),
		'5px',
		'border-radius: expands to border-bottom-left-radius'
	);
	s.setProperty('border-radius', 'inherit');
	assertEq(
		s.getPropertyValue('border-top-left-radius'),
		'inherit',
		'border-radius: inherit expands to border-top-left-radius'
	);
	assertEq(
		s.getPropertyValue('border-top-right-radius'),
		'inherit',
		'border-radius: inherit expands to border-top-right-radius'
	);
	assertEq(
		s.getPropertyValue('border-bottom-right-radius'),
		'inherit',
		'border-radius: inherit expands to border-bottom-right-radius'
	);
	assertEq(
		s.getPropertyValue('border-bottom-left-radius'),
		'inherit',
		'border-radius: inherit expands to border-bottom-left-radius'
	);
	s.removeProperty('border-radius');
	assertEq(
		s.getPropertyValue('border-top-left-radius'),
		'',
		'border-radius: removeProperty clears border-top-left-radius'
	);
	assertEq(
		s.getPropertyValue('border-top-right-radius'),
		'',
		'border-radius: removeProperty clears border-top-right-radius'
	);
	assertEq(
		s.getPropertyValue('border-bottom-right-radius'),
		'',
		'border-radius: removeProperty clears border-bottom-right-radius'
	);
	assertEq(
		s.getPropertyValue('border-bottom-left-radius'),
		'',
		'border-radius: removeProperty clears border-bottom-left-radius'
	);
}
...
// --- border-right (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-right-width'),
		'1px',
		'border-right: expands to border-right-width'
	);
	assertEq(
		s.getPropertyValue('border-right-style'),
		'solid',
		'border-right: expands to border-right-style'
	);
	assertEq(
		s.getPropertyValue('border-right-color'),
		'red',
		'border-right: expands to border-right-color'
	);
	s.setProperty('border-right', 'inherit');
	assertEq(
		s.getPropertyValue('border-right-width'),
		'inherit',
		'border-right: inherit expands to border-right-width'
	);
	assertEq(
		s.getPropertyValue('border-right-style'),
		'inherit',
		'border-right: inherit expands to border-right-style'
	);
	assertEq(
		s.getPropertyValue('border-right-color'),
		'inherit',
		'border-right: inherit expands to border-right-color'
	);
	s.removeProperty('border-right');
	assertEq(
		s.getPropertyValue('border-right-width'),
		'',
		'border-right: removeProperty clears border-right-width'
	);
	assertEq(
		s.getPropertyValue('border-right-style'),
		'',
		'border-right: removeProperty clears border-right-style'
	);
	assertEq(
		s.getPropertyValue('border-right-color'),
		'',
		'border-right: removeProperty clears border-right-color'
	);
}
...
// --- border-spacing (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-border-horizontal-spacing'),
		'inherit',
		'border-spacing: expands to -webkit-border-horizontal-spacing'
	);
	assertEq(
		s.getPropertyValue('-webkit-border-vertical-spacing'),
		'inherit',
		'border-spacing: expands to -webkit-border-vertical-spacing'
	);
	s.setProperty('border-spacing', 'inherit');
	assertEq(
		s.getPropertyValue('-webkit-border-horizontal-spacing'),
		'inherit',
		'border-spacing: inherit expands to -webkit-border-horizontal-spacing'
	);
	assertEq(
		s.getPropertyValue('-webkit-border-vertical-spacing'),
		'inherit',
		'border-spacing: inherit expands to -webkit-border-vertical-spacing'
	);
	s.removeProperty('border-spacing');
	assertEq(
		s.getPropertyValue('-webkit-border-horizontal-spacing'),
		'',
		'border-spacing: removeProperty clears -webkit-border-horizontal-spacing'
	);
	assertEq(
		s.getPropertyValue('-webkit-border-vertical-spacing'),
		'',
		'border-spacing: removeProperty clears -webkit-border-vertical-spacing'
	);
}
...
// --- border-style (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-top-style'),
		'solid',
		'border-style: expands to border-top-style'
	);
	assertEq(
		s.getPropertyValue('border-right-style'),
		'solid',
		'border-style: expands to border-right-style'
	);
	assertEq(
		s.getPropertyValue('border-bottom-style'),
		'solid',
		'border-style: expands to border-bottom-style'
	);
	assertEq(
		s.getPropertyValue('border-left-style'),
		'solid',
		'border-style: expands to border-left-style'
	);
	s.setProperty('border-style', 'inherit');
	assertEq(
		s.getPropertyValue('border-top-style'),
		'inherit',
		'border-style: inherit expands to border-top-style'
	);
	assertEq(
		s.getPropertyValue('border-right-style'),
		'inherit',
		'border-style: inherit expands to border-right-style'
	);
	assertEq(
		s.getPropertyValue('border-bottom-style'),
		'inherit',
		'border-style: inherit expands to border-bottom-style'
	);
	assertEq(
		s.getPropertyValue('border-left-style'),
		'inherit',
		'border-style: inherit expands to border-left-style'
	);
	s.removeProperty('border-style');
	assertEq(
		s.getPropertyValue('border-top-style'),
		'',
		'border-style: removeProperty clears border-top-style'
	);
	assertEq(
		s.getPropertyValue('border-right-style'),
		'',
		'border-style: removeProperty clears border-right-style'
	);
	assertEq(
		s.getPropertyValue('border-bottom-style'),
		'',
		'border-style: removeProperty clears border-bottom-style'
	);
	assertEq(
		s.getPropertyValue('border-left-style'),
		'',
		'border-style: removeProperty clears border-left-style'
	);
}
...
// --- border-top (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-top-width'),
		'1px',
		'border-top: expands to border-top-width'
	);
	assertEq(
		s.getPropertyValue('border-top-style'),
		'solid',
		'border-top: expands to border-top-style'
	);
	assertEq(
		s.getPropertyValue('border-top-color'),
		'red',
		'border-top: expands to border-top-color'
	);
	s.setProperty('border-top', 'inherit');
	assertEq(
		s.getPropertyValue('border-top-width'),
		'inherit',
		'border-top: inherit expands to border-top-width'
	);
	assertEq(
		s.getPropertyValue('border-top-style'),
		'inherit',
		'border-top: inherit expands to border-top-style'
	);
	assertEq(
		s.getPropertyValue('border-top-color'),
		'inherit',
		'border-top: inherit expands to border-top-color'
	);
	s.removeProperty('border-top');
	assertEq(
		s.getPropertyValue('border-top-width'),
		'',
		'border-top: removeProperty clears border-top-width'
	);
	assertEq(
		s.getPropertyValue('border-top-style'),
		'',
		'border-top: removeProperty clears border-top-style'
	);
	assertEq(
		s.getPropertyValue('border-top-color'),
		'',
		'border-top: removeProperty clears border-top-color'
	);
}
...
// --- border-width (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-top-width'),
		'1px',
		'border-width: expands to border-top-width'
	);
	assertEq(
		s.getPropertyValue('border-right-width'),
		'2px',
		'border-width: expands to border-right-width'
	);
	assertEq(
		s.getPropertyValue('border-bottom-width'),
		'3px',
		'border-width: expands to border-bottom-width'
	);
	assertEq(
		s.getPropertyValue('border-left-width'),
		'4px',
		'border-width: expands to border-left-width'
	);
	s.setProperty('border-width', 'inherit');
	assertEq(
		s.getPropertyValue('border-top-width'),
		'inherit',
		'border-width: inherit expands to border-top-width'
	);
	assertEq(
		s.getPropertyValue('border-right-width'),
		'inherit',
		'border-width: inherit expands to border-right-width'
	);
	assertEq(
		s.getPropertyValue('border-bottom-width'),
		'inherit',
		'border-width: inherit expands to border-bottom-width'
	);
	assertEq(
		s.getPropertyValue('border-left-width'),
		'inherit',
		'border-width: inherit expands to border-left-width'
	);
	s.removeProperty('border-width');
	assertEq(
		s.getPropertyValue('border-top-width'),
		'',
		'border-width: removeProperty clears border-top-width'
	);
	assertEq(
		s.getPropertyValue('border-right-width'),
		'',
		'border-width: removeProperty clears border-right-width'
	);
	assertEq(
		s.getPropertyValue('border-bottom-width'),
		'',
		'border-width: removeProperty clears border-bottom-width'
	);
	assertEq(
		s.getPropertyValue('border-left-width'),
		'',
		'border-width: removeProperty clears border-left-width'
	);
}
...
// --- column-rule-edge-inset (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'inherit',
		'column-rule-edge-inset: expands to column-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'inherit',
		'column-rule-edge-inset: expands to column-rule-edge-inset-end'
	);
	s.setProperty('column-rule-edge-inset', 'inherit');
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'inherit',
		'column-rule-edge-inset: inherit expands to column-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'inherit',
		'column-rule-edge-inset: inherit expands to column-rule-edge-inset-end'
	);
	s.removeProperty('column-rule-edge-inset');
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'',
		'column-rule-edge-inset: removeProperty clears column-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'',
		'column-rule-edge-inset: removeProperty clears column-rule-edge-inset-end'
	);
}
...
// --- column-rule-inset-end (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'inherit',
		'column-rule-inset-end: expands to column-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'inherit',
		'column-rule-inset-end: expands to column-rule-interior-inset-end'
	);
	s.setProperty('column-rule-inset-end', 'inherit');
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'inherit',
		'column-rule-inset-end: inherit expands to column-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'inherit',
		'column-rule-inset-end: inherit expands to column-rule-interior-inset-end'
	);
	s.removeProperty('column-rule-inset-end');
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'',
		'column-rule-inset-end: removeProperty clears column-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'',
		'column-rule-inset-end: removeProperty clears column-rule-interior-inset-end'
	);
}
...
// --- column-rule-inset-start (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'inherit',
		'column-rule-inset-start: expands to column-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'inherit',
		'column-rule-inset-start: expands to column-rule-interior-inset-start'
	);
	s.setProperty('column-rule-inset-start', 'inherit');
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'inherit',
		'column-rule-inset-start: inherit expands to column-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'inherit',
		'column-rule-inset-start: inherit expands to column-rule-interior-inset-start'
	);
	s.removeProperty('column-rule-inset-start');
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'',
		'column-rule-inset-start: removeProperty clears column-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'',
		'column-rule-inset-start: removeProperty clears column-rule-interior-inset-start'
	);
}
...
// --- column-rule-interior-inset (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'inherit',
		'column-rule-interior-inset: expands to column-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'inherit',
		'column-rule-interior-inset: expands to column-rule-interior-inset-end'
	);
	s.setProperty('column-rule-interior-inset', 'inherit');
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'inherit',
		'column-rule-interior-inset: inherit expands to column-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'inherit',
		'column-rule-interior-inset: inherit expands to column-rule-interior-inset-end'
	);
	s.removeProperty('column-rule-interior-inset');
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'',
		'column-rule-interior-inset: removeProperty clears column-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'',
		'column-rule-interior-inset: removeProperty clears column-rule-interior-inset-end'
	);
}
...
// --- contain-intrinsic-size (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('contain-intrinsic-width'),
		'inherit',
		'contain-intrinsic-size: expands to contain-intrinsic-width'
	);
	assertEq(
		s.getPropertyValue('contain-intrinsic-height'),
		'inherit',
		'contain-intrinsic-size: expands to contain-intrinsic-height'
	);
	s.setProperty('contain-intrinsic-size', 'inherit');
	assertEq(
		s.getPropertyValue('contain-intrinsic-width'),
		'inherit',
		'contain-intrinsic-size: inherit expands to contain-intrinsic-width'
	);
	assertEq(
		s.getPropertyValue('contain-intrinsic-height'),
		'inherit',
		'contain-intrinsic-size: inherit expands to contain-intrinsic-height'
	);
	s.removeProperty('contain-intrinsic-size');
	assertEq(
		s.getPropertyValue('contain-intrinsic-width'),
		'',
		'contain-intrinsic-size: removeProperty clears contain-intrinsic-width'
	);
	assertEq(
		s.getPropertyValue('contain-intrinsic-height'),
		'',
		'contain-intrinsic-size: removeProperty clears contain-intrinsic-height'
	);
}
...
// --- container (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('container-name'),
		'inherit',
		'container: inherit expands to container-name'
	);
	assertEq(
		s.getPropertyValue('container-type'),
		'inherit',
		'container: inherit expands to container-type'
	);
	s.removeProperty('container');
	assertEq(
		s.getPropertyValue('container-name'),
		'',
		'container: removeProperty clears container-name'
	);
	assertEq(
		s.getPropertyValue('container-type'),
		'',
		'container: removeProperty clears container-type'
	);
}
...
// --- corner-top-shape (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('corner-top-left-shape'),
		'inherit',
		'corner-top-shape: expands to corner-top-left-shape'
	);
	assertEq(
		s.getPropertyValue('corner-top-right-shape'),
		'inherit',
		'corner-top-shape: expands to corner-top-right-shape'
	);
	s.setProperty('corner-top-shape', 'inherit');
	assertEq(
		s.getPropertyValue('corner-top-left-shape'),
		'inherit',
		'corner-top-shape: inherit expands to corner-top-left-shape'
	);
	assertEq(
		s.getPropertyValue('corner-top-right-shape'),
		'inherit',
		'corner-top-shape: inherit expands to corner-top-right-shape'
	);
	s.removeProperty('corner-top-shape');
	assertEq(
		s.getPropertyValue('corner-top-left-shape'),
		'',
		'corner-top-shape: removeProperty clears corner-top-left-shape'
	);
	assertEq(
		s.getPropertyValue('corner-top-right-shape'),
		'',
		'corner-top-shape: removeProperty clears corner-top-right-shape'
	);
}
...
// --- corner-right-shape (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('corner-top-right-shape'),
		'inherit',
		'corner-right-shape: expands to corner-top-right-shape'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-right-shape'),
		'inherit',
		'corner-right-shape: expands to corner-bottom-right-shape'
	);
	s.setProperty('corner-right-shape', 'inherit');
	assertEq(
		s.getPropertyValue('corner-top-right-shape'),
		'inherit',
		'corner-right-shape: inherit expands to corner-top-right-shape'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-right-shape'),
		'inherit',
		'corner-right-shape: inherit expands to corner-bottom-right-shape'
	);
	s.removeProperty('corner-right-shape');
	assertEq(
		s.getPropertyValue('corner-top-right-shape'),
		'',
		'corner-right-shape: removeProperty clears corner-top-right-shape'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-right-shape'),
		'',
		'corner-right-shape: removeProperty clears corner-bottom-right-shape'
	);
}
...
// --- corner-bottom-shape (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('corner-bottom-left-shape'),
		'inherit',
		'corner-bottom-shape: expands to corner-bottom-left-shape'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-right-shape'),
		'inherit',
		'corner-bottom-shape: expands to corner-bottom-right-shape'
	);
	s.setProperty('corner-bottom-shape', 'inherit');
	assertEq(
		s.getPropertyValue('corner-bottom-left-shape'),
		'inherit',
		'corner-bottom-shape: inherit expands to corner-bottom-left-shape'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-right-shape'),
		'inherit',
		'corner-bottom-shape: inherit expands to corner-bottom-right-shape'
	);
	s.removeProperty('corner-bottom-shape');
	assertEq(
		s.getPropertyValue('corner-bottom-left-shape'),
		'',
		'corner-bottom-shape: removeProperty clears corner-bottom-left-shape'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-right-shape'),
		'',
		'corner-bottom-shape: removeProperty clears corner-bottom-right-shape'
	);
}
...
// --- corner-left-shape (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('corner-top-left-shape'),
		'inherit',
		'corner-left-shape: expands to corner-top-left-shape'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-left-shape'),
		'inherit',
		'corner-left-shape: expands to corner-bottom-left-shape'
	);
	s.setProperty('corner-left-shape', 'inherit');
	assertEq(
		s.getPropertyValue('corner-top-left-shape'),
		'inherit',
		'corner-left-shape: inherit expands to corner-top-left-shape'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-left-shape'),
		'inherit',
		'corner-left-shape: inherit expands to corner-bottom-left-shape'
	);
	s.removeProperty('corner-left-shape');
	assertEq(
		s.getPropertyValue('corner-top-left-shape'),
		'',
		'corner-left-shape: removeProperty clears corner-top-left-shape'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-left-shape'),
		'',
		'corner-left-shape: removeProperty clears corner-bottom-left-shape'
	);
}
...
// --- corner-block-start-shape (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('corner-start-start-shape'),
		'inherit',
		'corner-block-start-shape: expands to corner-start-start-shape'
	);
	assertEq(
		s.getPropertyValue('corner-start-end-shape'),
		'inherit',
		'corner-block-start-shape: expands to corner-start-end-shape'
	);
	s.setProperty('corner-block-start-shape', 'inherit');
	assertEq(
		s.getPropertyValue('corner-start-start-shape'),
		'inherit',
		'corner-block-start-shape: inherit expands to corner-start-start-shape'
	);
	assertEq(
		s.getPropertyValue('corner-start-end-shape'),
		'inherit',
		'corner-block-start-shape: inherit expands to corner-start-end-shape'
	);
	s.removeProperty('corner-block-start-shape');
	assertEq(
		s.getPropertyValue('corner-start-start-shape'),
		'',
		'corner-block-start-shape: removeProperty clears corner-start-start-shape'
	);
	assertEq(
		s.getPropertyValue('corner-start-end-shape'),
		'',
		'corner-block-start-shape: removeProperty clears corner-start-end-shape'
	);
}
...
// --- corner-block-end-shape (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('corner-end-start-shape'),
		'inherit',
		'corner-block-end-shape: expands to corner-end-start-shape'
	);
	assertEq(
		s.getPropertyValue('corner-end-end-shape'),
		'inherit',
		'corner-block-end-shape: expands to corner-end-end-shape'
	);
	s.setProperty('corner-block-end-shape', 'inherit');
	assertEq(
		s.getPropertyValue('corner-end-start-shape'),
		'inherit',
		'corner-block-end-shape: inherit expands to corner-end-start-shape'
	);
	assertEq(
		s.getPropertyValue('corner-end-end-shape'),
		'inherit',
		'corner-block-end-shape: inherit expands to corner-end-end-shape'
	);
	s.removeProperty('corner-block-end-shape');
	assertEq(
		s.getPropertyValue('corner-end-start-shape'),
		'',
		'corner-block-end-shape: removeProperty clears corner-end-start-shape'
	);
	assertEq(
		s.getPropertyValue('corner-end-end-shape'),
		'',
		'corner-block-end-shape: removeProperty clears corner-end-end-shape'
	);
}
...
// --- corner-inline-start-shape (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('corner-start-start-shape'),
		'inherit',
		'corner-inline-start-shape: expands to corner-start-start-shape'
	);
	assertEq(
		s.getPropertyValue('corner-end-start-shape'),
		'inherit',
		'corner-inline-start-shape: expands to corner-end-start-shape'
	);
	s.setProperty('corner-inline-start-shape', 'inherit');
	assertEq(
		s.getPropertyValue('corner-start-start-shape'),
		'inherit',
		'corner-inline-start-shape: inherit expands to corner-start-start-shape'
	);
	assertEq(
		s.getPropertyValue('corner-end-start-shape'),
		'inherit',
		'corner-inline-start-shape: inherit expands to corner-end-start-shape'
	);
	s.removeProperty('corner-inline-start-shape');
	assertEq(
		s.getPropertyValue('corner-start-start-shape'),
		'',
		'corner-inline-start-shape: removeProperty clears corner-start-start-shape'
	);
	assertEq(
		s.getPropertyValue('corner-end-start-shape'),
		'',
		'corner-inline-start-shape: removeProperty clears corner-end-start-shape'
	);
}
...
// --- corner-inline-end-shape (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('corner-start-end-shape'),
		'inherit',
		'corner-inline-end-shape: expands to corner-start-end-shape'
	);
	assertEq(
		s.getPropertyValue('corner-end-end-shape'),
		'inherit',
		'corner-inline-end-shape: expands to corner-end-end-shape'
	);
	s.setProperty('corner-inline-end-shape', 'inherit');
	assertEq(
		s.getPropertyValue('corner-start-end-shape'),
		'inherit',
		'corner-inline-end-shape: inherit expands to corner-start-end-shape'
	);
	assertEq(
		s.getPropertyValue('corner-end-end-shape'),
		'inherit',
		'corner-inline-end-shape: inherit expands to corner-end-end-shape'
	);
	s.removeProperty('corner-inline-end-shape');
	assertEq(
		s.getPropertyValue('corner-start-end-shape'),
		'',
		'corner-inline-end-shape: removeProperty clears corner-start-end-shape'
	);
	assertEq(
		s.getPropertyValue('corner-end-end-shape'),
		'',
		'corner-inline-end-shape: removeProperty clears corner-end-end-shape'
	);
}
...
// --- corner-shape (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('corner-top-left-shape'),
		'inherit',
		'corner-shape: expands to corner-top-left-shape'
	);
	assertEq(
		s.getPropertyValue('corner-top-right-shape'),
		'inherit',
		'corner-shape: expands to corner-top-right-shape'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-right-shape'),
		'inherit',
		'corner-shape: expands to corner-bottom-right-shape'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-left-shape'),
		'inherit',
		'corner-shape: expands to corner-bottom-left-shape'
	);
	s.setProperty('corner-shape', 'inherit');
	assertEq(
		s.getPropertyValue('corner-top-left-shape'),
		'inherit',
		'corner-shape: inherit expands to corner-top-left-shape'
	);
	assertEq(
		s.getPropertyValue('corner-top-right-shape'),
		'inherit',
		'corner-shape: inherit expands to corner-top-right-shape'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-right-shape'),
		'inherit',
		'corner-shape: inherit expands to corner-bottom-right-shape'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-left-shape'),
		'inherit',
		'corner-shape: inherit expands to corner-bottom-left-shape'
	);
	s.removeProperty('corner-shape');
	assertEq(
		s.getPropertyValue('corner-top-left-shape'),
		'',
		'corner-shape: removeProperty clears corner-top-left-shape'
	);
	assertEq(
		s.getPropertyValue('corner-top-right-shape'),
		'',
		'corner-shape: removeProperty clears corner-top-right-shape'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-right-shape'),
		'',
		'corner-shape: removeProperty clears corner-bottom-right-shape'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-left-shape'),
		'',
		'corner-shape: removeProperty clears corner-bottom-left-shape'
	);
}
...
// --- corners (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('border-top-left-radius'),
		'inherit',
		'corners: expands to border-top-left-radius'
	);
	assertEq(
		s.getPropertyValue('corner-top-left-shape'),
		'inherit',
		'corners: expands to corner-top-left-shape'
	);
	assertEq(
		s.getPropertyValue('border-top-right-radius'),
		'inherit',
		'corners: expands to border-top-right-radius'
	);
	assertEq(
		s.getPropertyValue('corner-top-right-shape'),
		'inherit',
		'corners: expands to corner-top-right-shape'
	);
	assertEq(
		s.getPropertyValue('border-bottom-right-radius'),
		'inherit',
		'corners: expands to border-bottom-right-radius'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-right-shape'),
		'inherit',
		'corners: expands to corner-bottom-right-shape'
	);
	assertEq(
		s.getPropertyValue('border-bottom-left-radius'),
		'inherit',
		'corners: expands to border-bottom-left-radius'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-left-shape'),
		'inherit',
		'corners: expands to corner-bottom-left-shape'
	);
	s.setProperty('corners', 'inherit');
	assertEq(
		s.getPropertyValue('border-top-left-radius'),
		'inherit',
		'corners: inherit expands to border-top-left-radius'
	);
	assertEq(
		s.getPropertyValue('corner-top-left-shape'),
		'inherit',
		'corners: inherit expands to corner-top-left-shape'
	);
	assertEq(
		s.getPropertyValue('border-top-right-radius'),
		'inherit',
		'corners: inherit expands to border-top-right-radius'
	);
	assertEq(
		s.getPropertyValue('corner-top-right-shape'),
		'inherit',
		'corners: inherit expands to corner-top-right-shape'
	);
	assertEq(
		s.getPropertyValue('border-bottom-right-radius'),
		'inherit',
		'corners: inherit expands to border-bottom-right-radius'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-right-shape'),
		'inherit',
		'corners: inherit expands to corner-bottom-right-shape'
	);
	assertEq(
		s.getPropertyValue('border-bottom-left-radius'),
		'inherit',
		'corners: inherit expands to border-bottom-left-radius'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-left-shape'),
		'inherit',
		'corners: inherit expands to corner-bottom-left-shape'
	);
	s.removeProperty('corners');
	assertEq(
		s.getPropertyValue('border-top-left-radius'),
		'',
		'corners: removeProperty clears border-top-left-radius'
	);
	assertEq(
		s.getPropertyValue('corner-top-left-shape'),
		'',
		'corners: removeProperty clears corner-top-left-shape'
	);
	assertEq(
		s.getPropertyValue('border-top-right-radius'),
		'',
		'corners: removeProperty clears border-top-right-radius'
	);
	assertEq(
		s.getPropertyValue('corner-top-right-shape'),
		'',
		'corners: removeProperty clears corner-top-right-shape'
	);
	assertEq(
		s.getPropertyValue('border-bottom-right-radius'),
		'',
		'corners: removeProperty clears border-bottom-right-radius'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-right-shape'),
		'',
		'corners: removeProperty clears corner-bottom-right-shape'
	);
	assertEq(
		s.getPropertyValue('border-bottom-left-radius'),
		'',
		'corners: removeProperty clears border-bottom-left-radius'
	);
	assertEq(
		s.getPropertyValue('corner-bottom-left-shape'),
		'',
		'corners: removeProperty clears corner-bottom-left-shape'
	);
}
...
// --- flex-flow (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('flex-direction'),
		'inherit',
		'flex-flow: inherit expands to flex-direction'
	);
	...
	assertEq(
		s.getPropertyValue('flex-direction'),
		'',
		'flex-flow: removeProperty clears flex-direction'
	);
...
// --- font (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('font-variant-ligatures'),
		'inherit',
		'font: expands to font-variant-ligatures'
	);
	assertEq(
		s.getPropertyValue('font-variant-caps'),
		'inherit',
		'font: expands to font-variant-caps'
	);
	assertEq(
		s.getPropertyValue('font-variant-numeric'),
		'inherit',
		'font: expands to font-variant-numeric'
	);
	assertEq(
		s.getPropertyValue('font-variant-east-asian'),
		'inherit',
		'font: expands to font-variant-east-asian'
	);
	assertEq(
		s.getPropertyValue('font-variant-alternates'),
		'inherit',
		'font: expands to font-variant-alternates'
	);
	assertEq(
		s.getPropertyValue('font-variant-position'),
		'inherit',
		'font: expands to font-variant-position'
	);
	assertEq(
		s.getPropertyValue('font-variant-emoji'),
		'inherit',
		'font: expands to font-variant-emoji'
	);
	...
	assertEq(
		s.getPropertyValue('font-optical-sizing'),
		'inherit',
		'font: expands to font-optical-sizing'
	);
	...
	assertEq(
		s.getPropertyValue('font-feature-settings'),
		'inherit',
		'font: expands to font-feature-settings'
	);
	assertEq(
		s.getPropertyValue('font-variation-settings'),
		'inherit',
		'font: expands to font-variation-settings'
	);
	assertEq(
		s.getPropertyValue('font-language-override'),
		'inherit',
		'font: expands to font-language-override'
	);
	s.setProperty('font', 'inherit');
	...
	assertEq(
		s.getPropertyValue('font-variant-ligatures'),
		'inherit',
		'font: inherit expands to font-variant-ligatures'
	);
	assertEq(
		s.getPropertyValue('font-variant-caps'),
		'inherit',
		'font: inherit expands to font-variant-caps'
	);
	assertEq(
		s.getPropertyValue('font-variant-numeric'),
		'inherit',
		'font: inherit expands to font-variant-numeric'
	);
	assertEq(
		s.getPropertyValue('font-variant-east-asian'),
		'inherit',
		'font: inherit expands to font-variant-east-asian'
	);
	assertEq(
		s.getPropertyValue('font-variant-alternates'),
		'inherit',
		'font: inherit expands to font-variant-alternates'
	);
	assertEq(
		s.getPropertyValue('font-variant-position'),
		'inherit',
		'font: inherit expands to font-variant-position'
	);
	assertEq(
		s.getPropertyValue('font-variant-emoji'),
		'inherit',
		'font: inherit expands to font-variant-emoji'
	);
	...
	assertEq(
		s.getPropertyValue('font-optical-sizing'),
		'inherit',
		'font: inherit expands to font-optical-sizing'
	);
	assertEq(
		s.getPropertyValue('font-size-adjust'),
		'inherit',
		'font: inherit expands to font-size-adjust'
	);
	assertEq(s.getPropertyValue('font-kerning'), 'inherit', 'font: inherit expands to font-kerning');
	assertEq(
		s.getPropertyValue('font-feature-settings'),
		'inherit',
		'font: inherit expands to font-feature-settings'
	);
	assertEq(
		s.getPropertyValue('font-variation-settings'),
		'inherit',
		'font: inherit expands to font-variation-settings'
	);
	assertEq(
		s.getPropertyValue('font-language-override'),
		'inherit',
		'font: inherit expands to font-language-override'
	);
	...
	assertEq(
		s.getPropertyValue('font-variant-ligatures'),
		'',
		'font: removeProperty clears font-variant-ligatures'
	);
	assertEq(
		s.getPropertyValue('font-variant-caps'),
		'',
		'font: removeProperty clears font-variant-caps'
	);
	assertEq(
		s.getPropertyValue('font-variant-numeric'),
		'',
		'font: removeProperty clears font-variant-numeric'
	);
	assertEq(
		s.getPropertyValue('font-variant-east-asian'),
		'',
		'font: removeProperty clears font-variant-east-asian'
	);
	assertEq(
		s.getPropertyValue('font-variant-alternates'),
		'',
		'font: removeProperty clears font-variant-alternates'
	);
	assertEq(
		s.getPropertyValue('font-variant-position'),
		'',
		'font: removeProperty clears font-variant-position'
	);
	assertEq(
		s.getPropertyValue('font-variant-emoji'),
		'',
		'font: removeProperty clears font-variant-emoji'
	);
	...
	assertEq(
		s.getPropertyValue('font-optical-sizing'),
		'',
		'font: removeProperty clears font-optical-sizing'
	);
	assertEq(
		s.getPropertyValue('font-size-adjust'),
		'',
		'font: removeProperty clears font-size-adjust'
	);
	assertEq(s.getPropertyValue('font-kerning'), '', 'font: removeProperty clears font-kerning');
	assertEq(
		s.getPropertyValue('font-feature-settings'),
		'',
		'font: removeProperty clears font-feature-settings'
	);
	assertEq(
		s.getPropertyValue('font-variation-settings'),
		'',
		'font: removeProperty clears font-variation-settings'
	);
	assertEq(
		s.getPropertyValue('font-language-override'),
		'',
		'font: removeProperty clears font-language-override'
	);
}
...
// --- font-variant (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('font-variant-ligatures'),
		'inherit',
		'font-variant: expands to font-variant-ligatures'
	);
	assertEq(
		s.getPropertyValue('font-variant-caps'),
		'inherit',
		'font-variant: expands to font-variant-caps'
	);
	assertEq(
		s.getPropertyValue('font-variant-alternates'),
		'inherit',
		'font-variant: expands to font-variant-alternates'
	);
	assertEq(
		s.getPropertyValue('font-variant-numeric'),
		'inherit',
		'font-variant: expands to font-variant-numeric'
	);
	assertEq(
		s.getPropertyValue('font-variant-east-asian'),
		'inherit',
		'font-variant: expands to font-variant-east-asian'
	);
	assertEq(
		s.getPropertyValue('font-variant-position'),
		'inherit',
		'font-variant: expands to font-variant-position'
	);
	assertEq(
		s.getPropertyValue('font-variant-emoji'),
		'inherit',
		'font-variant: expands to font-variant-emoji'
	);
	s.setProperty('font-variant', 'inherit');
	assertEq(
		s.getPropertyValue('font-variant-ligatures'),
		'inherit',
		'font-variant: inherit expands to font-variant-ligatures'
	);
	assertEq(
		s.getPropertyValue('font-variant-caps'),
		'inherit',
		'font-variant: inherit expands to font-variant-caps'
	);
	assertEq(
		s.getPropertyValue('font-variant-alternates'),
		'inherit',
		'font-variant: inherit expands to font-variant-alternates'
	);
	assertEq(
		s.getPropertyValue('font-variant-numeric'),
		'inherit',
		'font-variant: inherit expands to font-variant-numeric'
	);
	assertEq(
		s.getPropertyValue('font-variant-east-asian'),
		'inherit',
		'font-variant: inherit expands to font-variant-east-asian'
	);
	assertEq(
		s.getPropertyValue('font-variant-position'),
		'inherit',
		'font-variant: inherit expands to font-variant-position'
	);
	assertEq(
		s.getPropertyValue('font-variant-emoji'),
		'inherit',
		'font-variant: inherit expands to font-variant-emoji'
	);
	s.removeProperty('font-variant');
	assertEq(
		s.getPropertyValue('font-variant-ligatures'),
		'',
		'font-variant: removeProperty clears font-variant-ligatures'
	);
	assertEq(
		s.getPropertyValue('font-variant-caps'),
		'',
		'font-variant: removeProperty clears font-variant-caps'
	);
	assertEq(
		s.getPropertyValue('font-variant-alternates'),
		'',
		'font-variant: removeProperty clears font-variant-alternates'
	);
	assertEq(
		s.getPropertyValue('font-variant-numeric'),
		'',
		'font-variant: removeProperty clears font-variant-numeric'
	);
	assertEq(
		s.getPropertyValue('font-variant-east-asian'),
		'',
		'font-variant: removeProperty clears font-variant-east-asian'
	);
	assertEq(
		s.getPropertyValue('font-variant-position'),
		'',
		'font-variant: removeProperty clears font-variant-position'
	);
	assertEq(
		s.getPropertyValue('font-variant-emoji'),
		'',
		'font-variant: removeProperty clears font-variant-emoji'
	);
}
...
// --- font-synthesis (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('font-synthesis-weight'),
		'inherit',
		'font-synthesis: expands to font-synthesis-weight'
	);
	assertEq(
		s.getPropertyValue('font-synthesis-style'),
		'inherit',
		'font-synthesis: expands to font-synthesis-style'
	);
	assertEq(
		s.getPropertyValue('font-synthesis-small-caps'),
		'inherit',
		'font-synthesis: expands to font-synthesis-small-caps'
	);
	s.setProperty('font-synthesis', 'inherit');
	assertEq(
		s.getPropertyValue('font-synthesis-weight'),
		'inherit',
		'font-synthesis: inherit expands to font-synthesis-weight'
	);
	assertEq(
		s.getPropertyValue('font-synthesis-style'),
		'inherit',
		'font-synthesis: inherit expands to font-synthesis-style'
	);
	assertEq(
		s.getPropertyValue('font-synthesis-small-caps'),
		'inherit',
		'font-synthesis: inherit expands to font-synthesis-small-caps'
	);
	s.removeProperty('font-synthesis');
	assertEq(
		s.getPropertyValue('font-synthesis-weight'),
		'',
		'font-synthesis: removeProperty clears font-synthesis-weight'
	);
	assertEq(
		s.getPropertyValue('font-synthesis-style'),
		'',
		'font-synthesis: removeProperty clears font-synthesis-style'
	);
	assertEq(
		s.getPropertyValue('font-synthesis-small-caps'),
		'',
		'font-synthesis: removeProperty clears font-synthesis-small-caps'
	);
}
...
// --- grid (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('grid-template-rows'),
		'inherit',
		'grid: expands to grid-template-rows'
	);
	assertEq(
		s.getPropertyValue('grid-template-columns'),
		'inherit',
		'grid: expands to grid-template-columns'
	);
	assertEq(
		s.getPropertyValue('grid-template-areas'),
		'inherit',
		'grid: expands to grid-template-areas'
	);
	...
	assertEq(
		s.getPropertyValue('grid-auto-columns'),
		'inherit',
		'grid: expands to grid-auto-columns'
	);
	s.setProperty('grid', 'inherit');
	assertEq(
		s.getPropertyValue('grid-template-rows'),
		'inherit',
		'grid: inherit expands to grid-template-rows'
	);
	assertEq(
		s.getPropertyValue('grid-template-columns'),
		'inherit',
		'grid: inherit expands to grid-template-columns'
	);
	assertEq(
		s.getPropertyValue('grid-template-areas'),
		'inherit',
		'grid: inherit expands to grid-template-areas'
	);
	assertEq(
		s.getPropertyValue('grid-auto-flow'),
		'inherit',
		'grid: inherit expands to grid-auto-flow'
	);
	assertEq(
		s.getPropertyValue('grid-auto-rows'),
		'inherit',
		'grid: inherit expands to grid-auto-rows'
	);
	assertEq(
		s.getPropertyValue('grid-auto-columns'),
		'inherit',
		'grid: inherit expands to grid-auto-columns'
	);
	s.removeProperty('grid');
	assertEq(
		s.getPropertyValue('grid-template-rows'),
		'',
		'grid: removeProperty clears grid-template-rows'
	);
	assertEq(
		s.getPropertyValue('grid-template-columns'),
		'',
		'grid: removeProperty clears grid-template-columns'
	);
	assertEq(
		s.getPropertyValue('grid-template-areas'),
		'',
		'grid: removeProperty clears grid-template-areas'
	);
	...
	assertEq(
		s.getPropertyValue('grid-auto-columns'),
		'',
		'grid: removeProperty clears grid-auto-columns'
	);
}
...
// --- place-content (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('align-content'),
		'center',
		'place-content: expands to align-content'
	);
	assertEq(
		s.getPropertyValue('justify-content'),
		'center',
		'place-content: expands to justify-content'
	);
	s.setProperty('place-content', 'inherit');
	assertEq(
		s.getPropertyValue('align-content'),
		'inherit',
		'place-content: inherit expands to align-content'
	);
	assertEq(
		s.getPropertyValue('justify-content'),
		'inherit',
		'place-content: inherit expands to justify-content'
	);
	s.removeProperty('place-content');
	assertEq(
		s.getPropertyValue('align-content'),
		'',
		'place-content: removeProperty clears align-content'
	);
	assertEq(
		s.getPropertyValue('justify-content'),
		'',
		'place-content: removeProperty clears justify-content'
	);
}
...
// --- place-items (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('align-items'),
		'inherit',
		'place-items: inherit expands to align-items'
	);
	assertEq(
		s.getPropertyValue('justify-items'),
		'inherit',
		'place-items: inherit expands to justify-items'
	);
	...
	assertEq(
		s.getPropertyValue('justify-items'),
		'',
		'place-items: removeProperty clears justify-items'
	);
}
...
// --- place-self (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('align-self'),
		'inherit',
		'place-self: inherit expands to align-self'
	);
	assertEq(
		s.getPropertyValue('justify-self'),
		'inherit',
		'place-self: inherit expands to justify-self'
	);
	...
	assertEq(
		s.getPropertyValue('justify-self'),
		'',
		'place-self: removeProperty clears justify-self'
	);
}
...
// --- grid-area (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('grid-column-start'),
		'inherit',
		'grid-area: expands to grid-column-start'
	);
	assertEq(s.getPropertyValue('grid-row-end'), 'inherit', 'grid-area: expands to grid-row-end');
	assertEq(
		s.getPropertyValue('grid-column-end'),
		'inherit',
		'grid-area: expands to grid-column-end'
	);
	s.setProperty('grid-area', 'inherit');
	assertEq(
		s.getPropertyValue('grid-row-start'),
		'inherit',
		'grid-area: inherit expands to grid-row-start'
	);
	assertEq(
		s.getPropertyValue('grid-column-start'),
		'inherit',
		'grid-area: inherit expands to grid-column-start'
	);
	assertEq(
		s.getPropertyValue('grid-row-end'),
		'inherit',
		'grid-area: inherit expands to grid-row-end'
	);
	assertEq(
		s.getPropertyValue('grid-column-end'),
		'inherit',
		'grid-area: inherit expands to grid-column-end'
	);
	s.removeProperty('grid-area');
	assertEq(
		s.getPropertyValue('grid-row-start'),
		'',
		'grid-area: removeProperty clears grid-row-start'
	);
	assertEq(
		s.getPropertyValue('grid-column-start'),
		'',
		'grid-area: removeProperty clears grid-column-start'
	);
	assertEq(s.getPropertyValue('grid-row-end'), '', 'grid-area: removeProperty clears grid-row-end');
	assertEq(
		s.getPropertyValue('grid-column-end'),
		'',
		'grid-area: removeProperty clears grid-column-end'
	);
}
...
// --- grid-column (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('grid-column-start'),
		'inherit',
		'grid-column: expands to grid-column-start'
	);
	assertEq(
		s.getPropertyValue('grid-column-end'),
		'inherit',
		'grid-column: expands to grid-column-end'
	);
	s.setProperty('grid-column', 'inherit');
	assertEq(
		s.getPropertyValue('grid-column-start'),
		'inherit',
		'grid-column: inherit expands to grid-column-start'
	);
	assertEq(
		s.getPropertyValue('grid-column-end'),
		'inherit',
		'grid-column: inherit expands to grid-column-end'
	);
	s.removeProperty('grid-column');
	assertEq(
		s.getPropertyValue('grid-column-start'),
		'',
		'grid-column: removeProperty clears grid-column-start'
	);
	assertEq(
		s.getPropertyValue('grid-column-end'),
		'',
		'grid-column: removeProperty clears grid-column-end'
	);
}
...
// --- grid-lanes (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('grid-template-areas'),
		'inherit',
		'grid-lanes: expands to grid-template-areas'
	);
	assertEq(
		s.getPropertyValue('grid-template-columns'),
		'inherit',
		'grid-lanes: expands to grid-template-columns'
	);
	assertEq(
		s.getPropertyValue('grid-template-rows'),
		'inherit',
		'grid-lanes: expands to grid-template-rows'
	);
	assertEq(
		s.getPropertyValue('grid-lanes-direction'),
		'inherit',
		'grid-lanes: expands to grid-lanes-direction'
	);
	s.setProperty('grid-lanes', 'inherit');
	assertEq(
		s.getPropertyValue('grid-template-areas'),
		'inherit',
		'grid-lanes: inherit expands to grid-template-areas'
	);
	assertEq(
		s.getPropertyValue('grid-template-columns'),
		'inherit',
		'grid-lanes: inherit expands to grid-template-columns'
	);
	assertEq(
		s.getPropertyValue('grid-template-rows'),
		'inherit',
		'grid-lanes: inherit expands to grid-template-rows'
	);
	assertEq(
		s.getPropertyValue('grid-lanes-direction'),
		'inherit',
		'grid-lanes: inherit expands to grid-lanes-direction'
	);
	s.removeProperty('grid-lanes');
	assertEq(
		s.getPropertyValue('grid-template-areas'),
		'',
		'grid-lanes: removeProperty clears grid-template-areas'
	);
	assertEq(
		s.getPropertyValue('grid-template-columns'),
		'',
		'grid-lanes: removeProperty clears grid-template-columns'
	);
	assertEq(
		s.getPropertyValue('grid-template-rows'),
		'',
		'grid-lanes: removeProperty clears grid-template-rows'
	);
	assertEq(
		s.getPropertyValue('grid-lanes-direction'),
		'',
		'grid-lanes: removeProperty clears grid-lanes-direction'
	);
}
...
// --- grid-row (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('grid-row-start'),
		'inherit',
		'grid-row: inherit expands to grid-row-start'
	);
	assertEq(
		s.getPropertyValue('grid-row-end'),
		'inherit',
		'grid-row: inherit expands to grid-row-end'
	);
	s.removeProperty('grid-row');
	assertEq(
		s.getPropertyValue('grid-row-start'),
		'',
		'grid-row: removeProperty clears grid-row-start'
	);
...
// --- grid-template (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('grid-template-rows'),
		'inherit',
		'grid-template: expands to grid-template-rows'
	);
	assertEq(
		s.getPropertyValue('grid-template-columns'),
		'inherit',
		'grid-template: expands to grid-template-columns'
	);
	assertEq(
		s.getPropertyValue('grid-template-areas'),
		'inherit',
		'grid-template: expands to grid-template-areas'
	);
	s.setProperty('grid-template', 'inherit');
	assertEq(
		s.getPropertyValue('grid-template-rows'),
		'inherit',
		'grid-template: inherit expands to grid-template-rows'
	);
	assertEq(
		s.getPropertyValue('grid-template-columns'),
		'inherit',
		'grid-template: inherit expands to grid-template-columns'
	);
	assertEq(
		s.getPropertyValue('grid-template-areas'),
		'inherit',
		'grid-template: inherit expands to grid-template-areas'
	);
	s.removeProperty('grid-template');
	assertEq(
		s.getPropertyValue('grid-template-rows'),
		'',
		'grid-template: removeProperty clears grid-template-rows'
	);
	assertEq(
		s.getPropertyValue('grid-template-columns'),
		'',
		'grid-template: removeProperty clears grid-template-columns'
	);
	assertEq(
		s.getPropertyValue('grid-template-areas'),
		'',
		'grid-template: removeProperty clears grid-template-areas'
	);
}
...
// --- inset-block (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('inset-block-start'),
		'5px',
		'inset-block: expands to inset-block-start'
	);
	...
	assertEq(
		s.getPropertyValue('inset-block-start'),
		'inherit',
		'inset-block: inherit expands to inset-block-start'
	);
	assertEq(
		s.getPropertyValue('inset-block-end'),
		'inherit',
		'inset-block: inherit expands to inset-block-end'
	);
	s.removeProperty('inset-block');
	assertEq(
		s.getPropertyValue('inset-block-start'),
		'',
		'inset-block: removeProperty clears inset-block-start'
	);
	assertEq(
		s.getPropertyValue('inset-block-end'),
		'',
		'inset-block: removeProperty clears inset-block-end'
	);
}
...
// --- inset-inline (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('inset-inline-start'),
		'5px',
		'inset-inline: expands to inset-inline-start'
	);
	assertEq(
		s.getPropertyValue('inset-inline-end'),
		'5px',
		'inset-inline: expands to inset-inline-end'
	);
	s.setProperty('inset-inline', 'inherit');
	assertEq(
		s.getPropertyValue('inset-inline-start'),
		'inherit',
		'inset-inline: inherit expands to inset-inline-start'
	);
	assertEq(
		s.getPropertyValue('inset-inline-end'),
		'inherit',
		'inset-inline: inherit expands to inset-inline-end'
	);
	s.removeProperty('inset-inline');
	assertEq(
		s.getPropertyValue('inset-inline-start'),
		'',
		'inset-inline: removeProperty clears inset-inline-start'
	);
	assertEq(
		s.getPropertyValue('inset-inline-end'),
		'',
		'inset-inline: removeProperty clears inset-inline-end'
	);
}
...
// --- list-style (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('list-style-position'),
		'inherit',
		'list-style: expands to list-style-position'
	);
	assertEq(
		s.getPropertyValue('list-style-image'),
		'inherit',
		'list-style: expands to list-style-image'
	);
	assertEq(
		s.getPropertyValue('list-style-type'),
		'inherit',
		'list-style: expands to list-style-type'
	);
	s.setProperty('list-style', 'inherit');
	assertEq(
		s.getPropertyValue('list-style-position'),
		'inherit',
		'list-style: inherit expands to list-style-position'
	);
	assertEq(
		s.getPropertyValue('list-style-image'),
		'inherit',
		'list-style: inherit expands to list-style-image'
	);
	assertEq(
		s.getPropertyValue('list-style-type'),
		'inherit',
		'list-style: inherit expands to list-style-type'
	);
	s.removeProperty('list-style');
	assertEq(
		s.getPropertyValue('list-style-position'),
		'',
		'list-style: removeProperty clears list-style-position'
	);
	assertEq(
		s.getPropertyValue('list-style-image'),
		'',
		'list-style: removeProperty clears list-style-image'
	);
	assertEq(
		s.getPropertyValue('list-style-type'),
		'',
		'list-style: removeProperty clears list-style-type'
	);
}
...
// --- margin (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('margin-right'),
		'inherit',
		'margin: inherit expands to margin-right'
	);
	assertEq(
		s.getPropertyValue('margin-bottom'),
		'inherit',
		'margin: inherit expands to margin-bottom'
	);
...
// --- margin-block (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('margin-block-start'),
		'5px',
		'margin-block: expands to margin-block-start'
	);
	assertEq(
		s.getPropertyValue('margin-block-end'),
		'5px',
		'margin-block: expands to margin-block-end'
	);
	s.setProperty('margin-block', 'inherit');
	assertEq(
		s.getPropertyValue('margin-block-start'),
		'inherit',
		'margin-block: inherit expands to margin-block-start'
	);
	assertEq(
		s.getPropertyValue('margin-block-end'),
		'inherit',
		'margin-block: inherit expands to margin-block-end'
	);
	s.removeProperty('margin-block');
	assertEq(
		s.getPropertyValue('margin-block-start'),
		'',
		'margin-block: removeProperty clears margin-block-start'
	);
	assertEq(
		s.getPropertyValue('margin-block-end'),
		'',
		'margin-block: removeProperty clears margin-block-end'
	);
}
...
// --- margin-inline (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('margin-inline-start'),
		'5px',
		'margin-inline: expands to margin-inline-start'
	);
	assertEq(
		s.getPropertyValue('margin-inline-end'),
		'5px',
		'margin-inline: expands to margin-inline-end'
	);
	s.setProperty('margin-inline', 'inherit');
	assertEq(
		s.getPropertyValue('margin-inline-start'),
		'inherit',
		'margin-inline: inherit expands to margin-inline-start'
	);
	assertEq(
		s.getPropertyValue('margin-inline-end'),
		'inherit',
		'margin-inline: inherit expands to margin-inline-end'
	);
	s.removeProperty('margin-inline');
	assertEq(
		s.getPropertyValue('margin-inline-start'),
		'',
		'margin-inline: removeProperty clears margin-inline-start'
	);
	assertEq(
		s.getPropertyValue('margin-inline-end'),
		'',
		'margin-inline: removeProperty clears margin-inline-end'
	);
}
...
// --- marker (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('marker-start'),
		'inherit',
		'marker: inherit expands to marker-start'
	);
...
// --- offset (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('offset-position'),
		'inherit',
		'offset: inherit expands to offset-position'
	);
	assertEq(s.getPropertyValue('offset-path'), 'inherit', 'offset: inherit expands to offset-path');
	assertEq(
		s.getPropertyValue('offset-distance'),
		'inherit',
		'offset: inherit expands to offset-distance'
	);
	assertEq(
		s.getPropertyValue('offset-rotate'),
		'inherit',
		'offset: inherit expands to offset-rotate'
	);
	assertEq(
		s.getPropertyValue('offset-anchor'),
		'inherit',
		'offset: inherit expands to offset-anchor'
	);
	s.removeProperty('offset');
	assertEq(
		s.getPropertyValue('offset-position'),
		'',
		'offset: removeProperty clears offset-position'
	);
	assertEq(s.getPropertyValue('offset-path'), '', 'offset: removeProperty clears offset-path');
	assertEq(
		s.getPropertyValue('offset-distance'),
		'',
		'offset: removeProperty clears offset-distance'
	);
...
// --- outline (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('outline-color'),
		'inherit',
		'outline: inherit expands to outline-color'
	);
	assertEq(
		s.getPropertyValue('outline-style'),
		'inherit',
		'outline: inherit expands to outline-style'
	);
	assertEq(
		s.getPropertyValue('outline-width'),
		'inherit',
		'outline: inherit expands to outline-width'
	);
...
// --- overscroll-behavior (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('overscroll-behavior-x'),
		'auto',
		'overscroll-behavior: expands to overscroll-behavior-x'
	);
	assertEq(
		s.getPropertyValue('overscroll-behavior-y'),
		'auto',
		'overscroll-behavior: expands to overscroll-behavior-y'
	);
	s.setProperty('overscroll-behavior', 'inherit');
	assertEq(
		s.getPropertyValue('overscroll-behavior-x'),
		'inherit',
		'overscroll-behavior: inherit expands to overscroll-behavior-x'
	);
	assertEq(
		s.getPropertyValue('overscroll-behavior-y'),
		'inherit',
		'overscroll-behavior: inherit expands to overscroll-behavior-y'
	);
	s.removeProperty('overscroll-behavior');
	assertEq(
		s.getPropertyValue('overscroll-behavior-x'),
		'',
		'overscroll-behavior: removeProperty clears overscroll-behavior-x'
	);
	assertEq(
		s.getPropertyValue('overscroll-behavior-y'),
		'',
		'overscroll-behavior: removeProperty clears overscroll-behavior-y'
	);
}
...
// --- padding (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('padding-right'),
		'inherit',
		'padding: inherit expands to padding-right'
	);
	assertEq(
		s.getPropertyValue('padding-bottom'),
		'inherit',
		'padding: inherit expands to padding-bottom'
	);
	assertEq(
		s.getPropertyValue('padding-left'),
		'inherit',
		'padding: inherit expands to padding-left'
	);
	...
	assertEq(
		s.getPropertyValue('padding-bottom'),
		'',
		'padding: removeProperty clears padding-bottom'
	);
...
// --- padding-block (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('padding-block-start'),
		'5px',
		'padding-block: expands to padding-block-start'
	);
	assertEq(
		s.getPropertyValue('padding-block-end'),
		'5px',
		'padding-block: expands to padding-block-end'
	);
	s.setProperty('padding-block', 'inherit');
	assertEq(
		s.getPropertyValue('padding-block-start'),
		'inherit',
		'padding-block: inherit expands to padding-block-start'
	);
	assertEq(
		s.getPropertyValue('padding-block-end'),
		'inherit',
		'padding-block: inherit expands to padding-block-end'
	);
	s.removeProperty('padding-block');
	assertEq(
		s.getPropertyValue('padding-block-start'),
		'',
		'padding-block: removeProperty clears padding-block-start'
	);
	assertEq(
		s.getPropertyValue('padding-block-end'),
		'',
		'padding-block: removeProperty clears padding-block-end'
	);
}
...
// --- padding-inline (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('padding-inline-start'),
		'5px',
		'padding-inline: expands to padding-inline-start'
	);
	assertEq(
		s.getPropertyValue('padding-inline-end'),
		'5px',
		'padding-inline: expands to padding-inline-end'
	);
	s.setProperty('padding-inline', 'inherit');
	assertEq(
		s.getPropertyValue('padding-inline-start'),
		'inherit',
		'padding-inline: inherit expands to padding-inline-start'
	);
	assertEq(
		s.getPropertyValue('padding-inline-end'),
		'inherit',
		'padding-inline: inherit expands to padding-inline-end'
	);
	s.removeProperty('padding-inline');
	assertEq(
		s.getPropertyValue('padding-inline-start'),
		'',
		'padding-inline: removeProperty clears padding-inline-start'
	);
	assertEq(
		s.getPropertyValue('padding-inline-end'),
		'',
		'padding-inline: removeProperty clears padding-inline-end'
	);
}
...
// --- page-break-after (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('break-after'),
		'inherit',
		'page-break-after: expands to break-after'
	);
	s.setProperty('page-break-after', 'inherit');
	assertEq(
		s.getPropertyValue('break-after'),
		'inherit',
		'page-break-after: inherit expands to break-after'
	);
	s.removeProperty('page-break-after');
	assertEq(
		s.getPropertyValue('break-after'),
		'',
		'page-break-after: removeProperty clears break-after'
	);
}
...
// --- page-break-before (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('break-before'),
		'inherit',
		'page-break-before: expands to break-before'
	);
	s.setProperty('page-break-before', 'inherit');
	assertEq(
		s.getPropertyValue('break-before'),
		'inherit',
		'page-break-before: inherit expands to break-before'
	);
	s.removeProperty('page-break-before');
	assertEq(
		s.getPropertyValue('break-before'),
		'',
		'page-break-before: removeProperty clears break-before'
	);
}
...
// --- page-break-inside (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('break-inside'),
		'inherit',
		'page-break-inside: expands to break-inside'
	);
	s.setProperty('page-break-inside', 'inherit');
	assertEq(
		s.getPropertyValue('break-inside'),
		'inherit',
		'page-break-inside: inherit expands to break-inside'
	);
	s.removeProperty('page-break-inside');
	assertEq(
		s.getPropertyValue('break-inside'),
		'',
		'page-break-inside: removeProperty clears break-inside'
	);
}
...
// --- position-try (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('position-try-order'),
		'inherit',
		'position-try: expands to position-try-order'
	);
	assertEq(
		s.getPropertyValue('position-try-fallbacks'),
		'inherit',
		'position-try: expands to position-try-fallbacks'
	);
	s.setProperty('position-try', 'inherit');
	assertEq(
		s.getPropertyValue('position-try-order'),
		'inherit',
		'position-try: inherit expands to position-try-order'
	);
	assertEq(
		s.getPropertyValue('position-try-fallbacks'),
		'inherit',
		'position-try: inherit expands to position-try-fallbacks'
	);
	s.removeProperty('position-try');
	assertEq(
		s.getPropertyValue('position-try-order'),
		'',
		'position-try: removeProperty clears position-try-order'
	);
	assertEq(
		s.getPropertyValue('position-try-fallbacks'),
		'',
		'position-try: removeProperty clears position-try-fallbacks'
	);
}
...
// --- row-rule-edge-inset (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'inherit',
		'row-rule-edge-inset: expands to row-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'inherit',
		'row-rule-edge-inset: expands to row-rule-edge-inset-end'
	);
	s.setProperty('row-rule-edge-inset', 'inherit');
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'inherit',
		'row-rule-edge-inset: inherit expands to row-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'inherit',
		'row-rule-edge-inset: inherit expands to row-rule-edge-inset-end'
	);
	s.removeProperty('row-rule-edge-inset');
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'',
		'row-rule-edge-inset: removeProperty clears row-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'',
		'row-rule-edge-inset: removeProperty clears row-rule-edge-inset-end'
	);
}
...
// --- row-rule-inset-end (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'inherit',
		'row-rule-inset-end: expands to row-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'inherit',
		'row-rule-inset-end: expands to row-rule-interior-inset-end'
	);
	s.setProperty('row-rule-inset-end', 'inherit');
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'inherit',
		'row-rule-inset-end: inherit expands to row-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'inherit',
		'row-rule-inset-end: inherit expands to row-rule-interior-inset-end'
	);
	s.removeProperty('row-rule-inset-end');
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'',
		'row-rule-inset-end: removeProperty clears row-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'',
		'row-rule-inset-end: removeProperty clears row-rule-interior-inset-end'
	);
}
...
// --- row-rule-inset-start (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'inherit',
		'row-rule-inset-start: expands to row-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'inherit',
		'row-rule-inset-start: expands to row-rule-interior-inset-start'
	);
	s.setProperty('row-rule-inset-start', 'inherit');
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'inherit',
		'row-rule-inset-start: inherit expands to row-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'inherit',
		'row-rule-inset-start: inherit expands to row-rule-interior-inset-start'
	);
	s.removeProperty('row-rule-inset-start');
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'',
		'row-rule-inset-start: removeProperty clears row-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'',
		'row-rule-inset-start: removeProperty clears row-rule-interior-inset-start'
	);
}
...
// --- row-rule-interior-inset (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'inherit',
		'row-rule-interior-inset: expands to row-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'inherit',
		'row-rule-interior-inset: expands to row-rule-interior-inset-end'
	);
	s.setProperty('row-rule-interior-inset', 'inherit');
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'inherit',
		'row-rule-interior-inset: inherit expands to row-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'inherit',
		'row-rule-interior-inset: inherit expands to row-rule-interior-inset-end'
	);
	s.removeProperty('row-rule-interior-inset');
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'',
		'row-rule-interior-inset: removeProperty clears row-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'',
		'row-rule-interior-inset: removeProperty clears row-rule-interior-inset-end'
	);
}
...
// --- rule (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-width'),
		'inherit',
		'rule: expands to column-rule-width'
	);
	assertEq(
		s.getPropertyValue('column-rule-style'),
		'inherit',
		'rule: expands to column-rule-style'
	);
	assertEq(
		s.getPropertyValue('column-rule-color'),
		'inherit',
		'rule: expands to column-rule-color'
	);
	...
	assertEq(
		s.getPropertyValue('column-rule-width'),
		'inherit',
		'rule: inherit expands to column-rule-width'
	);
	assertEq(
		s.getPropertyValue('column-rule-style'),
		'inherit',
		'rule: inherit expands to column-rule-style'
	);
	assertEq(
		s.getPropertyValue('column-rule-color'),
		'inherit',
		'rule: inherit expands to column-rule-color'
	);
	assertEq(
		s.getPropertyValue('row-rule-width'),
		'inherit',
		'rule: inherit expands to row-rule-width'
	);
	assertEq(
		s.getPropertyValue('row-rule-style'),
		'inherit',
		'rule: inherit expands to row-rule-style'
	);
	assertEq(
		s.getPropertyValue('row-rule-color'),
		'inherit',
		'rule: inherit expands to row-rule-color'
	);
	s.removeProperty('rule');
	assertEq(
		s.getPropertyValue('column-rule-width'),
		'',
		'rule: removeProperty clears column-rule-width'
	);
	assertEq(
		s.getPropertyValue('column-rule-style'),
		'',
		'rule: removeProperty clears column-rule-style'
	);
	assertEq(
		s.getPropertyValue('column-rule-color'),
		'',
		'rule: removeProperty clears column-rule-color'
	);
...
// --- rule-break (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('row-rule-break'),
		'inherit',
		'rule-break: expands to row-rule-break'
	);
	assertEq(
		s.getPropertyValue('column-rule-break'),
		'inherit',
		'rule-break: expands to column-rule-break'
	);
	s.setProperty('rule-break', 'inherit');
	assertEq(
		s.getPropertyValue('row-rule-break'),
		'inherit',
		'rule-break: inherit expands to row-rule-break'
	);
	assertEq(
		s.getPropertyValue('column-rule-break'),
		'inherit',
		'rule-break: inherit expands to column-rule-break'
	);
	s.removeProperty('rule-break');
	assertEq(
		s.getPropertyValue('row-rule-break'),
		'',
		'rule-break: removeProperty clears row-rule-break'
	);
	assertEq(
		s.getPropertyValue('column-rule-break'),
		'',
		'rule-break: removeProperty clears column-rule-break'
	);
}
...
// --- rule-color (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-color'),
		'inherit',
		'rule-color: expands to column-rule-color'
	);
	assertEq(
		s.getPropertyValue('row-rule-color'),
		'inherit',
		'rule-color: expands to row-rule-color'
	);
	s.setProperty('rule-color', 'inherit');
	assertEq(
		s.getPropertyValue('column-rule-color'),
		'inherit',
		'rule-color: inherit expands to column-rule-color'
	);
	assertEq(
		s.getPropertyValue('row-rule-color'),
		'inherit',
		'rule-color: inherit expands to row-rule-color'
	);
	s.removeProperty('rule-color');
	assertEq(
		s.getPropertyValue('column-rule-color'),
		'',
		'rule-color: removeProperty clears column-rule-color'
	);
	assertEq(
		s.getPropertyValue('row-rule-color'),
		'',
		'rule-color: removeProperty clears row-rule-color'
	);
}
...
// --- rule-edge-inset (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'inherit',
		'rule-edge-inset: expands to row-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'inherit',
		'rule-edge-inset: expands to row-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'inherit',
		'rule-edge-inset: expands to column-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'inherit',
		'rule-edge-inset: expands to column-rule-edge-inset-end'
	);
	s.setProperty('rule-edge-inset', 'inherit');
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'inherit',
		'rule-edge-inset: inherit expands to row-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'inherit',
		'rule-edge-inset: inherit expands to row-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'inherit',
		'rule-edge-inset: inherit expands to column-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'inherit',
		'rule-edge-inset: inherit expands to column-rule-edge-inset-end'
	);
	s.removeProperty('rule-edge-inset');
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'',
		'rule-edge-inset: removeProperty clears row-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'',
		'rule-edge-inset: removeProperty clears row-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'',
		'rule-edge-inset: removeProperty clears column-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'',
		'rule-edge-inset: removeProperty clears column-rule-edge-inset-end'
	);
}
...
// --- rule-interior-inset (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'inherit',
		'rule-interior-inset: expands to row-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'inherit',
		'rule-interior-inset: expands to row-rule-interior-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'inherit',
		'rule-interior-inset: expands to column-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'inherit',
		'rule-interior-inset: expands to column-rule-interior-inset-end'
	);
	s.setProperty('rule-interior-inset', 'inherit');
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'inherit',
		'rule-interior-inset: inherit expands to row-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'inherit',
		'rule-interior-inset: inherit expands to row-rule-interior-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'inherit',
		'rule-interior-inset: inherit expands to column-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'inherit',
		'rule-interior-inset: inherit expands to column-rule-interior-inset-end'
	);
	s.removeProperty('rule-interior-inset');
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'',
		'rule-interior-inset: removeProperty clears row-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'',
		'rule-interior-inset: removeProperty clears row-rule-interior-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'',
		'rule-interior-inset: removeProperty clears column-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'',
		'rule-interior-inset: removeProperty clears column-rule-interior-inset-end'
	);
}
...
// --- rule-inset-end (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'inherit',
		'rule-inset-end: expands to column-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'inherit',
		'rule-inset-end: expands to column-rule-interior-inset-end'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'inherit',
		'rule-inset-end: expands to row-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'inherit',
		'rule-inset-end: expands to row-rule-interior-inset-end'
	);
	s.setProperty('rule-inset-end', 'inherit');
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'inherit',
		'rule-inset-end: inherit expands to column-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'inherit',
		'rule-inset-end: inherit expands to column-rule-interior-inset-end'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'inherit',
		'rule-inset-end: inherit expands to row-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'inherit',
		'rule-inset-end: inherit expands to row-rule-interior-inset-end'
	);
	s.removeProperty('rule-inset-end');
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'',
		'rule-inset-end: removeProperty clears column-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'',
		'rule-inset-end: removeProperty clears column-rule-interior-inset-end'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'',
		'rule-inset-end: removeProperty clears row-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'',
		'rule-inset-end: removeProperty clears row-rule-interior-inset-end'
	);
}
...
// --- rule-inset-start (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'inherit',
		'rule-inset-start: expands to column-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'inherit',
		'rule-inset-start: expands to column-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'inherit',
		'rule-inset-start: expands to row-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'inherit',
		'rule-inset-start: expands to row-rule-interior-inset-start'
	);
	s.setProperty('rule-inset-start', 'inherit');
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'inherit',
		'rule-inset-start: inherit expands to column-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'inherit',
		'rule-inset-start: inherit expands to column-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'inherit',
		'rule-inset-start: inherit expands to row-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'inherit',
		'rule-inset-start: inherit expands to row-rule-interior-inset-start'
	);
	s.removeProperty('rule-inset-start');
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'',
		'rule-inset-start: removeProperty clears column-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'',
		'rule-inset-start: removeProperty clears column-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'',
		'rule-inset-start: removeProperty clears row-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'',
		'rule-inset-start: removeProperty clears row-rule-interior-inset-start'
	);
}
...
// --- column-rule-inset (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'inherit',
		'column-rule-inset: expands to column-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'inherit',
		'column-rule-inset: expands to column-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'inherit',
		'column-rule-inset: expands to column-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'inherit',
		'column-rule-inset: expands to column-rule-interior-inset-end'
	);
	s.setProperty('column-rule-inset', 'inherit');
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'inherit',
		'column-rule-inset: inherit expands to column-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'inherit',
		'column-rule-inset: inherit expands to column-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'inherit',
		'column-rule-inset: inherit expands to column-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'inherit',
		'column-rule-inset: inherit expands to column-rule-interior-inset-end'
	);
	s.removeProperty('column-rule-inset');
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'',
		'column-rule-inset: removeProperty clears column-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'',
		'column-rule-inset: removeProperty clears column-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'',
		'column-rule-inset: removeProperty clears column-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'',
		'column-rule-inset: removeProperty clears column-rule-interior-inset-end'
	);
}
...
// --- row-rule-inset (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'inherit',
		'row-rule-inset: expands to row-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'inherit',
		'row-rule-inset: expands to row-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'inherit',
		'row-rule-inset: expands to row-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'inherit',
		'row-rule-inset: expands to row-rule-interior-inset-end'
	);
	s.setProperty('row-rule-inset', 'inherit');
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'inherit',
		'row-rule-inset: inherit expands to row-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'inherit',
		'row-rule-inset: inherit expands to row-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'inherit',
		'row-rule-inset: inherit expands to row-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'inherit',
		'row-rule-inset: inherit expands to row-rule-interior-inset-end'
	);
	s.removeProperty('row-rule-inset');
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'',
		'row-rule-inset: removeProperty clears row-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'',
		'row-rule-inset: removeProperty clears row-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'',
		'row-rule-inset: removeProperty clears row-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'',
		'row-rule-inset: removeProperty clears row-rule-interior-inset-end'
	);
}
...
// --- rule-inset (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'inherit',
		'rule-inset: expands to row-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'inherit',
		'rule-inset: expands to row-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'inherit',
		'rule-inset: expands to row-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'inherit',
		'rule-inset: expands to row-rule-interior-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'inherit',
		'rule-inset: expands to column-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'inherit',
		'rule-inset: expands to column-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'inherit',
		'rule-inset: expands to column-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'inherit',
		'rule-inset: expands to column-rule-interior-inset-end'
	);
	s.setProperty('rule-inset', 'inherit');
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'inherit',
		'rule-inset: inherit expands to row-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'inherit',
		'rule-inset: inherit expands to row-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'inherit',
		'rule-inset: inherit expands to row-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'inherit',
		'rule-inset: inherit expands to row-rule-interior-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'inherit',
		'rule-inset: inherit expands to column-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'inherit',
		'rule-inset: inherit expands to column-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'inherit',
		'rule-inset: inherit expands to column-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'inherit',
		'rule-inset: inherit expands to column-rule-interior-inset-end'
	);
	s.removeProperty('rule-inset');
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-start'),
		'',
		'rule-inset: removeProperty clears row-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-edge-inset-end'),
		'',
		'rule-inset: removeProperty clears row-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-start'),
		'',
		'rule-inset: removeProperty clears row-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('row-rule-interior-inset-end'),
		'',
		'rule-inset: removeProperty clears row-rule-interior-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-start'),
		'',
		'rule-inset: removeProperty clears column-rule-edge-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-edge-inset-end'),
		'',
		'rule-inset: removeProperty clears column-rule-edge-inset-end'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-start'),
		'',
		'rule-inset: removeProperty clears column-rule-interior-inset-start'
	);
	assertEq(
		s.getPropertyValue('column-rule-interior-inset-end'),
		'',
		'rule-inset: removeProperty clears column-rule-interior-inset-end'
	);
}
...
// --- rule-width (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-width'),
		'inherit',
		'rule-width: expands to column-rule-width'
	);
	assertEq(
		s.getPropertyValue('row-rule-width'),
		'inherit',
		'rule-width: expands to row-rule-width'
	);
	s.setProperty('rule-width', 'inherit');
	assertEq(
		s.getPropertyValue('column-rule-width'),
		'inherit',
		'rule-width: inherit expands to column-rule-width'
	);
	assertEq(
		s.getPropertyValue('row-rule-width'),
		'inherit',
		'rule-width: inherit expands to row-rule-width'
	);
	s.removeProperty('rule-width');
	assertEq(
		s.getPropertyValue('column-rule-width'),
		'',
		'rule-width: removeProperty clears column-rule-width'
	);
	assertEq(
		s.getPropertyValue('row-rule-width'),
		'',
		'rule-width: removeProperty clears row-rule-width'
	);
}
...
// --- rule-style (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-style'),
		'inherit',
		'rule-style: expands to column-rule-style'
	);
	assertEq(
		s.getPropertyValue('row-rule-style'),
		'inherit',
		'rule-style: expands to row-rule-style'
	);
	s.setProperty('rule-style', 'inherit');
	assertEq(
		s.getPropertyValue('column-rule-style'),
		'inherit',
		'rule-style: inherit expands to column-rule-style'
	);
	assertEq(
		s.getPropertyValue('row-rule-style'),
		'inherit',
		'rule-style: inherit expands to row-rule-style'
	);
	s.removeProperty('rule-style');
	assertEq(
		s.getPropertyValue('column-rule-style'),
		'',
		'rule-style: removeProperty clears column-rule-style'
	);
	assertEq(
		s.getPropertyValue('row-rule-style'),
		'',
		'rule-style: removeProperty clears row-rule-style'
	);
}
...
// --- rule-visibility-items (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-visibility-items'),
		'inherit',
		'rule-visibility-items: expands to column-rule-visibility-items'
	);
	assertEq(
		s.getPropertyValue('row-rule-visibility-items'),
		'inherit',
		'rule-visibility-items: expands to row-rule-visibility-items'
	);
	s.setProperty('rule-visibility-items', 'inherit');
	assertEq(
		s.getPropertyValue('column-rule-visibility-items'),
		'inherit',
		'rule-visibility-items: inherit expands to column-rule-visibility-items'
	);
	assertEq(
		s.getPropertyValue('row-rule-visibility-items'),
		'inherit',
		'rule-visibility-items: inherit expands to row-rule-visibility-items'
	);
	s.removeProperty('rule-visibility-items');
	assertEq(
		s.getPropertyValue('column-rule-visibility-items'),
		'',
		'rule-visibility-items: removeProperty clears column-rule-visibility-items'
	);
	assertEq(
		s.getPropertyValue('row-rule-visibility-items'),
		'',
		'rule-visibility-items: removeProperty clears row-rule-visibility-items'
	);
}
...
// --- scroll-margin (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-margin-top'),
		'10px',
		'scroll-margin: expands to scroll-margin-top'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-right'),
		'10px',
		'scroll-margin: expands to scroll-margin-right'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-bottom'),
		'10px',
		'scroll-margin: expands to scroll-margin-bottom'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-left'),
		'10px',
		'scroll-margin: expands to scroll-margin-left'
	);
	s.setProperty('scroll-margin', 'inherit');
	assertEq(
		s.getPropertyValue('scroll-margin-top'),
		'inherit',
		'scroll-margin: inherit expands to scroll-margin-top'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-right'),
		'inherit',
		'scroll-margin: inherit expands to scroll-margin-right'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-bottom'),
		'inherit',
		'scroll-margin: inherit expands to scroll-margin-bottom'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-left'),
		'inherit',
		'scroll-margin: inherit expands to scroll-margin-left'
	);
	s.removeProperty('scroll-margin');
	assertEq(
		s.getPropertyValue('scroll-margin-top'),
		'',
		'scroll-margin: removeProperty clears scroll-margin-top'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-right'),
		'',
		'scroll-margin: removeProperty clears scroll-margin-right'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-bottom'),
		'',
		'scroll-margin: removeProperty clears scroll-margin-bottom'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-left'),
		'',
		'scroll-margin: removeProperty clears scroll-margin-left'
	);
}
...
// --- scroll-margin-block (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-margin-block-start'),
		'5px',
		'scroll-margin-block: expands to scroll-margin-block-start'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-block-end'),
		'5px',
		'scroll-margin-block: expands to scroll-margin-block-end'
	);
	s.setProperty('scroll-margin-block', 'inherit');
	assertEq(
		s.getPropertyValue('scroll-margin-block-start'),
		'inherit',
		'scroll-margin-block: inherit expands to scroll-margin-block-start'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-block-end'),
		'inherit',
		'scroll-margin-block: inherit expands to scroll-margin-block-end'
	);
	s.removeProperty('scroll-margin-block');
	assertEq(
		s.getPropertyValue('scroll-margin-block-start'),
		'',
		'scroll-margin-block: removeProperty clears scroll-margin-block-start'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-block-end'),
		'',
		'scroll-margin-block: removeProperty clears scroll-margin-block-end'
	);
}
...
// --- scroll-margin-inline (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-margin-inline-start'),
		'5px',
		'scroll-margin-inline: expands to scroll-margin-inline-start'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-inline-end'),
		'5px',
		'scroll-margin-inline: expands to scroll-margin-inline-end'
	);
	s.setProperty('scroll-margin-inline', 'inherit');
	assertEq(
		s.getPropertyValue('scroll-margin-inline-start'),
		'inherit',
		'scroll-margin-inline: inherit expands to scroll-margin-inline-start'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-inline-end'),
		'inherit',
		'scroll-margin-inline: inherit expands to scroll-margin-inline-end'
	);
	s.removeProperty('scroll-margin-inline');
	assertEq(
		s.getPropertyValue('scroll-margin-inline-start'),
		'',
		'scroll-margin-inline: removeProperty clears scroll-margin-inline-start'
	);
	assertEq(
		s.getPropertyValue('scroll-margin-inline-end'),
		'',
		'scroll-margin-inline: removeProperty clears scroll-margin-inline-end'
	);
}
...
// --- scroll-padding (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-padding-top'),
		'10px',
		'scroll-padding: expands to scroll-padding-top'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-right'),
		'10px',
		'scroll-padding: expands to scroll-padding-right'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-bottom'),
		'10px',
		'scroll-padding: expands to scroll-padding-bottom'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-left'),
		'10px',
		'scroll-padding: expands to scroll-padding-left'
	);
	s.setProperty('scroll-padding', 'inherit');
	assertEq(
		s.getPropertyValue('scroll-padding-top'),
		'inherit',
		'scroll-padding: inherit expands to scroll-padding-top'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-right'),
		'inherit',
		'scroll-padding: inherit expands to scroll-padding-right'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-bottom'),
		'inherit',
		'scroll-padding: inherit expands to scroll-padding-bottom'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-left'),
		'inherit',
		'scroll-padding: inherit expands to scroll-padding-left'
	);
	s.removeProperty('scroll-padding');
	assertEq(
		s.getPropertyValue('scroll-padding-top'),
		'',
		'scroll-padding: removeProperty clears scroll-padding-top'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-right'),
		'',
		'scroll-padding: removeProperty clears scroll-padding-right'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-bottom'),
		'',
		'scroll-padding: removeProperty clears scroll-padding-bottom'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-left'),
		'',
		'scroll-padding: removeProperty clears scroll-padding-left'
	);
}
...
// --- scroll-padding-block (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-padding-block-start'),
		'5px',
		'scroll-padding-block: expands to scroll-padding-block-start'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-block-end'),
		'5px',
		'scroll-padding-block: expands to scroll-padding-block-end'
	);
	s.setProperty('scroll-padding-block', 'inherit');
	assertEq(
		s.getPropertyValue('scroll-padding-block-start'),
		'inherit',
		'scroll-padding-block: inherit expands to scroll-padding-block-start'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-block-end'),
		'inherit',
		'scroll-padding-block: inherit expands to scroll-padding-block-end'
	);
	s.removeProperty('scroll-padding-block');
	assertEq(
		s.getPropertyValue('scroll-padding-block-start'),
		'',
		'scroll-padding-block: removeProperty clears scroll-padding-block-start'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-block-end'),
		'',
		'scroll-padding-block: removeProperty clears scroll-padding-block-end'
	);
}
...
// --- scroll-padding-inline (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-padding-inline-start'),
		'5px',
		'scroll-padding-inline: expands to scroll-padding-inline-start'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-inline-end'),
		'5px',
		'scroll-padding-inline: expands to scroll-padding-inline-end'
	);
	s.setProperty('scroll-padding-inline', 'inherit');
	assertEq(
		s.getPropertyValue('scroll-padding-inline-start'),
		'inherit',
		'scroll-padding-inline: inherit expands to scroll-padding-inline-start'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-inline-end'),
		'inherit',
		'scroll-padding-inline: inherit expands to scroll-padding-inline-end'
	);
	s.removeProperty('scroll-padding-inline');
	assertEq(
		s.getPropertyValue('scroll-padding-inline-start'),
		'',
		'scroll-padding-inline: removeProperty clears scroll-padding-inline-start'
	);
	assertEq(
		s.getPropertyValue('scroll-padding-inline-end'),
		'',
		'scroll-padding-inline: removeProperty clears scroll-padding-inline-end'
	);
}
...
// --- scroll-timeline (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('scroll-timeline-name'),
		'inherit',
		'scroll-timeline: expands to scroll-timeline-name'
	);
	assertEq(
		s.getPropertyValue('scroll-timeline-axis'),
		'inherit',
		'scroll-timeline: expands to scroll-timeline-axis'
	);
	s.setProperty('scroll-timeline', 'inherit');
	assertEq(
		s.getPropertyValue('scroll-timeline-name'),
		'inherit',
		'scroll-timeline: inherit expands to scroll-timeline-name'
	);
	assertEq(
		s.getPropertyValue('scroll-timeline-axis'),
		'inherit',
		'scroll-timeline: inherit expands to scroll-timeline-axis'
	);
	s.removeProperty('scroll-timeline');
	assertEq(
		s.getPropertyValue('scroll-timeline-name'),
		'',
		'scroll-timeline: removeProperty clears scroll-timeline-name'
	);
	assertEq(
		s.getPropertyValue('scroll-timeline-axis'),
		'',
		'scroll-timeline: removeProperty clears scroll-timeline-axis'
	);
}
...
// --- text-decoration (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('text-decoration-line'),
		'inherit',
		'text-decoration: expands to text-decoration-line'
	);
	assertEq(
		s.getPropertyValue('text-decoration-thickness'),
		'inherit',
		'text-decoration: expands to text-decoration-thickness'
	);
	assertEq(
		s.getPropertyValue('text-decoration-style'),
		'inherit',
		'text-decoration: expands to text-decoration-style'
	);
	assertEq(
		s.getPropertyValue('text-decoration-color'),
		'inherit',
		'text-decoration: expands to text-decoration-color'
	);
	s.setProperty('text-decoration', 'inherit');
	assertEq(
		s.getPropertyValue('text-decoration-line'),
		'inherit',
		'text-decoration: inherit expands to text-decoration-line'
	);
	assertEq(
		s.getPropertyValue('text-decoration-thickness'),
		'inherit',
		'text-decoration: inherit expands to text-decoration-thickness'
	);
	assertEq(
		s.getPropertyValue('text-decoration-style'),
		'inherit',
		'text-decoration: inherit expands to text-decoration-style'
	);
	assertEq(
		s.getPropertyValue('text-decoration-color'),
		'inherit',
		'text-decoration: inherit expands to text-decoration-color'
	);
	s.removeProperty('text-decoration');
	assertEq(
		s.getPropertyValue('text-decoration-line'),
		'',
		'text-decoration: removeProperty clears text-decoration-line'
	);
	assertEq(
		s.getPropertyValue('text-decoration-thickness'),
		'',
		'text-decoration: removeProperty clears text-decoration-thickness'
	);
	assertEq(
		s.getPropertyValue('text-decoration-style'),
		'',
		'text-decoration: removeProperty clears text-decoration-style'
	);
	assertEq(
		s.getPropertyValue('text-decoration-color'),
		'',
		'text-decoration: removeProperty clears text-decoration-color'
	);
}
...
// --- transition (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('transition-property'),
		'inherit',
		'transition: expands to transition-property'
	);
	assertEq(
		s.getPropertyValue('transition-duration'),
		'inherit',
		'transition: expands to transition-duration'
	);
	assertEq(
		s.getPropertyValue('transition-timing-function'),
		'inherit',
		'transition: expands to transition-timing-function'
	);
	assertEq(
		s.getPropertyValue('transition-delay'),
		'inherit',
		'transition: expands to transition-delay'
	);
	assertEq(
		s.getPropertyValue('transition-behavior'),
		'inherit',
		'transition: expands to transition-behavior'
	);
	s.setProperty('transition', 'inherit');
	assertEq(
		s.getPropertyValue('transition-property'),
		'inherit',
		'transition: inherit expands to transition-property'
	);
	assertEq(
		s.getPropertyValue('transition-duration'),
		'inherit',
		'transition: inherit expands to transition-duration'
	);
	assertEq(
		s.getPropertyValue('transition-timing-function'),
		'inherit',
		'transition: inherit expands to transition-timing-function'
	);
	assertEq(
		s.getPropertyValue('transition-delay'),
		'inherit',
		'transition: inherit expands to transition-delay'
	);
	assertEq(
		s.getPropertyValue('transition-behavior'),
		'inherit',
		'transition: inherit expands to transition-behavior'
	);
	s.removeProperty('transition');
	assertEq(
		s.getPropertyValue('transition-property'),
		'',
		'transition: removeProperty clears transition-property'
	);
	assertEq(
		s.getPropertyValue('transition-duration'),
		'',
		'transition: removeProperty clears transition-duration'
	);
	assertEq(
		s.getPropertyValue('transition-timing-function'),
		'',
		'transition: removeProperty clears transition-timing-function'
	);
	assertEq(
		s.getPropertyValue('transition-delay'),
		'',
		'transition: removeProperty clears transition-delay'
	);
	assertEq(
		s.getPropertyValue('transition-behavior'),
		'',
		'transition: removeProperty clears transition-behavior'
	);
}
...
// --- view-timeline (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('view-timeline-name'),
		'inherit',
		'view-timeline: expands to view-timeline-name'
	);
	assertEq(
		s.getPropertyValue('view-timeline-axis'),
		'inherit',
		'view-timeline: expands to view-timeline-axis'
	);
	assertEq(
		s.getPropertyValue('view-timeline-inset'),
		'inherit',
		'view-timeline: expands to view-timeline-inset'
	);
	s.setProperty('view-timeline', 'inherit');
	assertEq(
		s.getPropertyValue('view-timeline-name'),
		'inherit',
		'view-timeline: inherit expands to view-timeline-name'
	);
	assertEq(
		s.getPropertyValue('view-timeline-axis'),
		'inherit',
		'view-timeline: inherit expands to view-timeline-axis'
	);
	assertEq(
		s.getPropertyValue('view-timeline-inset'),
		'inherit',
		'view-timeline: inherit expands to view-timeline-inset'
	);
	s.removeProperty('view-timeline');
	assertEq(
		s.getPropertyValue('view-timeline-name'),
		'',
		'view-timeline: removeProperty clears view-timeline-name'
	);
	assertEq(
		s.getPropertyValue('view-timeline-axis'),
		'',
		'view-timeline: removeProperty clears view-timeline-axis'
	);
	assertEq(
		s.getPropertyValue('view-timeline-inset'),
		'',
		'view-timeline: removeProperty clears view-timeline-inset'
	);
}
...
// --- -webkit-column-break-after (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('break-after'),
		'inherit',
		'-webkit-column-break-after: expands to break-after'
	);
	s.setProperty('-webkit-column-break-after', 'inherit');
	assertEq(
		s.getPropertyValue('break-after'),
		'inherit',
		'-webkit-column-break-after: inherit expands to break-after'
	);
	s.removeProperty('-webkit-column-break-after');
	assertEq(
		s.getPropertyValue('break-after'),
		'',
		'-webkit-column-break-after: removeProperty clears break-after'
	);
}
...
// --- -webkit-column-break-before (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('break-before'),
		'inherit',
		'-webkit-column-break-before: expands to break-before'
	);
	s.setProperty('-webkit-column-break-before', 'inherit');
	assertEq(
		s.getPropertyValue('break-before'),
		'inherit',
		'-webkit-column-break-before: inherit expands to break-before'
	);
	s.removeProperty('-webkit-column-break-before');
	assertEq(
		s.getPropertyValue('break-before'),
		'',
		'-webkit-column-break-before: removeProperty clears break-before'
	);
}
...
// --- -webkit-column-break-inside (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('break-inside'),
		'inherit',
		'-webkit-column-break-inside: expands to break-inside'
	);
	s.setProperty('-webkit-column-break-inside', 'inherit');
	assertEq(
		s.getPropertyValue('break-inside'),
		'inherit',
		'-webkit-column-break-inside: inherit expands to break-inside'
	);
	s.removeProperty('-webkit-column-break-inside');
	assertEq(
		s.getPropertyValue('break-inside'),
		'',
		'-webkit-column-break-inside: removeProperty clears break-inside'
	);
}
...
// --- column-rule (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-width'),
		'inherit',
		'column-rule: expands to column-rule-width'
	);
	assertEq(
		s.getPropertyValue('column-rule-style'),
		'inherit',
		'column-rule: expands to column-rule-style'
	);
	assertEq(
		s.getPropertyValue('column-rule-color'),
		'inherit',
		'column-rule: expands to column-rule-color'
	);
	s.setProperty('column-rule', 'inherit');
	assertEq(
		s.getPropertyValue('column-rule-width'),
		'inherit',
		'column-rule: inherit expands to column-rule-width'
	);
	assertEq(
		s.getPropertyValue('column-rule-style'),
		'inherit',
		'column-rule: inherit expands to column-rule-style'
	);
	assertEq(
		s.getPropertyValue('column-rule-color'),
		'inherit',
		'column-rule: inherit expands to column-rule-color'
	);
	s.removeProperty('column-rule');
	assertEq(
		s.getPropertyValue('column-rule-width'),
		'',
		'column-rule: removeProperty clears column-rule-width'
	);
	assertEq(
		s.getPropertyValue('column-rule-style'),
		'',
		'column-rule: removeProperty clears column-rule-style'
	);
	assertEq(
		s.getPropertyValue('column-rule-color'),
		'',
		'column-rule: removeProperty clears column-rule-color'
	);
}
...
// --- row-rule (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('row-rule-width'),
		'inherit',
		'row-rule: inherit expands to row-rule-width'
	);
	assertEq(
		s.getPropertyValue('row-rule-style'),
		'inherit',
		'row-rule: inherit expands to row-rule-style'
	);
	assertEq(
		s.getPropertyValue('row-rule-color'),
		'inherit',
		'row-rule: inherit expands to row-rule-color'
	);
	s.removeProperty('row-rule');
	assertEq(
		s.getPropertyValue('row-rule-width'),
		'',
		'row-rule: removeProperty clears row-rule-width'
	);
	assertEq(
		s.getPropertyValue('row-rule-style'),
		'',
		'row-rule: removeProperty clears row-rule-style'
	);
	assertEq(
		s.getPropertyValue('row-rule-color'),
		'',
		'row-rule: removeProperty clears row-rule-color'
	);
}
...
// --- columns (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('column-width'),
		'inherit',
		'columns: inherit expands to column-width'
	);
	assertEq(
		s.getPropertyValue('column-count'),
		'inherit',
		'columns: inherit expands to column-count'
	);
	assertEq(
		s.getPropertyValue('column-height'),
		'inherit',
		'columns: inherit expands to column-height'
	);
...
// --- mask (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-mask-position-x'),
		'inherit',
		'mask: expands to -webkit-mask-position-x'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-position-y'),
		'inherit',
		'mask: expands to -webkit-mask-position-y'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-mask-position-x'),
		'inherit',
		'mask: inherit expands to -webkit-mask-position-x'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-position-y'),
		'inherit',
		'mask: inherit expands to -webkit-mask-position-y'
	);
	...
	assertEq(
		s.getPropertyValue('mask-composite'),
		'inherit',
		'mask: inherit expands to mask-composite'
	);
	...
	assertEq(
		s.getPropertyValue('-webkit-mask-position-x'),
		'',
		'mask: removeProperty clears -webkit-mask-position-x'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-position-y'),
		'',
		'mask: removeProperty clears -webkit-mask-position-y'
	);
...
// --- -webkit-mask-box-image (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-source'),
		'inherit',
		'-webkit-mask-box-image: expands to -webkit-mask-box-image-source'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-slice'),
		'inherit',
		'-webkit-mask-box-image: expands to -webkit-mask-box-image-slice'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-width'),
		'inherit',
		'-webkit-mask-box-image: expands to -webkit-mask-box-image-width'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-outset'),
		'inherit',
		'-webkit-mask-box-image: expands to -webkit-mask-box-image-outset'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-repeat'),
		'inherit',
		'-webkit-mask-box-image: expands to -webkit-mask-box-image-repeat'
	);
	s.setProperty('-webkit-mask-box-image', 'inherit');
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-source'),
		'inherit',
		'-webkit-mask-box-image: inherit expands to -webkit-mask-box-image-source'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-slice'),
		'inherit',
		'-webkit-mask-box-image: inherit expands to -webkit-mask-box-image-slice'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-width'),
		'inherit',
		'-webkit-mask-box-image: inherit expands to -webkit-mask-box-image-width'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-outset'),
		'inherit',
		'-webkit-mask-box-image: inherit expands to -webkit-mask-box-image-outset'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-repeat'),
		'inherit',
		'-webkit-mask-box-image: inherit expands to -webkit-mask-box-image-repeat'
	);
	s.removeProperty('-webkit-mask-box-image');
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-source'),
		'',
		'-webkit-mask-box-image: removeProperty clears -webkit-mask-box-image-source'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-slice'),
		'',
		'-webkit-mask-box-image: removeProperty clears -webkit-mask-box-image-slice'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-width'),
		'',
		'-webkit-mask-box-image: removeProperty clears -webkit-mask-box-image-width'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-outset'),
		'',
		'-webkit-mask-box-image: removeProperty clears -webkit-mask-box-image-outset'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-box-image-repeat'),
		'',
		'-webkit-mask-box-image: removeProperty clears -webkit-mask-box-image-repeat'
	);
}
...
// --- mask-position (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-mask-position-x'),
		'inherit',
		'mask-position: expands to -webkit-mask-position-x'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-position-y'),
		'inherit',
		'mask-position: expands to -webkit-mask-position-y'
	);
	s.setProperty('mask-position', 'inherit');
	assertEq(
		s.getPropertyValue('-webkit-mask-position-x'),
		'inherit',
		'mask-position: inherit expands to -webkit-mask-position-x'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-position-y'),
		'inherit',
		'mask-position: inherit expands to -webkit-mask-position-y'
	);
	s.removeProperty('mask-position');
	assertEq(
		s.getPropertyValue('-webkit-mask-position-x'),
		'',
		'mask-position: removeProperty clears -webkit-mask-position-x'
	);
	assertEq(
		s.getPropertyValue('-webkit-mask-position-y'),
		'',
		'mask-position: removeProperty clears -webkit-mask-position-y'
	);
}
...
// --- text-emphasis (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('text-emphasis-style'),
		'inherit',
		'text-emphasis: expands to text-emphasis-style'
	);
	assertEq(
		s.getPropertyValue('text-emphasis-color'),
		'inherit',
		'text-emphasis: expands to text-emphasis-color'
	);
	s.setProperty('text-emphasis', 'inherit');
	assertEq(
		s.getPropertyValue('text-emphasis-style'),
		'inherit',
		'text-emphasis: inherit expands to text-emphasis-style'
	);
	assertEq(
		s.getPropertyValue('text-emphasis-color'),
		'inherit',
		'text-emphasis: inherit expands to text-emphasis-color'
	);
	s.removeProperty('text-emphasis');
	assertEq(
		s.getPropertyValue('text-emphasis-style'),
		'',
		'text-emphasis: removeProperty clears text-emphasis-style'
	);
	assertEq(
		s.getPropertyValue('text-emphasis-color'),
		'',
		'text-emphasis: removeProperty clears text-emphasis-color'
	);
}
...
// --- timeline-trigger (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('timeline-trigger-name'),
		'inherit',
		'timeline-trigger: expands to timeline-trigger-name'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-source'),
		'inherit',
		'timeline-trigger: expands to timeline-trigger-source'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-activation-range-start'),
		'inherit',
		'timeline-trigger: expands to timeline-trigger-activation-range-start'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-activation-range-end'),
		'inherit',
		'timeline-trigger: expands to timeline-trigger-activation-range-end'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-active-range-start'),
		'inherit',
		'timeline-trigger: expands to timeline-trigger-active-range-start'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-active-range-end'),
		'inherit',
		'timeline-trigger: expands to timeline-trigger-active-range-end'
	);
	s.setProperty('timeline-trigger', 'inherit');
	assertEq(
		s.getPropertyValue('timeline-trigger-name'),
		'inherit',
		'timeline-trigger: inherit expands to timeline-trigger-name'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-source'),
		'inherit',
		'timeline-trigger: inherit expands to timeline-trigger-source'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-activation-range-start'),
		'inherit',
		'timeline-trigger: inherit expands to timeline-trigger-activation-range-start'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-activation-range-end'),
		'inherit',
		'timeline-trigger: inherit expands to timeline-trigger-activation-range-end'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-active-range-start'),
		'inherit',
		'timeline-trigger: inherit expands to timeline-trigger-active-range-start'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-active-range-end'),
		'inherit',
		'timeline-trigger: inherit expands to timeline-trigger-active-range-end'
	);
	s.removeProperty('timeline-trigger');
	assertEq(
		s.getPropertyValue('timeline-trigger-name'),
		'',
		'timeline-trigger: removeProperty clears timeline-trigger-name'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-source'),
		'',
		'timeline-trigger: removeProperty clears timeline-trigger-source'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-activation-range-start'),
		'',
		'timeline-trigger: removeProperty clears timeline-trigger-activation-range-start'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-activation-range-end'),
		'',
		'timeline-trigger: removeProperty clears timeline-trigger-activation-range-end'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-active-range-start'),
		'',
		'timeline-trigger: removeProperty clears timeline-trigger-active-range-start'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-active-range-end'),
		'',
		'timeline-trigger: removeProperty clears timeline-trigger-active-range-end'
	);
}
...
// --- timeline-trigger-activation-range (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('timeline-trigger-activation-range-start'),
		'inherit',
		'timeline-trigger-activation-range: expands to timeline-trigger-activation-range-start'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-activation-range-end'),
		'inherit',
		'timeline-trigger-activation-range: expands to timeline-trigger-activation-range-end'
	);
	s.setProperty('timeline-trigger-activation-range', 'inherit');
	assertEq(
		s.getPropertyValue('timeline-trigger-activation-range-start'),
		'inherit',
		'timeline-trigger-activation-range: inherit expands to timeline-trigger-activation-range-start'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-activation-range-end'),
		'inherit',
		'timeline-trigger-activation-range: inherit expands to timeline-trigger-activation-range-end'
	);
	s.removeProperty('timeline-trigger-activation-range');
	assertEq(
		s.getPropertyValue('timeline-trigger-activation-range-start'),
		'',
		'timeline-trigger-activation-range: removeProperty clears timeline-trigger-activation-range-start'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-activation-range-end'),
		'',
		'timeline-trigger-activation-range: removeProperty clears timeline-trigger-activation-range-end'
	);
}
...
// --- timeline-trigger-active-range (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('timeline-trigger-active-range-start'),
		'inherit',
		'timeline-trigger-active-range: expands to timeline-trigger-active-range-start'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-active-range-end'),
		'inherit',
		'timeline-trigger-active-range: expands to timeline-trigger-active-range-end'
	);
	s.setProperty('timeline-trigger-active-range', 'inherit');
	assertEq(
		s.getPropertyValue('timeline-trigger-active-range-start'),
		'inherit',
		'timeline-trigger-active-range: inherit expands to timeline-trigger-active-range-start'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-active-range-end'),
		'inherit',
		'timeline-trigger-active-range: inherit expands to timeline-trigger-active-range-end'
	);
	s.removeProperty('timeline-trigger-active-range');
	assertEq(
		s.getPropertyValue('timeline-trigger-active-range-start'),
		'',
		'timeline-trigger-active-range: removeProperty clears timeline-trigger-active-range-start'
	);
	assertEq(
		s.getPropertyValue('timeline-trigger-active-range-end'),
		'',
		'timeline-trigger-active-range: removeProperty clears timeline-trigger-active-range-end'
	);
}
...
// --- -webkit-text-stroke (shorthand) ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-text-stroke-width'),
		'inherit',
		'-webkit-text-stroke: expands to -webkit-text-stroke-width'
	);
	assertEq(
		s.getPropertyValue('-webkit-text-stroke-color'),
		'inherit',
		'-webkit-text-stroke: expands to -webkit-text-stroke-color'
	);
	s.setProperty('-webkit-text-stroke', 'inherit');
	assertEq(
		s.getPropertyValue('-webkit-text-stroke-width'),
		'inherit',
		'-webkit-text-stroke: inherit expands to -webkit-text-stroke-width'
	);
	assertEq(
		s.getPropertyValue('-webkit-text-stroke-color'),
		'inherit',
		'-webkit-text-stroke: inherit expands to -webkit-text-stroke-color'
	);
	s.removeProperty('-webkit-text-stroke');
	assertEq(
		s.getPropertyValue('-webkit-text-stroke-width'),
		'',
		'-webkit-text-stroke: removeProperty clears -webkit-text-stroke-width'
	);
	assertEq(
		s.getPropertyValue('-webkit-text-stroke-color'),
		'',
		'-webkit-text-stroke: removeProperty clears -webkit-text-stroke-color'
	);
}
...
// --- -webkit-appearance → appearance (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('appearance'),
		'initial',
		'-webkit-appearance: alias sets canonical appearance'
	);
	const s2 = fresh();
	s2.setProperty('appearance', 'initial');
	assertEq(
		s2.getPropertyValue('-webkit-appearance'),
		'initial',
		'-webkit-appearance: reading alias returns canonical value'
	);
}
...
// --- -webkit-app-region → app-region (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('app-region'),
		'none',
		'-webkit-app-region: alias sets canonical app-region'
	);
	const s2 = fresh();
	s2.setProperty('app-region', 'none');
	assertEq(
		s2.getPropertyValue('-webkit-app-region'),
		'none',
		'-webkit-app-region: reading alias returns canonical value'
	);
}
...
// --- -webkit-mask-clip → mask-clip (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('mask-clip'),
		'initial',
		'-webkit-mask-clip: alias sets canonical mask-clip'
	);
	const s2 = fresh();
	s2.setProperty('mask-clip', 'initial');
	assertEq(
		s2.getPropertyValue('-webkit-mask-clip'),
		'initial',
		'-webkit-mask-clip: reading alias returns canonical value'
	);
}
...
// --- -webkit-mask-composite → mask-composite (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('mask-composite'),
		'add',
		'-webkit-mask-composite: alias sets canonical mask-composite'
	);
	const s2 = fresh();
	s2.setProperty('mask-composite', 'add');
	assertEq(
		s2.getPropertyValue('-webkit-mask-composite'),
		'add',
		'-webkit-mask-composite: reading alias returns canonical value'
	);
}
...
// --- -webkit-mask-image → mask-image (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('mask-image'),
		'none',
		'-webkit-mask-image: alias sets canonical mask-image'
	);
	const s2 = fresh();
	s2.setProperty('mask-image', 'none');
	assertEq(
		s2.getPropertyValue('-webkit-mask-image'),
		'none',
		'-webkit-mask-image: reading alias returns canonical value'
	);
}
...
// --- -webkit-mask-origin → mask-origin (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('mask-origin'),
		'initial',
		'-webkit-mask-origin: alias sets canonical mask-origin'
	);
	const s2 = fresh();
	s2.setProperty('mask-origin', 'initial');
	assertEq(
		s2.getPropertyValue('-webkit-mask-origin'),
		'initial',
		'-webkit-mask-origin: reading alias returns canonical value'
	);
}
...
// --- -webkit-mask-repeat → mask-repeat (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('mask-repeat'),
		'initial',
		'-webkit-mask-repeat: alias sets canonical mask-repeat'
	);
	const s2 = fresh();
	s2.setProperty('mask-repeat', 'initial');
	assertEq(
		s2.getPropertyValue('-webkit-mask-repeat'),
		'initial',
		'-webkit-mask-repeat: reading alias returns canonical value'
	);
}
...
// --- -webkit-mask-size → mask-size (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('mask-size'),
		'10px',
		'-webkit-mask-size: alias sets canonical mask-size'
	);
	const s2 = fresh();
	s2.setProperty('mask-size', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-mask-size'),
		'10px',
		'-webkit-mask-size: reading alias returns canonical value'
	);
}
...
// --- -webkit-border-end-color → border-inline-end-color (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-inline-end-color'),
		'red',
		'-webkit-border-end-color: alias sets canonical border-inline-end-color'
	);
	const s2 = fresh();
	s2.setProperty('border-inline-end-color', 'red');
	assertEq(
		s2.getPropertyValue('-webkit-border-end-color'),
		'red',
		'-webkit-border-end-color: reading alias returns canonical value'
	);
}
...
// --- -webkit-border-end-style → border-inline-end-style (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-inline-end-style'),
		'initial',
		'-webkit-border-end-style: alias sets canonical border-inline-end-style'
	);
	const s2 = fresh();
	s2.setProperty('border-inline-end-style', 'initial');
	assertEq(
		s2.getPropertyValue('-webkit-border-end-style'),
		'initial',
		'-webkit-border-end-style: reading alias returns canonical value'
	);
}
...
// --- -webkit-border-end-width → border-inline-end-width (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-inline-end-width'),
		'10px',
		'-webkit-border-end-width: alias sets canonical border-inline-end-width'
	);
	const s2 = fresh();
	s2.setProperty('border-inline-end-width', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-border-end-width'),
		'10px',
		'-webkit-border-end-width: reading alias returns canonical value'
	);
}
...
// --- -webkit-border-start-color → border-inline-start-color (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-inline-start-color'),
		'red',
		'-webkit-border-start-color: alias sets canonical border-inline-start-color'
	);
	const s2 = fresh();
	s2.setProperty('border-inline-start-color', 'red');
	assertEq(
		s2.getPropertyValue('-webkit-border-start-color'),
		'red',
		'-webkit-border-start-color: reading alias returns canonical value'
	);
}
...
// --- -webkit-border-start-style → border-inline-start-style (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-inline-start-style'),
		'initial',
		'-webkit-border-start-style: alias sets canonical border-inline-start-style'
	);
	const s2 = fresh();
	s2.setProperty('border-inline-start-style', 'initial');
	assertEq(
		s2.getPropertyValue('-webkit-border-start-style'),
		'initial',
		'-webkit-border-start-style: reading alias returns canonical value'
	);
}
...
// --- -webkit-border-start-width → border-inline-start-width (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-inline-start-width'),
		'10px',
		'-webkit-border-start-width: alias sets canonical border-inline-start-width'
	);
	const s2 = fresh();
	s2.setProperty('border-inline-start-width', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-border-start-width'),
		'10px',
		'-webkit-border-start-width: reading alias returns canonical value'
	);
}
...
// --- -webkit-border-before-color → border-block-start-color (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-block-start-color'),
		'red',
		'-webkit-border-before-color: alias sets canonical border-block-start-color'
	);
	const s2 = fresh();
	s2.setProperty('border-block-start-color', 'red');
	assertEq(
		s2.getPropertyValue('-webkit-border-before-color'),
		'red',
		'-webkit-border-before-color: reading alias returns canonical value'
	);
}
...
// --- -webkit-border-before-style → border-block-start-style (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-block-start-style'),
		'initial',
		'-webkit-border-before-style: alias sets canonical border-block-start-style'
	);
	const s2 = fresh();
	s2.setProperty('border-block-start-style', 'initial');
	assertEq(
		s2.getPropertyValue('-webkit-border-before-style'),
		'initial',
		'-webkit-border-before-style: reading alias returns canonical value'
	);
}
...
// --- -webkit-border-before-width → border-block-start-width (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-block-start-width'),
		'10px',
		'-webkit-border-before-width: alias sets canonical border-block-start-width'
	);
	const s2 = fresh();
	s2.setProperty('border-block-start-width', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-border-before-width'),
		'10px',
		'-webkit-border-before-width: reading alias returns canonical value'
	);
}
...
// --- -webkit-border-after-color → border-block-end-color (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-block-end-color'),
		'red',
		'-webkit-border-after-color: alias sets canonical border-block-end-color'
	);
	const s2 = fresh();
	s2.setProperty('border-block-end-color', 'red');
	assertEq(
		s2.getPropertyValue('-webkit-border-after-color'),
		'red',
		'-webkit-border-after-color: reading alias returns canonical value'
	);
}
...
// --- -webkit-border-after-style → border-block-end-style (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-block-end-style'),
		'initial',
		'-webkit-border-after-style: alias sets canonical border-block-end-style'
	);
	const s2 = fresh();
	s2.setProperty('border-block-end-style', 'initial');
	assertEq(
		s2.getPropertyValue('-webkit-border-after-style'),
		'initial',
		'-webkit-border-after-style: reading alias returns canonical value'
	);
}
...
// --- -webkit-border-after-width → border-block-end-width (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-block-end-width'),
		'10px',
		'-webkit-border-after-width: alias sets canonical border-block-end-width'
	);
	const s2 = fresh();
	s2.setProperty('border-block-end-width', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-border-after-width'),
		'10px',
		'-webkit-border-after-width: reading alias returns canonical value'
	);
}
...
// --- -webkit-margin-end → margin-inline-end (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('margin-inline-end'),
		'10px',
		'-webkit-margin-end: alias sets canonical margin-inline-end'
	);
	const s2 = fresh();
	s2.setProperty('margin-inline-end', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-margin-end'),
		'10px',
		'-webkit-margin-end: reading alias returns canonical value'
	);
}
...
// --- -webkit-margin-start → margin-inline-start (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('margin-inline-start'),
		'10px',
		'-webkit-margin-start: alias sets canonical margin-inline-start'
	);
	const s2 = fresh();
	s2.setProperty('margin-inline-start', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-margin-start'),
		'10px',
		'-webkit-margin-start: reading alias returns canonical value'
	);
}
...
// --- -webkit-margin-before → margin-block-start (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('margin-block-start'),
		'10px',
		'-webkit-margin-before: alias sets canonical margin-block-start'
	);
	const s2 = fresh();
	s2.setProperty('margin-block-start', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-margin-before'),
		'10px',
		'-webkit-margin-before: reading alias returns canonical value'
	);
}
...
// --- -webkit-margin-after → margin-block-end (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('margin-block-end'),
		'10px',
		'-webkit-margin-after: alias sets canonical margin-block-end'
	);
	const s2 = fresh();
	s2.setProperty('margin-block-end', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-margin-after'),
		'10px',
		'-webkit-margin-after: reading alias returns canonical value'
	);
}
...
// --- -webkit-padding-end → padding-inline-end (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('padding-inline-end'),
		'10px',
		'-webkit-padding-end: alias sets canonical padding-inline-end'
	);
	const s2 = fresh();
	s2.setProperty('padding-inline-end', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-padding-end'),
		'10px',
		'-webkit-padding-end: reading alias returns canonical value'
	);
}
...
// --- -webkit-padding-start → padding-inline-start (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('padding-inline-start'),
		'10px',
		'-webkit-padding-start: alias sets canonical padding-inline-start'
	);
	const s2 = fresh();
	s2.setProperty('padding-inline-start', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-padding-start'),
		'10px',
		'-webkit-padding-start: reading alias returns canonical value'
	);
}
...
// --- -webkit-padding-before → padding-block-start (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('padding-block-start'),
		'10px',
		'-webkit-padding-before: alias sets canonical padding-block-start'
	);
	const s2 = fresh();
	s2.setProperty('padding-block-start', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-padding-before'),
		'10px',
		'-webkit-padding-before: reading alias returns canonical value'
	);
}
...
// --- -webkit-padding-after → padding-block-end (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('padding-block-end'),
		'10px',
		'-webkit-padding-after: alias sets canonical padding-block-end'
	);
	const s2 = fresh();
	s2.setProperty('padding-block-end', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-padding-after'),
		'10px',
		'-webkit-padding-after: reading alias returns canonical value'
	);
}
...
// --- -webkit-logical-width → inline-size (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('inline-size'),
		'10px',
		'-webkit-logical-width: alias sets canonical inline-size'
	);
	const s2 = fresh();
	s2.setProperty('inline-size', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-logical-width'),
		'10px',
		'-webkit-logical-width: reading alias returns canonical value'
	);
}
...
// --- -webkit-logical-height → block-size (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('block-size'),
		'10px',
		'-webkit-logical-height: alias sets canonical block-size'
	);
	const s2 = fresh();
	s2.setProperty('block-size', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-logical-height'),
		'10px',
		'-webkit-logical-height: reading alias returns canonical value'
	);
}
...
// --- -webkit-min-logical-width → min-inline-size (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('min-inline-size'),
		'10px',
		'-webkit-min-logical-width: alias sets canonical min-inline-size'
	);
	const s2 = fresh();
	s2.setProperty('min-inline-size', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-min-logical-width'),
		'10px',
		'-webkit-min-logical-width: reading alias returns canonical value'
	);
}
...
// --- -webkit-min-logical-height → min-block-size (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('min-block-size'),
		'10px',
		'-webkit-min-logical-height: alias sets canonical min-block-size'
	);
	const s2 = fresh();
	s2.setProperty('min-block-size', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-min-logical-height'),
		'10px',
		'-webkit-min-logical-height: reading alias returns canonical value'
	);
}
...
// --- -webkit-max-logical-width → max-inline-size (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('max-inline-size'),
		'10px',
		'-webkit-max-logical-width: alias sets canonical max-inline-size'
	);
	const s2 = fresh();
	s2.setProperty('max-inline-size', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-max-logical-width'),
		'10px',
		'-webkit-max-logical-width: reading alias returns canonical value'
	);
}
...
// --- -webkit-max-logical-height → max-block-size (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('max-block-size'),
		'10px',
		'-webkit-max-logical-height: alias sets canonical max-block-size'
	);
	const s2 = fresh();
	s2.setProperty('max-block-size', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-max-logical-height'),
		'10px',
		'-webkit-max-logical-height: reading alias returns canonical value'
	);
}
...
// --- -webkit-print-color-adjust → print-color-adjust (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('print-color-adjust'),
		'economy',
		'-webkit-print-color-adjust: alias sets canonical print-color-adjust'
	);
	const s2 = fresh();
	s2.setProperty('print-color-adjust', 'economy');
	assertEq(
		s2.getPropertyValue('-webkit-print-color-adjust'),
		'economy',
		'-webkit-print-color-adjust: reading alias returns canonical value'
	);
}
...
// --- -webkit-border-after → border-block-end (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-block-end-width'),
		'inherit',
		'-webkit-border-after: alias expands via border-block-end to border-block-end-width'
	);
	const s2 = fresh();
	s2.setProperty('border-block-end', 'inherit');
	assertEq(
		s2.getPropertyValue('-webkit-border-after').includes('inherit'),
		true,
		'-webkit-border-after: reading alias returns composed value'
	);
}
...
// --- -webkit-border-before → border-block-start (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-block-start-width'),
		'inherit',
		'-webkit-border-before: alias expands via border-block-start to border-block-start-width'
	);
	const s2 = fresh();
	s2.setProperty('border-block-start', 'inherit');
	assertEq(
		s2.getPropertyValue('-webkit-border-before').includes('inherit'),
		true,
		'-webkit-border-before: reading alias returns composed value'
	);
}
...
// --- -webkit-border-end → border-inline-end (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-inline-end-width'),
		'inherit',
		'-webkit-border-end: alias expands via border-inline-end to border-inline-end-width'
	);
	const s2 = fresh();
	s2.setProperty('border-inline-end', 'inherit');
	assertEq(
		s2.getPropertyValue('-webkit-border-end').includes('inherit'),
		true,
		'-webkit-border-end: reading alias returns composed value'
	);
}
...
// --- -webkit-border-start → border-inline-start (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-inline-start-width'),
		'inherit',
		'-webkit-border-start: alias expands via border-inline-start to border-inline-start-width'
	);
	const s2 = fresh();
	s2.setProperty('border-inline-start', 'inherit');
	assertEq(
		s2.getPropertyValue('-webkit-border-start').includes('inherit'),
		true,
		'-webkit-border-start: reading alias returns composed value'
	);
}
...
// --- -webkit-mask → mask (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('mask-image'),
		'inherit',
		'-webkit-mask: alias expands via mask to mask-image'
	);
	const s2 = fresh();
	s2.setProperty('mask', 'inherit');
	assertEq(
		s2.getPropertyValue('-webkit-mask').includes('inherit'),
		true,
		'-webkit-mask: reading alias returns composed value'
	);
}
...
// --- -webkit-mask-position → mask-position (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-mask-position-x'),
		'inherit',
		'-webkit-mask-position: alias expands via mask-position to -webkit-mask-position-x'
	);
	const s2 = fresh();
	s2.setProperty('mask-position', 'inherit');
	assertEq(
		s2.getPropertyValue('-webkit-mask-position').includes('inherit'),
		true,
		'-webkit-mask-position: reading alias returns composed value'
	);
}
...
// --- -epub-caption-side → caption-side (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('caption-side'),
		'top',
		'-epub-caption-side: alias sets canonical caption-side'
	);
	const s2 = fresh();
	s2.setProperty('caption-side', 'top');
	assertEq(
		s2.getPropertyValue('-epub-caption-side'),
		'top',
		'-epub-caption-side: reading alias returns canonical value'
	);
}
...
// --- -epub-text-combine → -webkit-text-combine (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-text-combine'),
		'initial',
		'-epub-text-combine: alias sets canonical -webkit-text-combine'
	);
	const s2 = fresh();
	s2.setProperty('-webkit-text-combine', 'initial');
	assertEq(
		s2.getPropertyValue('-epub-text-combine'),
		'initial',
		'-epub-text-combine: reading alias returns canonical value'
	);
}
...
// --- -epub-text-emphasis → text-emphasis (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('text-emphasis-style'),
		'inherit',
		'-epub-text-emphasis: alias expands via text-emphasis to text-emphasis-style'
	);
	const s2 = fresh();
	s2.setProperty('text-emphasis', 'inherit');
	assertEq(
		s2.getPropertyValue('-epub-text-emphasis').includes('inherit'),
		true,
		'-epub-text-emphasis: reading alias returns composed value'
	);
}
...
// --- -epub-text-emphasis-color → text-emphasis-color (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('text-emphasis-color'),
		'red',
		'-epub-text-emphasis-color: alias sets canonical text-emphasis-color'
	);
	const s2 = fresh();
	s2.setProperty('text-emphasis-color', 'red');
	assertEq(
		s2.getPropertyValue('-epub-text-emphasis-color'),
		'red',
		'-epub-text-emphasis-color: reading alias returns canonical value'
	);
}
...
// --- -epub-text-emphasis-style → text-emphasis-style (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('text-emphasis-style'),
		'initial',
		'-epub-text-emphasis-style: alias sets canonical text-emphasis-style'
	);
	const s2 = fresh();
	s2.setProperty('text-emphasis-style', 'initial');
	assertEq(
		s2.getPropertyValue('-epub-text-emphasis-style'),
		'initial',
		'-epub-text-emphasis-style: reading alias returns canonical value'
	);
}
...
// --- -epub-text-orientation → -webkit-text-orientation (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-text-orientation'),
		'initial',
		'-epub-text-orientation: alias sets canonical -webkit-text-orientation'
	);
	const s2 = fresh();
	s2.setProperty('-webkit-text-orientation', 'initial');
	assertEq(
		s2.getPropertyValue('-epub-text-orientation'),
		'initial',
		'-epub-text-orientation: reading alias returns canonical value'
	);
}
...
// --- -epub-text-transform → text-transform (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('text-transform'),
		'none',
		'-epub-text-transform: alias sets canonical text-transform'
	);
	const s2 = fresh();
	s2.setProperty('text-transform', 'none');
	assertEq(
		s2.getPropertyValue('-epub-text-transform'),
		'none',
		'-epub-text-transform: reading alias returns canonical value'
	);
}
...
// --- -epub-word-break → word-break (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('word-break'),
		'normal',
		'-epub-word-break: alias sets canonical word-break'
	);
	const s2 = fresh();
	s2.setProperty('word-break', 'normal');
	assertEq(
		s2.getPropertyValue('-epub-word-break'),
		'normal',
		'-epub-word-break: reading alias returns canonical value'
	);
}
...
// --- -epub-writing-mode → -webkit-writing-mode (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('-webkit-writing-mode'),
		'initial',
		'-epub-writing-mode: alias sets canonical -webkit-writing-mode'
	);
	const s2 = fresh();
	s2.setProperty('-webkit-writing-mode', 'initial');
	assertEq(
		s2.getPropertyValue('-epub-writing-mode'),
		'initial',
		'-epub-writing-mode: reading alias returns canonical value'
	);
}
...
// --- -webkit-align-content → align-content (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('align-content'),
		'initial',
		'-webkit-align-content: alias sets canonical align-content'
	);
	const s2 = fresh();
	s2.setProperty('align-content', 'initial');
	assertEq(
		s2.getPropertyValue('-webkit-align-content'),
		'initial',
		'-webkit-align-content: reading alias returns canonical value'
	);
}
...
// --- -webkit-align-items → align-items (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('align-items'),
		'initial',
		'-webkit-align-items: alias sets canonical align-items'
	);
	const s2 = fresh();
	s2.setProperty('align-items', 'initial');
	assertEq(
		s2.getPropertyValue('-webkit-align-items'),
		'initial',
		'-webkit-align-items: reading alias returns canonical value'
	);
}
...
// --- -webkit-align-self → align-self (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('align-self'),
		'initial',
		'-webkit-align-self: alias sets canonical align-self'
	);
	const s2 = fresh();
	s2.setProperty('align-self', 'initial');
	assertEq(
		s2.getPropertyValue('-webkit-align-self'),
		'initial',
		'-webkit-align-self: reading alias returns canonical value'
	);
}
...
// --- -webkit-animation → animation (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('animation-duration'),
		'inherit',
		'-webkit-animation: alias expands via animation to animation-duration'
	);
	const s2 = fresh();
	s2.setProperty('animation', 'inherit');
	assertEq(
		s2.getPropertyValue('-webkit-animation').includes('inherit'),
		true,
		'-webkit-animation: reading alias returns composed value'
	);
}
...
// --- -webkit-animation-delay → animation-delay (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('animation-delay'),
		'1s',
		'-webkit-animation-delay: alias sets canonical animation-delay'
	);
	const s2 = fresh();
	s2.setProperty('animation-delay', '1s');
	assertEq(
		s2.getPropertyValue('-webkit-animation-delay'),
		'1s',
		'-webkit-animation-delay: reading alias returns canonical value'
	);
}
...
// --- -webkit-animation-direction → animation-direction (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('animation-direction'),
		'normal',
		'-webkit-animation-direction: alias sets canonical animation-direction'
	);
	const s2 = fresh();
	s2.setProperty('animation-direction', 'normal');
	assertEq(
		s2.getPropertyValue('-webkit-animation-direction'),
		'normal',
		'-webkit-animation-direction: reading alias returns canonical value'
	);
}
...
// --- -webkit-animation-duration → animation-duration (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('animation-duration'),
		'1s',
		'-webkit-animation-duration: alias sets canonical animation-duration'
	);
	const s2 = fresh();
	s2.setProperty('animation-duration', '1s');
	assertEq(
		s2.getPropertyValue('-webkit-animation-duration'),
		'1s',
		'-webkit-animation-duration: reading alias returns canonical value'
	);
}
...
// --- -webkit-animation-fill-mode → animation-fill-mode (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('animation-fill-mode'),
		'none',
		'-webkit-animation-fill-mode: alias sets canonical animation-fill-mode'
	);
	const s2 = fresh();
	s2.setProperty('animation-fill-mode', 'none');
	assertEq(
		s2.getPropertyValue('-webkit-animation-fill-mode'),
		'none',
		'-webkit-animation-fill-mode: reading alias returns canonical value'
	);
}
...
// --- -webkit-animation-iteration-count → animation-iteration-count (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('animation-iteration-count'),
		'infinite',
		'-webkit-animation-iteration-count: alias sets canonical animation-iteration-count'
	);
	const s2 = fresh();
	s2.setProperty('animation-iteration-count', 'infinite');
	assertEq(
		s2.getPropertyValue('-webkit-animation-iteration-count'),
		'infinite',
		'-webkit-animation-iteration-count: reading alias returns canonical value'
	);
}
...
// --- -webkit-animation-name → animation-name (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('animation-name'),
		'none',
		'-webkit-animation-name: alias sets canonical animation-name'
	);
	const s2 = fresh();
	s2.setProperty('animation-name', 'none');
	assertEq(
		s2.getPropertyValue('-webkit-animation-name'),
		'none',
		'-webkit-animation-name: reading alias returns canonical value'
	);
}
...
// --- -webkit-animation-play-state → animation-play-state (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('animation-play-state'),
		'running',
		'-webkit-animation-play-state: alias sets canonical animation-play-state'
	);
	const s2 = fresh();
	s2.setProperty('animation-play-state', 'running');
	assertEq(
		s2.getPropertyValue('-webkit-animation-play-state'),
		'running',
		'-webkit-animation-play-state: reading alias returns canonical value'
	);
}
...
// --- -webkit-animation-timing-function → animation-timing-function (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('animation-timing-function'),
		'linear',
		'-webkit-animation-timing-function: alias sets canonical animation-timing-function'
	);
	const s2 = fresh();
	s2.setProperty('animation-timing-function', 'linear');
	assertEq(
		s2.getPropertyValue('-webkit-animation-timing-function'),
		'linear',
		'-webkit-animation-timing-function: reading alias returns canonical value'
	);
}
...
// --- -webkit-backface-visibility → backface-visibility (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('backface-visibility'),
		'visible',
		'-webkit-backface-visibility: alias sets canonical backface-visibility'
	);
	const s2 = fresh();
	s2.setProperty('backface-visibility', 'visible');
	assertEq(
		s2.getPropertyValue('-webkit-backface-visibility'),
		'visible',
		'-webkit-backface-visibility: reading alias returns canonical value'
	);
}
...
// --- -webkit-background-clip → background-clip (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('background-clip'),
		'border-box',
		'-webkit-background-clip: alias sets canonical background-clip'
	);
	const s2 = fresh();
	s2.setProperty('background-clip', 'border-box');
	assertEq(
		s2.getPropertyValue('-webkit-background-clip'),
		'border-box',
		'-webkit-background-clip: reading alias returns canonical value'
	);
}
...
// --- -webkit-background-origin → background-origin (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('background-origin'),
		'border-box',
		'-webkit-background-origin: alias sets canonical background-origin'
	);
	const s2 = fresh();
	s2.setProperty('background-origin', 'border-box');
	assertEq(
		s2.getPropertyValue('-webkit-background-origin'),
		'border-box',
		'-webkit-background-origin: reading alias returns canonical value'
	);
}
...
// --- -webkit-background-size → background-size (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('background-size'),
		'auto',
		'-webkit-background-size: alias sets canonical background-size'
	);
	const s2 = fresh();
	s2.setProperty('background-size', 'auto');
	assertEq(
		s2.getPropertyValue('-webkit-background-size'),
		'auto',
		'-webkit-background-size: reading alias returns canonical value'
	);
}
...
// --- -webkit-border-bottom-left-radius → border-bottom-left-radius (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-bottom-left-radius'),
		'10px',
		'-webkit-border-bottom-left-radius: alias sets canonical border-bottom-left-radius'
	);
	const s2 = fresh();
	s2.setProperty('border-bottom-left-radius', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-border-bottom-left-radius'),
		'10px',
		'-webkit-border-bottom-left-radius: reading alias returns canonical value'
	);
}
...
// --- -webkit-border-bottom-right-radius → border-bottom-right-radius (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-bottom-right-radius'),
		'10px',
		'-webkit-border-bottom-right-radius: alias sets canonical border-bottom-right-radius'
	);
	const s2 = fresh();
	s2.setProperty('border-bottom-right-radius', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-border-bottom-right-radius'),
		'10px',
		'-webkit-border-bottom-right-radius: reading alias returns canonical value'
	);
}
...
// --- -webkit-border-radius → border-radius (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-top-left-radius'),
		'inherit',
		'-webkit-border-radius: alias expands via border-radius to border-top-left-radius'
	);
	const s2 = fresh();
	s2.setProperty('border-radius', 'inherit');
	assertEq(
		s2.getPropertyValue('-webkit-border-radius').includes('inherit'),
		true,
		'-webkit-border-radius: reading alias returns composed value'
	);
}
...
// --- -webkit-border-top-left-radius → border-top-left-radius (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-top-left-radius'),
		'10px',
		'-webkit-border-top-left-radius: alias sets canonical border-top-left-radius'
	);
	const s2 = fresh();
	s2.setProperty('border-top-left-radius', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-border-top-left-radius'),
		'10px',
		'-webkit-border-top-left-radius: reading alias returns canonical value'
	);
}
...
// --- -webkit-border-top-right-radius → border-top-right-radius (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('border-top-right-radius'),
		'10px',
		'-webkit-border-top-right-radius: alias sets canonical border-top-right-radius'
	);
	const s2 = fresh();
	s2.setProperty('border-top-right-radius', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-border-top-right-radius'),
		'10px',
		'-webkit-border-top-right-radius: reading alias returns canonical value'
	);
}
...
// --- -webkit-box-shadow → box-shadow (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('box-shadow'),
		'none',
		'-webkit-box-shadow: alias sets canonical box-shadow'
	);
	const s2 = fresh();
	s2.setProperty('box-shadow', 'none');
	assertEq(
		s2.getPropertyValue('-webkit-box-shadow'),
		'none',
		'-webkit-box-shadow: reading alias returns canonical value'
	);
}
...
// --- -webkit-box-sizing → box-sizing (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('box-sizing'),
		'content-box',
		'-webkit-box-sizing: alias sets canonical box-sizing'
	);
	const s2 = fresh();
	s2.setProperty('box-sizing', 'content-box');
	assertEq(
		s2.getPropertyValue('-webkit-box-sizing'),
		'content-box',
		'-webkit-box-sizing: reading alias returns canonical value'
	);
}
...
// --- -webkit-clip-path → clip-path (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('clip-path'),
		'border-box',
		'-webkit-clip-path: alias sets canonical clip-path'
	);
	const s2 = fresh();
	s2.setProperty('clip-path', 'border-box');
	assertEq(
		s2.getPropertyValue('-webkit-clip-path'),
		'border-box',
		'-webkit-clip-path: reading alias returns canonical value'
	);
}
...
// --- -webkit-column-count → column-count (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('column-count'),
		'auto',
		'-webkit-column-count: alias sets canonical column-count'
	);
	const s2 = fresh();
	s2.setProperty('column-count', 'auto');
	assertEq(
		s2.getPropertyValue('-webkit-column-count'),
		'auto',
		'-webkit-column-count: reading alias returns canonical value'
	);
}
...
// --- -webkit-column-gap → column-gap (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('column-gap'),
		'10px',
		'-webkit-column-gap: alias sets canonical column-gap'
	);
	const s2 = fresh();
	s2.setProperty('column-gap', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-column-gap'),
		'10px',
		'-webkit-column-gap: reading alias returns canonical value'
	);
}
...
// --- -webkit-column-rule → column-rule (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-width'),
		'inherit',
		'-webkit-column-rule: alias expands via column-rule to column-rule-width'
	);
	const s2 = fresh();
	s2.setProperty('column-rule', 'inherit');
	assertEq(
		s2.getPropertyValue('-webkit-column-rule').includes('inherit'),
		true,
		'-webkit-column-rule: reading alias returns composed value'
	);
}
...
// --- -webkit-column-rule-color → column-rule-color (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-color'),
		'red',
		'-webkit-column-rule-color: alias sets canonical column-rule-color'
	);
	const s2 = fresh();
	s2.setProperty('column-rule-color', 'red');
	assertEq(
		s2.getPropertyValue('-webkit-column-rule-color'),
		'red',
		'-webkit-column-rule-color: reading alias returns canonical value'
	);
}
...
// --- -webkit-column-rule-style → column-rule-style (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-style'),
		'none',
		'-webkit-column-rule-style: alias sets canonical column-rule-style'
	);
	const s2 = fresh();
	s2.setProperty('column-rule-style', 'none');
	assertEq(
		s2.getPropertyValue('-webkit-column-rule-style'),
		'none',
		'-webkit-column-rule-style: reading alias returns canonical value'
	);
}
...
// --- -webkit-column-rule-width → column-rule-width (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('column-rule-width'),
		'thin',
		'-webkit-column-rule-width: alias sets canonical column-rule-width'
	);
	const s2 = fresh();
	s2.setProperty('column-rule-width', 'thin');
	assertEq(
		s2.getPropertyValue('-webkit-column-rule-width'),
		'thin',
		'-webkit-column-rule-width: reading alias returns canonical value'
	);
}
...
// --- -webkit-column-span → column-span (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('column-span'),
		'none',
		'-webkit-column-span: alias sets canonical column-span'
	);
	const s2 = fresh();
	s2.setProperty('column-span', 'none');
	assertEq(
		s2.getPropertyValue('-webkit-column-span'),
		'none',
		'-webkit-column-span: reading alias returns canonical value'
	);
}
...
// --- -webkit-column-width → column-width (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('column-width'),
		'10px',
		'-webkit-column-width: alias sets canonical column-width'
	);
	const s2 = fresh();
	s2.setProperty('column-width', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-column-width'),
		'10px',
		'-webkit-column-width: reading alias returns canonical value'
	);
}
...
// --- -webkit-columns → columns (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('column-width'),
		'inherit',
		'-webkit-columns: alias expands via columns to column-width'
	);
	const s2 = fresh();
	s2.setProperty('columns', 'inherit');
	assertEq(
		s2.getPropertyValue('-webkit-columns').includes('inherit'),
		true,
		'-webkit-columns: reading alias returns composed value'
	);
}
...
// --- -webkit-filter → filter (alias) ---
{
	...
	assertEq(
		s2.getPropertyValue('-webkit-filter'),
		'none',
		'-webkit-filter: reading alias returns canonical value'
	);
}
...
// --- -webkit-flex → flex (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('flex-grow'),
		'inherit',
		'-webkit-flex: alias expands via flex to flex-grow'
	);
	const s2 = fresh();
	s2.setProperty('flex', 'inherit');
	assertEq(
		s2.getPropertyValue('-webkit-flex').includes('inherit'),
		true,
		'-webkit-flex: reading alias returns composed value'
	);
}
...
// --- -webkit-flex-basis → flex-basis (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('flex-basis'),
		'10px',
		'-webkit-flex-basis: alias sets canonical flex-basis'
	);
	const s2 = fresh();
	s2.setProperty('flex-basis', '10px');
	assertEq(
		s2.getPropertyValue('-webkit-flex-basis'),
		'10px',
		'-webkit-flex-basis: reading alias returns canonical value'
	);
}
...
// --- -webkit-flex-direction → flex-direction (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('flex-direction'),
		'row',
		'-webkit-flex-direction: alias sets canonical flex-direction'
	);
	const s2 = fresh();
	s2.setProperty('flex-direction', 'row');
	assertEq(
		s2.getPropertyValue('-webkit-flex-direction'),
		'row',
		'-webkit-flex-direction: reading alias returns canonical value'
	);
}
...
// --- -webkit-flex-flow → flex-flow (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('flex-direction'),
		'inherit',
		'-webkit-flex-flow: alias expands via flex-flow to flex-direction'
	);
	const s2 = fresh();
	s2.setProperty('flex-flow', 'inherit');
	assertEq(
		s2.getPropertyValue('-webkit-flex-flow').includes('inherit'),
		true,
		'-webkit-flex-flow: reading alias returns composed value'
	);
}
...
// --- -webkit-flex-grow → flex-grow (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('flex-grow'),
		'1',
		'-webkit-flex-grow: alias sets canonical flex-grow'
	);
	const s2 = fresh();
	s2.setProperty('flex-grow', '1');
	assertEq(
		s2.getPropertyValue('-webkit-flex-grow'),
		'1',
		'-webkit-flex-grow: reading alias returns canonical value'
	);
}
...
// --- -webkit-flex-shrink → flex-shrink (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('flex-shrink'),
		'1',
		'-webkit-flex-shrink: alias sets canonical flex-shrink'
	);
	const s2 = fresh();
	s2.setProperty('flex-shrink', '1');
	assertEq(
		s2.getPropertyValue('-webkit-flex-shrink'),
		'1',
		'-webkit-flex-shrink: reading alias returns canonical value'
	);
}
...
// --- -webkit-flex-wrap → flex-wrap (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('flex-wrap'),
		'nowrap',
		'-webkit-flex-wrap: alias sets canonical flex-wrap'
	);
	const s2 = fresh();
	s2.setProperty('flex-wrap', 'nowrap');
	assertEq(
		s2.getPropertyValue('-webkit-flex-wrap'),
		'nowrap',
		'-webkit-flex-wrap: reading alias returns canonical value'
	);
}
...
// --- -webkit-font-feature-settings → font-feature-settings (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('font-feature-settings'),
		'normal',
		'-webkit-font-feature-settings: alias sets canonical font-feature-settings'
	);
	const s2 = fresh();
	s2.setProperty('font-feature-settings', 'normal');
	assertEq(
		s2.getPropertyValue('-webkit-font-feature-settings'),
		'normal',
		'-webkit-font-feature-settings: reading alias returns canonical value'
	);
}
...
// --- -webkit-hyphenate-character → hyphenate-character (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('hyphenate-character'),
		'initial',
		'-webkit-hyphenate-character: alias sets canonical hyphenate-character'
	);
	const s2 = fresh();
	s2.setProperty('hyphenate-character', 'initial');
	assertEq(
		s2.getPropertyValue('-webkit-hyphenate-character'),
		'initial',
		'-webkit-hyphenate-character: reading alias returns canonical value'
	);
}
...
// --- -webkit-justify-content → justify-content (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('justify-content'),
		'initial',
		'-webkit-justify-content: alias sets canonical justify-content'
	);
	const s2 = fresh();
	s2.setProperty('justify-content', 'initial');
	assertEq(
		s2.getPropertyValue('-webkit-justify-content'),
		'initial',
		'-webkit-justify-content: reading alias returns canonical value'
	);
}
...
// --- -webkit-opacity → opacity (alias) ---
{
	...
	assertEq(
		s2.getPropertyValue('-webkit-opacity'),
		'1',
		'-webkit-opacity: reading alias returns canonical value'
	);
}
...
// --- -webkit-order → order (alias) ---
{
	...
	assertEq(
		s2.getPropertyValue('-webkit-order'),
		'1',
		'-webkit-order: reading alias returns canonical value'
	);
}
...
// --- -webkit-perspective → perspective (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('perspective'),
		'none',
		'-webkit-perspective: alias sets canonical perspective'
	);
	const s2 = fresh();
	s2.setProperty('perspective', 'none');
	assertEq(
		s2.getPropertyValue('-webkit-perspective'),
		'none',
		'-webkit-perspective: reading alias returns canonical value'
	);
}
...
// --- -webkit-perspective-origin → perspective-origin (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('perspective-origin'),
		'initial',
		'-webkit-perspective-origin: alias sets canonical perspective-origin'
	);
	const s2 = fresh();
	s2.setProperty('perspective-origin', 'initial');
	assertEq(
		s2.getPropertyValue('-webkit-perspective-origin'),
		'initial',
		'-webkit-perspective-origin: reading alias returns canonical value'
	);
}
...
// --- -webkit-shape-image-threshold → shape-image-threshold (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('shape-image-threshold'),
		'1',
		'-webkit-shape-image-threshold: alias sets canonical shape-image-threshold'
	);
	const s2 = fresh();
	s2.setProperty('shape-image-threshold', '1');
	assertEq(
		s2.getPropertyValue('-webkit-shape-image-threshold'),
		'1',
		'-webkit-shape-image-threshold: reading alias returns canonical value'
	);
}
...
// --- -webkit-shape-margin → shape-margin (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('shape-margin'),
		'none',
		'-webkit-shape-margin: alias sets canonical shape-margin'
	);
	const s2 = fresh();
	s2.setProperty('shape-margin', 'none');
	assertEq(
		s2.getPropertyValue('-webkit-shape-margin'),
		'none',
		'-webkit-shape-margin: reading alias returns canonical value'
	);
}
...
// --- -webkit-shape-outside → shape-outside (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('shape-outside'),
		'none',
		'-webkit-shape-outside: alias sets canonical shape-outside'
	);
	const s2 = fresh();
	s2.setProperty('shape-outside', 'none');
	assertEq(
		s2.getPropertyValue('-webkit-shape-outside'),
		'none',
		'-webkit-shape-outside: reading alias returns canonical value'
	);
}
...
// --- -webkit-text-emphasis → text-emphasis (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('text-emphasis-style'),
		'inherit',
		'-webkit-text-emphasis: alias expands via text-emphasis to text-emphasis-style'
	);
	const s2 = fresh();
	s2.setProperty('text-emphasis', 'inherit');
	assertEq(
		s2.getPropertyValue('-webkit-text-emphasis').includes('inherit'),
		true,
		'-webkit-text-emphasis: reading alias returns composed value'
	);
}
...
// --- -webkit-text-emphasis-color → text-emphasis-color (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('text-emphasis-color'),
		'red',
		'-webkit-text-emphasis-color: alias sets canonical text-emphasis-color'
	);
	const s2 = fresh();
	s2.setProperty('text-emphasis-color', 'red');
	assertEq(
		s2.getPropertyValue('-webkit-text-emphasis-color'),
		'red',
		'-webkit-text-emphasis-color: reading alias returns canonical value'
	);
}
...
// --- -webkit-text-emphasis-position → text-emphasis-position (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('text-emphasis-position'),
		'initial',
		'-webkit-text-emphasis-position: alias sets canonical text-emphasis-position'
	);
	const s2 = fresh();
	s2.setProperty('text-emphasis-position', 'initial');
	assertEq(
		s2.getPropertyValue('-webkit-text-emphasis-position'),
		'initial',
		'-webkit-text-emphasis-position: reading alias returns canonical value'
	);
}
...
// --- -webkit-text-emphasis-style → text-emphasis-style (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('text-emphasis-style'),
		'initial',
		'-webkit-text-emphasis-style: alias sets canonical text-emphasis-style'
	);
	const s2 = fresh();
	s2.setProperty('text-emphasis-style', 'initial');
	assertEq(
		s2.getPropertyValue('-webkit-text-emphasis-style'),
		'initial',
		'-webkit-text-emphasis-style: reading alias returns canonical value'
	);
}
...
// --- -webkit-text-size-adjust → text-size-adjust (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('text-size-adjust'),
		'none',
		'-webkit-text-size-adjust: alias sets canonical text-size-adjust'
	);
	const s2 = fresh();
	s2.setProperty('text-size-adjust', 'none');
	assertEq(
		s2.getPropertyValue('-webkit-text-size-adjust'),
		'none',
		'-webkit-text-size-adjust: reading alias returns canonical value'
	);
}
...
// --- -webkit-transform → transform (alias) ---
{
	...
	assertEq(
		...
		'none',
		'-webkit-transform: alias sets canonical transform'
	);
	const s2 = fresh();
	s2.setProperty('transform', 'none');
	assertEq(
		s2.getPropertyValue('-webkit-transform'),
		'none',
		'-webkit-transform: reading alias returns canonical value'
	);
}
...
// --- -webkit-transform-origin → transform-origin (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('transform-origin'),
		'initial',
		'-webkit-transform-origin: alias sets canonical transform-origin'
	);
	const s2 = fresh();
	s2.setProperty('transform-origin', 'initial');
	assertEq(
		s2.getPropertyValue('-webkit-transform-origin'),
		'initial',
		'-webkit-transform-origin: reading alias returns canonical value'
	);
}
...
// --- -webkit-transform-style → transform-style (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('transform-style'),
		'flat',
		'-webkit-transform-style: alias sets canonical transform-style'
	);
	const s2 = fresh();
	s2.setProperty('transform-style', 'flat');
	assertEq(
		s2.getPropertyValue('-webkit-transform-style'),
		'flat',
		'-webkit-transform-style: reading alias returns canonical value'
	);
}
...
// --- -webkit-transition → transition (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('transition-property'),
		'inherit',
		'-webkit-transition: alias expands via transition to transition-property'
	);
	const s2 = fresh();
	s2.setProperty('transition', 'inherit');
	assertEq(
		s2.getPropertyValue('-webkit-transition').includes('inherit'),
		true,
		'-webkit-transition: reading alias returns composed value'
	);
}
...
// --- -webkit-transition-delay → transition-delay (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('transition-delay'),
		'1s',
		'-webkit-transition-delay: alias sets canonical transition-delay'
	);
	const s2 = fresh();
	s2.setProperty('transition-delay', '1s');
	assertEq(
		s2.getPropertyValue('-webkit-transition-delay'),
		'1s',
		'-webkit-transition-delay: reading alias returns canonical value'
	);
}
...
// --- -webkit-transition-duration → transition-duration (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('transition-duration'),
		'1s',
		'-webkit-transition-duration: alias sets canonical transition-duration'
	);
	const s2 = fresh();
	s2.setProperty('transition-duration', '1s');
	assertEq(
		s2.getPropertyValue('-webkit-transition-duration'),
		'1s',
		'-webkit-transition-duration: reading alias returns canonical value'
	);
}
...
// --- -webkit-transition-property → transition-property (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('transition-property'),
		'none',
		'-webkit-transition-property: alias sets canonical transition-property'
	);
	const s2 = fresh();
	s2.setProperty('transition-property', 'none');
	assertEq(
		s2.getPropertyValue('-webkit-transition-property'),
		'none',
		'-webkit-transition-property: reading alias returns canonical value'
	);
}
...
// --- -webkit-transition-timing-function → transition-timing-function (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('transition-timing-function'),
		'linear',
		'-webkit-transition-timing-function: alias sets canonical transition-timing-function'
	);
	const s2 = fresh();
	s2.setProperty('transition-timing-function', 'linear');
	assertEq(
		s2.getPropertyValue('-webkit-transition-timing-function'),
		'linear',
		'-webkit-transition-timing-function: reading alias returns canonical value'
	);
}
...
// --- -webkit-user-select → user-select (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('user-select'),
		'auto',
		'-webkit-user-select: alias sets canonical user-select'
	);
	const s2 = fresh();
	s2.setProperty('user-select', 'auto');
	assertEq(
		s2.getPropertyValue('-webkit-user-select'),
		'auto',
		'-webkit-user-select: reading alias returns canonical value'
	);
}
...
// --- word-wrap → overflow-wrap (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('overflow-wrap'),
		'normal',
		'word-wrap: alias sets canonical overflow-wrap'
	);
	const s2 = fresh();
	s2.setProperty('overflow-wrap', 'normal');
	assertEq(
		s2.getPropertyValue('word-wrap'),
		'normal',
		'word-wrap: reading alias returns canonical value'
	);
}
...
// --- grid-column-gap → column-gap (alias) ---
{
	...
	assertEq(
		s.getPropertyValue('column-gap'),
		'10px',
		'grid-column-gap: alias sets canonical column-gap'
	);
	const s2 = fresh();
	s2.setProperty('column-gap', '10px');
	assertEq(
		s2.getPropertyValue('grid-column-gap'),
		'10px',
		'grid-column-gap: reading alias returns canonical value'
	);
}
...
// --- grid-row-gap → row-gap (alias) ---
{
	...
	assertEq(
		s2.getPropertyValue('grid-row-gap'),
		'10px',
		'grid-row-gap: reading alias returns canonical value'
	);
}
...
// --- grid-gap → gap (alias) ---
{
	...
	assertEq(
		s2.getPropertyValue('grid-gap').includes('inherit'),
		true,
		'grid-gap: reading alias returns composed value'
	);
}
