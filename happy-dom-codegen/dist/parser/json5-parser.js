 ...
 * @param raw
 */
function deriveInitialValue(raw) {
 ...
 * @param filePath
 */
export function parseJSON5(filePath) {
	...
	for (const entry of entries) {
		...
		const type = isAlias ? 'alias' : hasLonghands ? 'shorthand' : 'longhand';
	...
	const shorthandToLonghands = new Map();
...
// # sourceMappingURL=json5-parser.js.map
