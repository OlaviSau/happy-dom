...
export default class CSSStyleDeclarationPropertyGetParser {
	 ...
	 */
	static GLOBAL_KEYWORDS = new Set(['inherit', 'initial', 'unset', 'revert', 'revert-layer']);
	/**
	 ...
	 * @param important
	 */
	static collapseGlobal(values, important) {
		if (values.length === 0) {
			return null;
		}
		const first = values[0];
		if (!this.GLOBAL_KEYWORDS.has(first)) {
			return null;
		}
	 ...
	 * @param leftProp
	 */
	static getBoxModel(props, topProp, rightProp, bottomProp, leftProp) {
	 ...
	 * @param prop2
	 */
	static getTwoValue(props, prop1, prop2) {
	 ...
	 * @param colorProp
	 */
	static getBorderSide(props, widthProp, styleProp, colorProp) {
	 ...
	 * @param props
	 */
	static getTextDecoration(props) {
